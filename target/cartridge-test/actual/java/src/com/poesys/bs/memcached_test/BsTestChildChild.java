 ...
 */
public class BsTestChildChild extends com.poesys.bs.memcached_test.AbstractBsTestChildChild {
  /**
   ...
   */
  public BsTestChildChild(com.poesys.db.memcached_test.ITestChildChild dto) throws DelegateException {
    super(dto);
  }
