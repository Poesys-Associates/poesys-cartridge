 ...
 */
public class BsTestChild2TestChild extends com.poesys.bs.test.AbstractBsTestChild2TestChild {
  /**
   ...
   */
  public BsTestChild2TestChild(com.poesys.db.test.ITestChild2TestChild dto) throws DelegateException {
    super(dto);
  }
   ...
   */
  public BsTestChild2TestChild(IPrimaryKey key, com.poesys.db.test.ITestChild downObject, com.poesys.db.test.ITestChild upObject, java.math.BigInteger upChildNo, java.math.BigInteger downChildNo, java.math.BigInteger upTestParentId, java.math.BigInteger downTestParentId) {
