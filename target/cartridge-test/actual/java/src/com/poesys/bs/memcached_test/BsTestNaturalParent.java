 ...
 */
public class BsTestNaturalParent extends com.poesys.bs.memcached_test.AbstractBsTestNaturalParent {
  /**
   ...
   */
  public BsTestNaturalParent(com.poesys.db.memcached_test.ITestNaturalParent dto) throws DelegateException {
    super(dto);
  }
