 ...
 */
public class BsTairObject extends com.poesys.bs.memcached_test.AbstractBsTairObject {
  /**
   ...
   */
  public BsTairObject(com.poesys.db.memcached_test.ITairObject dto) throws DelegateException {
    super(dto);
  }
