 ...
 */
public class BsSelf2Self extends com.poesys.bs.memcached_test.AbstractBsSelf2Self {
  /**
   ...
   */
  public BsSelf2Self(com.poesys.db.memcached_test.ISelf2Self dto) throws DelegateException {
    super(dto);
  }
   ...
   */
  public BsSelf2Self(IPrimaryKey key, com.poesys.db.memcached_test.ISelf2 children2Object, com.poesys.db.memcached_test.ISelf2 parents2Object, java.math.BigInteger parents2Self2Id, java.math.BigInteger children2Self2Id) {
