 ...
 */
public class BsTestX extends com.poesys.bs.memcached_test.AbstractBsTestX {
  /**
   ...
   */
  public BsTestX(com.poesys.db.memcached_test.ITestX dto) throws DelegateException {
    super(dto);
  }
