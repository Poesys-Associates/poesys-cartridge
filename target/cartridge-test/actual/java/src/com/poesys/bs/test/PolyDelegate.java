 ...
 * Poly objects and their dependents. This class delegates to an abstract
 * class, AbstractPolyDelegate. You can modify this class to override
 ...
 */
public class PolyDelegate extends AbstractPolyDelegate {
  /**
   * Create a PolyDelegate object with a supplied subsystem, using the
   * default database properties (usually for testing).
   * 
   * @param subsystem the subsystem to use
   */
  public PolyDelegate(String subsystem) {
    super(subsystem);
  }
  
  /**
   * Create a PolyDelegate object with a supplied subsystem and DBMS,
   * usually JNDI for production/test usage with an application server.
   * 
   * @param subsystem the subsystem to use
   * @param dbms the DBMS to use (usually IConnectionFactory.DBMS.JNDI)
   */
  public PolyDelegate(String subsystem, IConnectionFactory.DBMS dbms) {
