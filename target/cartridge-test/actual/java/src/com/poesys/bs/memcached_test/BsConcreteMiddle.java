 ...
 */
public class BsConcreteMiddle extends com.poesys.bs.memcached_test.AbstractBsConcreteMiddle {
  /**
   ...
   */
  public BsConcreteMiddle(com.poesys.db.memcached_test.IConcreteMiddle dto) throws DelegateException {
    super(dto);
  }
