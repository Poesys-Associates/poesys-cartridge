 ...
 */
public class BsTestSequenceKey extends com.poesys.bs.test.AbstractBsTestSequenceKey {
  /**
   ...
   */
  public BsTestSequenceKey(com.poesys.db.test.ITestSequenceKey dto) throws DelegateException {
    super(dto);
  }
