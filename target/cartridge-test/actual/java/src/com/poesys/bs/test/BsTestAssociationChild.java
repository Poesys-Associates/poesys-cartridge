 ...
 */
public class BsTestAssociationChild extends com.poesys.bs.test.AbstractBsTestAssociationChild {
  /**
   ...
   */
  public BsTestAssociationChild(com.poesys.db.test.ITestAssociationChild dto) throws DelegateException {
    super(dto);
  }
