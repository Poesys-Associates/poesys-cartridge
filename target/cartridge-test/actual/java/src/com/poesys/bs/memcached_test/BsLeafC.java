 ...
 */
public class BsLeafC extends com.poesys.bs.memcached_test.AbstractBsLeafC {
  /**
   ...
   */
  public BsLeafC(com.poesys.db.memcached_test.ILeafC dto) throws DelegateException {
    super(dto);
  }
