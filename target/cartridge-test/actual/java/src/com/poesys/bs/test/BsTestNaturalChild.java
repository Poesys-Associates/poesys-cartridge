 ...
 */
public class BsTestNaturalChild extends com.poesys.bs.test.AbstractBsTestNaturalChild {
  /**
   ...
   */
  public BsTestNaturalChild(com.poesys.db.test.ITestNaturalChild dto) throws DelegateException {
    super(dto);
  }
