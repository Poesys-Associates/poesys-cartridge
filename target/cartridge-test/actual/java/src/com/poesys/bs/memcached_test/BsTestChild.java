 ...
 */
public class BsTestChild extends com.poesys.bs.memcached_test.AbstractBsTestChild {
  /**
   ...
   */
  public BsTestChild(com.poesys.db.memcached_test.ITestChild dto) throws DelegateException {
    super(dto);
  }
