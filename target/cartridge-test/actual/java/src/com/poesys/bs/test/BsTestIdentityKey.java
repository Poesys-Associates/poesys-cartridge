 ...
 */
public class BsTestIdentityKey extends com.poesys.bs.test.AbstractBsTestIdentityKey {
  /**
   ...
   */
  public BsTestIdentityKey(com.poesys.db.test.ITestIdentityKey dto) throws DelegateException {
    super(dto);
  }
