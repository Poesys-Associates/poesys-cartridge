 ...
 */
public class BsTestNaturalKey extends com.poesys.bs.memcached_test.AbstractBsTestNaturalKey {
  /**
   ...
   */
  public BsTestNaturalKey(com.poesys.db.memcached_test.ITestNaturalKey dto) throws DelegateException {
    super(dto);
  }
