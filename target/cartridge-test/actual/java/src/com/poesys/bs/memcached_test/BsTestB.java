 ...
 */
public class BsTestB extends com.poesys.bs.memcached_test.AbstractBsTestB {
  /**
   ...
   */
  public BsTestB(com.poesys.db.memcached_test.ITestB dto) throws DelegateException {
    super(dto);
  }
