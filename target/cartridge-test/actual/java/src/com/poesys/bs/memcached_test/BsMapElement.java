 ...
 */
public class BsMapElement extends com.poesys.bs.memcached_test.AbstractBsMapElement {
  /**
   ...
   */
  public BsMapElement(com.poesys.db.memcached_test.IMapElement dto) throws DelegateException {
    super(dto);
  }
   ...
   * @param elementType 
   */
  public BsMapElement(IPrimaryKey key, com.poesys.db.memcached_test.IMap mapsObject, com.poesys.db.memcached_test.IPoly polysObject, java.math.BigInteger tairObjectId, java.math.BigInteger polyId, java.math.BigInteger mapId, java.lang.Integer version, java.lang.String elementType) {
    super(key, mapsObject, polysObject, tairObjectId, polyId, mapId, version, elementType); 
  }
}