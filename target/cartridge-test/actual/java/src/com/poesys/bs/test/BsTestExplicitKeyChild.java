 ...
 */
public class BsTestExplicitKeyChild extends com.poesys.bs.test.AbstractBsTestExplicitKeyChild {
  /**
   ...
   */
  public BsTestExplicitKeyChild(com.poesys.db.test.ITestExplicitKeyChild dto) throws DelegateException {
    super(dto);
  }
