 ...
 */
public class BsTestParent extends com.poesys.bs.memcached_test.AbstractBsTestParent {
  /**
   ...
   */
  public BsTestParent(com.poesys.db.memcached_test.ITestParent dto) throws DelegateException {
    super(dto);
  }
