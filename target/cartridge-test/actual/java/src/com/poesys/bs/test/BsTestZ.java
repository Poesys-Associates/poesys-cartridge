 ...
 */
public class BsTestZ extends com.poesys.bs.test.AbstractBsTestZ {
  /**
   ...
   */
  public BsTestZ(com.poesys.db.test.ITestZ dto) throws DelegateException {
    super(dto);
  }
   ...
   * @param zAttr 
   */
  public BsTestZ(IPrimaryKey key, com.poesys.db.test.ITestX xsObject, com.poesys.db.test.ITestY ysObject, java.math.BigInteger testXId, java.math.BigInteger testYId, java.lang.String zAttr) {
