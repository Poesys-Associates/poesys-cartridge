...
/**
 * <p>
 * A single-object query of a TestX using its primary key. This class
 * is the concrete subclass of the generated abstract class AbstractQueryTestX. 
 ...
 * single TestX object from the database.
 * </p>
${dto.getDocumentation}
 * 
 * @author Poesys/DB Cartridge
 */
public class QueryTestX extends AbstractQueryTestX {
}