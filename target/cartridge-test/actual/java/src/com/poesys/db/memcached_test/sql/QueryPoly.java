...
/**
 * <p>
 * A single-object query of a Poly using its primary key. This class
 * is the concrete subclass of the generated abstract class AbstractQueryPoly. 
 ...
 * single Poly object from the database.
 * </p>
${dto.getDocumentation}
 * 
 * @author Poesys/DB Cartridge
 */
public class QueryPoly extends AbstractQueryPoly {
}