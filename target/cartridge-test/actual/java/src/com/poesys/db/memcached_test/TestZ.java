...
public class TestZ extends AbstractTestZ {
   ...
   * @param zAttr 
   */
  public TestZ(IPrimaryKey key, com.poesys.db.memcached_test.ITestX xsObject, com.poesys.db.memcached_test.ITestY ysObject, java.math.BigInteger testXId, java.math.BigInteger testYId, java.lang.String zAttr) {
