...
/**
 * <p>
 * A single-object query of a TestA using its primary key. This class
 * is the concrete subclass of the generated abstract class AbstractQueryTestA. 
 ...
 * single TestA object from the database.
 * </p>
${dto.getDocumentation}
 * 
 * @author Poesys/DB Cartridge
 */
public class QueryTestA extends AbstractQueryTestA {
}