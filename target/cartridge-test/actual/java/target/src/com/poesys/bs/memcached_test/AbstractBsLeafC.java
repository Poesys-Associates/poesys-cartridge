...
import com.poesys.db.memcached_test.ILeafC;
import com.poesys.db.memcached_test.LeafCProxy;
import com.poesys.db.memcached_test.LeafC;


/**
 * <p>
 * A business layer data-transfer object (DTO) for the LeafC. This class
 ...
 */
public abstract class AbstractBsLeafC 
    extends AbstractDto<com.poesys.db.memcached_test.ILeafC> {
   ...
   */
  public AbstractBsLeafC(ILeafC dto) throws DelegateException {
    super(dto);
  }

  /**
   * Create a LeafC from new data.
   *
   ...
   * @param cString 
   */
  public AbstractBsLeafC(IPrimaryKey key, java.math.BigInteger baseId, java.lang.String baseString, java.lang.String middleString, java.lang.String cString) {
    super(new LeafCProxy(new LeafC(key, baseId, baseString, middleString, cString)));
  }
  ...
  public boolean equals(Object arg0) {
    // Unchecked cast here
    IDto<ILeafC> other = (IDto<ILeafC>)arg0;
  ...
  public int compareTo(IDto<ILeafC> o) {
...
// Read/Write property: true
   ...
   * <ul>
   * <li>Property is read/write: true</li>
   * <li>Property is defined in the data-access object LeafC</li>
   * </ul>
   * </p>
   * @return a java.lang.String cString
   */
  public java.lang.String getCString() {
    return dto.getCString();
  }
   ...
   * </ul>
   * </p>
   * @param cString the associated business object
   * @throws com.poesys.db.dto.DtoStatusException when the system can't set
   *                 the data-access status to CHANGED
   */
  public void setCString(java.lang.String cString) 
      throws com.poesys.db.dto.DtoStatusException {
    dto.setCString(cString);
  }
}