...
public abstract class AbstractTestY extends AbstractDto implements ITestY {
   ...
   *
   * @see com.poesys.db.test.sql.QueryXsByTestY
   */
  private class QueryXsSetter 
      extends com.poesys.db.dto.AbstractListSetter<com.poesys.db.test.ITestX, ITestY, java.util.Collection<com.poesys.db.test.ITestX>> {
    private static final long serialVersionUID = 1L;
    ...
    protected String getClassName() {
      return com.poesys.db.test.TestX.class.getName();
    }
    ...
    @Override
    protected com.poesys.db.dao.query.IParameterizedQuerySql<com.poesys.db.test.ITestX, ITestY> getSql() {
      return new com.poesys.db.test.sql.QueryXsByTestY();
    }

    @Override
    protected void set(java.util.Collection<com.poesys.db.test.ITestX> list) {
   ...
   * Source: TransformToProperty + AddToManyAssociationCollectionProperties
   *
   * @see com.poesys.db.test.sql.QueryTestX
   */
  private class ReadXsSetter 
      extends com.poesys.db.dto.AbstractCollectionReadSetter<com.poesys.db.test.ITestX> {
    private static final long serialVersionUID = 1L;
    ...
    @Override
    protected java.util.Collection<com.poesys.db.test.ITestX> getObjectCollection() {
      return xs;
    }
    ...
    @Override
    protected com.poesys.db.dao.query.IKeyQuerySql<com.poesys.db.test.ITestX> getSql() {
      return new com.poesys.db.test.sql.QueryTestX();
    }

    @Override
    protected void set(java.util.Collection<com.poesys.db.test.ITestX> collection) {
     xs = collection;
    }
  }
   ...
   *
   * @see com.poesys.db.test.sql.InsertTestX
   */
  ...
  private class UpdateXsSetter 
      extends com.poesys.db.dto.AbstractProcessNestedObjects<com.poesys.db.test.ITestX, java.util.Collection<com.poesys.db.test.ITestX>> {
    private static final long serialVersionUID = 1L;
    ...
    @Override
    protected void doChanged(java.sql.Connection connection, java.util.Collection<com.poesys.db.test.ITestX> dtos)
      ...
      com.poesys.db.dao.IDaoFactory<com.poesys.db.test.ITestX> factory = 
        manager.getFactory(com.poesys.db.test.TestX.class.getName(), subsystem, 2147483647);
      com.poesys.db.dao.update.IUpdateBatch<com.poesys.db.test.ITestX> updater =
        factory.getUpdateBatch(new com.poesys.db.test.sql.UpdateTestX());
    ...
    @Override
    protected void doDeleted(java.sql.Connection connection, java.util.Collection<com.poesys.db.test.ITestX> dtos)
        throws java.sql.SQLException, com.poesys.db.BatchException, com.poesys.db.ConstraintViolationException,
        com.poesys.db.dto.DtoStatusException {
      com.poesys.db.dao.IDaoManager manager = 
        com.poesys.db.dao.DaoManagerFactory.getManager(subsystem);
      com.poesys.db.dao.IDaoFactory<com.poesys.db.test.ITestX> factory = 
        manager.getFactory(com.poesys.db.test.TestX.class.getName(), subsystem, 2147483647);
      com.poesys.db.dao.delete.IDeleteBatch<com.poesys.db.test.ITestX> dao = 
        factory.getDeleteBatch(new com.poesys.db.test.sql.DeleteTestX());
      dao.delete(connection, dtos, BATCH_SIZE);
    }

    @Override
    protected void doNew(java.sql.Connection connection, java.util.Collection<com.poesys.db.test.ITestX> dtos)
        throws java.sql.SQLException, com.poesys.db.BatchException, com.poesys.db.ConstraintViolationException,
        com.poesys.db.dto.DtoStatusException {
      com.poesys.db.dao.IDaoManager manager = 
        com.poesys.db.dao.DaoManagerFactory.getManager(subsystem);
      ...
      com.poesys.db.dao.IDaoFactory<com.poesys.db.test.ITestX> factory = 
        manager.getFactory(com.poesys.db.test.TestX.class.getName(), subsystem, 2147483647);
      com.poesys.db.dao.insert.IInsertBatch<com.poesys.db.test.ITestX> inserter =
        factory.getInsertBatch(new com.poesys.db.test.sql.InsertTestX());
    ...
    @Override
    protected java.util.Collection<com.poesys.db.test.ITestX> getDtos() {
      return xs;
    }
  ...
  /**
   * Add com.poesys.db.test.ITestX object to xs collection.
   * 
   * @param object the com.poesys.db.test.ITestX object
   */
  public void addXsTestX(com.poesys.db.test.ITestX object) {
    if (xs == null) {
      // Association not yet created, create it.
      xs = new java.util.concurrent.CopyOnWriteArrayList<com.poesys.db.test.ITestX>();
    }
    xs.add(object);
   ...
   *
   * @see com.poesys.db.test.sql.QueryZsByTestY
   */
  private class QueryZsSetter 
      extends com.poesys.db.dto.AbstractListSetter<com.poesys.db.test.ITestZ, ITestY, java.util.Collection<com.poesys.db.test.ITestZ>> {
    private static final long serialVersionUID = 1L;
    private static final int FETCH_SIZE = 10;
    ...
    @Override
    protected com.poesys.db.dao.query.IParameterizedQuerySql<com.poesys.db.test.ITestZ, ITestY> getSql() {
      return new com.poesys.db.test.sql.QueryZsByTestY();
    }

    @Override
    protected void set(java.util.Collection<com.poesys.db.test.ITestZ> list) {
      // No status change; this is just filling in the object data.
      zs = list;
      // Add the primary keys to the serialized key list if there are any.
      if (zs != null) {
   ...
   *
   * @see com.poesys.db.test.sql.InsertTestZ
   */
  ...
  private class UpdateZsSetter 
      extends com.poesys.db.dto.AbstractProcessNestedObjects<com.poesys.db.test.ITestZ, java.util.Collection<com.poesys.db.test.ITestZ>> {
    private static final long serialVersionUID = 1L;
    private static final int BATCH_SIZE = 100;
    ...
    @Override
    protected void doChanged(java.sql.Connection connection, java.util.Collection<com.poesys.db.test.ITestZ> dtos)
        throws java.sql.SQLException, com.poesys.db.BatchException, com.poesys.db.ConstraintViolationException,
        com.poesys.db.dto.DtoStatusException {
      ...
      com.poesys.db.dao.IDaoFactory<com.poesys.db.test.ITestZ> factory = 
        manager.getFactory(com.poesys.db.test.TestZ.class.getName(), subsystem, 2147483647);
      com.poesys.db.dao.update.IUpdateBatch<com.poesys.db.test.ITestZ> updater =
        factory.getUpdateBatch(new com.poesys.db.test.sql.UpdateTestZ());
    ...
    @Override
    protected void doDeleted(java.sql.Connection connection, java.util.Collection<com.poesys.db.test.ITestZ> dtos)
        throws java.sql.SQLException, com.poesys.db.BatchException, com.poesys.db.ConstraintViolationException,
        com.poesys.db.dto.DtoStatusException {
      com.poesys.db.dao.IDaoManager manager = 
        com.poesys.db.dao.DaoManagerFactory.getManager(subsystem);
      com.poesys.db.dao.IDaoFactory<com.poesys.db.test.ITestZ> factory = 
        manager.getFactory(com.poesys.db.test.TestZ.class.getName(), subsystem, 2147483647);
      com.poesys.db.dao.delete.IDeleteBatch<com.poesys.db.test.ITestZ> dao = 
        factory.getDeleteBatch(new com.poesys.db.test.sql.DeleteTestZ());
      dao.delete(connection, dtos, BATCH_SIZE);
    }

    @Override
    protected void doNew(java.sql.Connection connection, java.util.Collection<com.poesys.db.test.ITestZ> dtos)
        throws java.sql.SQLException, com.poesys.db.BatchException, com.poesys.db.ConstraintViolationException,
        com.poesys.db.dto.DtoStatusException {
      com.poesys.db.dao.IDaoManager manager = 
        com.poesys.db.dao.DaoManagerFactory.getManager(subsystem);
      ...
      com.poesys.db.dao.IDaoFactory<com.poesys.db.test.ITestZ> factory = 
        manager.getFactory(com.poesys.db.test.TestZ.class.getName(), subsystem, 2147483647);
      com.poesys.db.dao.insert.IInsertBatch<com.poesys.db.test.ITestZ> inserter =
        factory.getInsertBatch(new com.poesys.db.test.sql.InsertTestZ());
    ...
    @Override
    protected java.util.Collection<com.poesys.db.test.ITestZ> getDtos() {
      return zs;
    }
  ...
  /**
   * Add com.poesys.db.test.ITestZ object to zs collection.
   * 
   * @param object the com.poesys.db.test.ITestZ object
   */
  public void addZsTestZ(com.poesys.db.test.ITestZ object) {
    if (zs == null) {
      // Association not yet created, create it.
      zs = new java.util.concurrent.CopyOnWriteArrayList<com.poesys.db.test.ITestZ>();
    }
    zs.add(object);
    // Add the primary key to the primary key array.
    zsKeys.add(object.getPrimaryKey());
  ...
  transient java.util.Collection<com.poesys.db.test.ITestX> xs;
  // Ordered list of keys of the objects in the xs list
  java.util.List<com.poesys.db.pk.IPrimaryKey> xKeys = 
    new java.util.ArrayList<com.poesys.db.pk.IPrimaryKey>();
  
  /**
   * Get a collection of com.poesys.db.test.ITestX.
   *
   * Source: TransformToProperty + AddToManyAssociationCollectionProperties
   * 
   * @return a java.util.Collection<com.poesys.db.test.ITestX>
   */

  public java.util.Collection<com.poesys.db.test.ITestX> getXs() {
    return xs;
  }
   ...
   */
  public  void setX(java.util.Collection<com.poesys.db.test.ITestX> xs) {
    this.xs = xs;
   ...
   */
  // Doesn't serialize; package access allows proxy to set on readObject()
  transient java.util.Collection<com.poesys.db.test.ITestZ> zs;
  ...
  public void update(com.poesys.db.dto.ISubject subject,
    ...
    // Clean up zs.
    if (subject != null && subject instanceof com.poesys.db.test.ITestZ && 
    ...
    if (event == com.poesys.db.dao.DataEvent.MARKED_DELETED &&
      ...
      outer: for (com.poesys.db.test.ITestZ value : zs) {
  ...
  private void createInserters() {
    ...
    final com.poesys.db.dao.IDaoFactory<com.poesys.db.test.ITestY> testYFactory =
      manager.getFactory("com.poesys.db.test.TestY",
                         getSubsystem(),
                         2147483647);
    com.poesys.db.dao.insert.IInsertSql<ITestY> sql =
      new com.poesys.db.test.sql.InsertTestY();
