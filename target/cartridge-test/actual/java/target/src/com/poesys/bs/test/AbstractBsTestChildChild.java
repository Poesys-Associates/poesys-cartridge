...
import com.poesys.db.test.ITestChildChild;
import com.poesys.db.test.TestChildChildProxy;
import com.poesys.db.test.TestChildChild;
...
public abstract class AbstractBsTestChildChild 
    extends AbstractDto<com.poesys.db.test.ITestChildChild> {
   ...
   * </ul>
   * </p>
   * @return a com.poesys.bs.test.BsTestChild childParent
   */
  public com.poesys.bs.test.BsTestChild getChildParent() {
    // Return 4
    return new com.poesys.bs.test.BsTestChild(dto.getChildParent());
  }
}