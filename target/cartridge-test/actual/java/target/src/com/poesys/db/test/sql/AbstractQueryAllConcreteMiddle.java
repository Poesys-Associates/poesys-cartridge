 ...
 */
public abstract class AbstractQueryAllConcreteMiddle implements IQuerySql<com.poesys.db.test.IConcreteMiddle> {
  ...
  public com.poesys.db.test.IConcreteMiddle getData(ResultSet rs) throws SQLException {
    IPrimaryKey key = 
      TestFactory.getConcreteMiddlePrimaryKey(rs, "");
    ...
    if (discriminant.equals("LeafC") && data == null) {
      ...
      data = 
        (com.poesys.db.test.IConcreteMiddle)com.poesys.db.test.TestFactory.getLeafCData(key, rs);
    }
    return data;
  }
  ...
  public IPrimaryKey getPrimaryKey(ResultSet rs) throws SQLException,
    ...
    return TestFactory.getConcreteMiddlePrimaryKey(rs, "");
  }
