...
// Read/Write property: true
   ...
   * </p>
   * @return a java.util.List<com.poesys.db.test.IMap> maps
   */
...
// Read/Write property: true
   ...
   * @throws com.poesys.db.dto.DtoStatusException when the status cannot be set to CHANGED
   */
  public void setMap(java.util.List<com.poesys.db.test.IMap> maps) throws com.poesys.db.dto.DtoStatusException;
