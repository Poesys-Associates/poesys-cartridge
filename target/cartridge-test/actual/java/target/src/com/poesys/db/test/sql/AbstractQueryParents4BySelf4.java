 ...
 * Self4 object through the association Parents4 using the 
 ...
 */
public abstract class AbstractQueryParents4BySelf4 
    implements IParameterizedQuerySql<com.poesys.db.test.ISelf4, com.poesys.db.test.ISelf4> {
  /** SQL query statement for Self4 */
  private static final String SQL =
    "SELECT a.key1, a.key2 FROM Self4 a JOIN Self4Self b ON a.key1 = b.parents4Parent AND a.key2 = b.parents4Parent WHERE b.children4Child = ? AND b.children4Child = ?";
