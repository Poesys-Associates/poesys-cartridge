 ...
 */
public abstract class AbstractQueryMiddle implements IKeyQuerySql<com.poesys.db.memcached_test.IMiddle> {
  ...
  public com.poesys.db.memcached_test.IMiddle getData(IPrimaryKey key, ResultSet rs) throws SQLException {
