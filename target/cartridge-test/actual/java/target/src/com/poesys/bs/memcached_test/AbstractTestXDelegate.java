 ...
 * TestX objects and their dependents. You should not modify this class;
 * instead, override or add methods in the class TestXDelegate, which
 ...
 */
public abstract class AbstractTestXDelegate
    extends AbstractDataDelegate<BsTestX, com.poesys.db.memcached_test.ITestX, com.poesys.db.pk.SequencePrimaryKey> {
  /**
   * Create an AbstractTestXDelegate object by supplying the database
   * subsystem in the database.properties file.
   * 
   * @param subsystem the database subsystem to use in database.properties
   */
  public AbstractTestXDelegate(String subsystem) {
   ...
   */
  public AbstractTestXDelegate(String subsystem, DBMS dbms) {
  ...
  @Override
  protected IInsertSql<com.poesys.db.memcached_test.ITestX> getInsertSql() {
    return new com.poesys.db.memcached_test.sql.InsertTestX();
  }

  @Override
  protected IDeleteSql<com.poesys.db.memcached_test.ITestX> getDeleteSql() {
    return new com.poesys.db.memcached_test.sql.DeleteTestX();
  }

  @Override
  protected IUpdateSql<com.poesys.db.memcached_test.ITestX> getUpdateSql() {
    return new com.poesys.db.memcached_test.sql.UpdateTestX();
  }

  @Override
  protected IKeyQuerySql<com.poesys.db.memcached_test.ITestX> getQueryByKeySql() {
    return new com.poesys.db.memcached_test.sql.QueryTestX();
  }

  @Override
  protected IQuerySql<com.poesys.db.memcached_test.ITestX> getQueryListSql() {
    // Query-All method not required
    return new com.poesys.db.memcached_test.sql.QueryAllTestX();
  }

  @Override
  protected com.poesys.bs.memcached_test.BsTestX wrapData(com.poesys.db.memcached_test.ITestX dto) {
    return new com.poesys.bs.memcached_test.BsTestX(dto);
  }

  /**
   * <p>
   * Create a new TestX with data fields.
   * </p>
   * <p>
   * The TestX class has a sequence key; this method generates the
   * sequence for later insertion into the database.
   * </p>
   * 
   * @param testXId primary key attribute
   * @param xAttr 
   * @return the new TestX object
   * @throws DelegateException when there is a problem generating the key or
   *             creating the object
   */
  public com.poesys.bs.memcached_test.BsTestX createTestX(java.math.BigInteger testXId, java.lang.String xAttr)
      throws DelegateException {
      com.poesys.db.pk.SequencePrimaryKey key = null;

    // Generate a new TestX id if the input key is null.
    if (testXId == null) {
        ...
        if (dbms.equals(DBMS.MYSQL) || dbms.equals(DBMS.JNDI_MYSQL)) {
          key =
            com.poesys.db.pk.PrimaryKeyFactory.createMySqlSequenceKey(connection,
                                                                      "TestX",
                                                                      "testXId",
                                                                      "com.poesys.db.memcached_test.TestX");
        } else if (dbms.equals(DBMS.ORACLE) || dbms.equals(DBMS.JNDI_ORACLE)) {
          // Create key with sequence TestX
          key =
    ...
    com.poesys.db.memcached_test.ITestX dto =
      new com.poesys.db.memcached_test.TestXProxy(new com.poesys.db.memcached_test.TestX(key, testXId, xAttr));
  ...
  /**
   * Create a new TestAssociationChild child of TestX with a composite key.
   * 
...
Natural Parent, identified by the zKey TestZ object
   ...
   */
  public com.poesys.bs.memcached_test.BsTestAssociationChild createTestAssociationChild(com.poesys.bs.memcached_test.BsTestX parent, java.lang.Long key1, java.lang.Long key2, java.math.BigInteger testXId, java.math.BigInteger testYId, java.lang.Long tsACAttr) throws DelegateException {
    // Create the key.
  ...
  /**
   * Create a new TestZ association class child of TestX with 
   ...
   * @throws DelegateException when a parameter causes a problem
   */
  public com.poesys.bs.memcached_test.BsTestZ createTestZ(com.poesys.bs.memcached_test.BsTestX xsObject, com.poesys.bs.memcached_test.BsTestY ysObject, java.math.BigInteger testXId, java.math.BigInteger testYId, java.lang.String zAttr) throws DelegateException {
    // Create the key.
    ...
    try {
      ...
      key = 
        com.poesys.db.pk.PrimaryKeyFactory.createAssociationKey(list, "com.poesys.db.memcached_test.TestZ");
    } catch (com.poesys.db.InvalidParametersException e) {
      Object[] args = e.getParameters().toArray();
      String message = com.poesys.db.Message.getMessage(e.getMessage(), args);
      throw new DelegateException(message, e);
    ...
    com.poesys.db.memcached_test.ITestZ dto =
      new com.poesys.db.memcached_test.TestZProxy(new com.poesys.db.memcached_test.TestZ(key, xsObject.toDto(), ysObject.toDto(), testXId, testYId, zAttr));
  ...
  public void truncateTable(String tableName) throws DelegateException {
    ...
    try {
      ...
      throw new DelegateException(e.getMessage() + ": " + "TestX", e);
    }
  }
}
