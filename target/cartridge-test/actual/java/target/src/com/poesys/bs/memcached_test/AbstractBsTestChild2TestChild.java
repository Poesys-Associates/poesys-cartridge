...
import com.poesys.db.memcached_test.ITestChild2TestChild;
import com.poesys.db.memcached_test.TestChild2TestChildProxy;
import com.poesys.db.memcached_test.TestChild2TestChild;
...
public abstract class AbstractBsTestChild2TestChild 
    extends AbstractDto<com.poesys.db.memcached_test.ITestChild2TestChild> {
   ...
   * com.poesys.db.memcached_test.ITC2TC2TC2TC objects
   */
  private class BsTc1TC2TC2TC2TCLinksCollectionBuilder 
      extends com.poesys.bs.dto.CollectionBuilder<com.poesys.db.memcached_test.ITC2TC2TC2TC, com.poesys.bs.memcached_test.BsTC2TC2TC2TC> {
    @Override
    public com.poesys.bs.memcached_test.BsTC2TC2TC2TC get(com.poesys.db.memcached_test.ITC2TC2TC2TC dto) {
   ...
   */
  public AbstractBsTestChild2TestChild(IPrimaryKey key, com.poesys.db.memcached_test.ITestChild downObject, com.poesys.db.memcached_test.ITestChild upObject, java.math.BigInteger downChildNo, java.math.BigInteger upChildNo, java.math.BigInteger downTestParentId, java.math.BigInteger upTestParentId) {
   ...
   * </ul>
   * </p>
   * @return a com.poesys.bs.memcached_test.BsTestChild2TestChild tc2TC2TC2TC2TCLinks
   */
  public java.util.Collection<com.poesys.bs.memcached_test.BsTestChild2TestChild> getTc1() {
   ...
   * @return a com.poesys.bs.memcached_test.BsTestChild2TestChild tc2TC2TC2TC2TCLinks
   */
  public java.util.Collection<com.poesys.bs.memcached_test.BsTestChild2TestChild> getTc2() {
   ...
   * </ul>
   * </p>
   * @return a com.poesys.bs.memcached_test.BsTC2TC2TC2TC tc2TC2TC2TC2TCLinks
   */
  public java.util.Collection<com.poesys.bs.memcached_test.BsTC2TC2TC2TC> getTc1TC2TC2TC2TCLinks() {
   ...
   * @return a com.poesys.bs.memcached_test.BsTC2TC2TC2TC tc2TC2TC2TC2TCLinks
   */
  public java.util.Collection<com.poesys.bs.memcached_test.BsTC2TC2TC2TC> getTc2TC2TC2TC2TCLinks() {
   ...
   * </ul>
   * </p>
   * @return a com.poesys.bs.memcached_test.BsTestChild up
   */
  public com.poesys.bs.memcached_test.BsTestChild getUp() {
    // Return 4
    return new com.poesys.bs.memcached_test.BsTestChild(dto.getUp());
  }
   ...
   * </ul>
   * </p>
   * @return a com.poesys.bs.memcached_test.BsTestChild down
   */
  public com.poesys.bs.memcached_test.BsTestChild getDown() {
    // Return 4
    return new com.poesys.bs.memcached_test.BsTestChild(dto.getDown());
  }
