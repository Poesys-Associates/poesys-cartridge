...
public abstract class AbstractQueryParents2BySelf2 
    implements IParameterizedQuerySql<com.poesys.db.test.ISelf2, com.poesys.db.test.ISelf2> {
  ...
  public com.poesys.db.test.ISelf2 getData(ResultSet rs) 
      throws SQLException, ConstraintViolationException {
    IPrimaryKey key = 
      com.poesys.db.test.TestFactory.getSelf2PrimaryKey(rs, "");
    return com.poesys.db.test.TestFactory.getSelf2Data(key, rs);
  }

  public IPrimaryKey getPrimaryKey(ResultSet rs) throws SQLException,
      InvalidParametersException {
    return com.poesys.db.test.TestFactory.getSelf2PrimaryKey(rs, "");
  }
