 ...
 */
public abstract class AbstractQueryTestY implements IKeyQuerySql<com.poesys.db.test.ITestY> {
  /** SQL query statement for TestY */
  private static final String SQL =
    "SELECT testYId, yAttr FROM TestY WHERE ";

  public com.poesys.db.test.ITestY getData(IPrimaryKey key, ResultSet rs) throws SQLException {
