...
public abstract class AbstractTestX extends AbstractDto implements ITestX {
   ...
   *
   * @see com.poesys.db.test.sql.InsertTestY
   */
  ...
  private class UpdateYsSetter 
      extends com.poesys.db.dto.AbstractProcessNestedObjects<com.poesys.db.test.ITestY, java.util.Collection<com.poesys.db.test.ITestY>> {
    private static final long serialVersionUID = 1L;
    ...
    @Override
    protected void doChanged(java.sql.Connection connection, java.util.Collection<com.poesys.db.test.ITestY> dtos)
      ...
      com.poesys.db.dao.IDaoFactory<com.poesys.db.test.ITestY> factory = 
        manager.getFactory(com.poesys.db.test.TestY.class.getName(), subsystem, 2147483647);
      com.poesys.db.dao.update.IUpdateBatch<com.poesys.db.test.ITestY> updater =
        factory.getUpdateBatch(new com.poesys.db.test.sql.UpdateTestY());
    ...
    @Override
    protected void doDeleted(java.sql.Connection connection, java.util.Collection<com.poesys.db.test.ITestY> dtos)
        throws java.sql.SQLException, com.poesys.db.BatchException, com.poesys.db.ConstraintViolationException,
        com.poesys.db.dto.DtoStatusException {
      com.poesys.db.dao.IDaoManager manager = 
        com.poesys.db.dao.DaoManagerFactory.getManager(subsystem);
      com.poesys.db.dao.IDaoFactory<com.poesys.db.test.ITestY> factory = 
        manager.getFactory(com.poesys.db.test.TestY.class.getName(), subsystem, 2147483647);
      com.poesys.db.dao.delete.IDeleteBatch<com.poesys.db.test.ITestY> dao = 
        factory.getDeleteBatch(new com.poesys.db.test.sql.DeleteTestY());
      dao.delete(connection, dtos, BATCH_SIZE);
    }

    @Override
    protected void doNew(java.sql.Connection connection, java.util.Collection<com.poesys.db.test.ITestY> dtos)
        throws java.sql.SQLException, com.poesys.db.BatchException, com.poesys.db.ConstraintViolationException,
        com.poesys.db.dto.DtoStatusException {
      com.poesys.db.dao.IDaoManager manager = 
        com.poesys.db.dao.DaoManagerFactory.getManager(subsystem);
      ...
      com.poesys.db.dao.IDaoFactory<com.poesys.db.test.ITestY> factory = 
        manager.getFactory(com.poesys.db.test.TestY.class.getName(), subsystem, 2147483647);
      com.poesys.db.dao.insert.IInsertBatch<com.poesys.db.test.ITestY> inserter =
        factory.getInsertBatch(new com.poesys.db.test.sql.InsertTestY());
    ...
    @Override
    protected java.util.Collection<com.poesys.db.test.ITestY> getDtos() {
      return ys;
    }
  ...
  /**
   * Add com.poesys.db.test.ITestY object to ys collection.
   * 
   * @param object the com.poesys.db.test.ITestY object
   */
  public void addYsTestY(com.poesys.db.test.ITestY object) {
    if (ys == null) {
      // Association not yet created, create it.
      ys = new java.util.concurrent.CopyOnWriteArrayList<com.poesys.db.test.ITestY>();
    }
    ys.add(object);
   ...
   *
   * @see com.poesys.db.test.sql.QueryZsByTestX
   */
  private class QueryZsSetter 
      extends com.poesys.db.dto.AbstractListSetter<com.poesys.db.test.ITestZ, ITestX, java.util.Collection<com.poesys.db.test.ITestZ>> {
    private static final long serialVersionUID = 1L;
    ...
    @Override
    protected com.poesys.db.dao.query.IParameterizedQuerySql<com.poesys.db.test.ITestZ, ITestX> getSql() {
      return new com.poesys.db.test.sql.QueryZsByTestX();
    }
  ...
  transient java.util.Collection<com.poesys.db.test.ITestY> ys;
  ...
  private void createInserters() {
    ...
    final com.poesys.db.dao.IDaoFactory<com.poesys.db.test.ITestX> testXFactory =
      manager.getFactory("com.poesys.db.test.TestX",
                         getSubsystem(),
                         2147483647);
    com.poesys.db.dao.insert.IInsertSql<ITestX> sql =
      new com.poesys.db.test.sql.InsertTestX();
