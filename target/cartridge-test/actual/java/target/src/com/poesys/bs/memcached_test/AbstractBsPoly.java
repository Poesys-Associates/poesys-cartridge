...
import com.poesys.db.memcached_test.IPoly;
import com.poesys.db.memcached_test.PolyProxy;
import com.poesys.db.memcached_test.Poly;
...
public abstract class AbstractBsPoly 
    extends AbstractDto<com.poesys.db.memcached_test.IPoly> {

  /**
   * A List builder helper class for building a business-layer List 
   * of BsMap objects from a List maps of data-access-layer 
   * com.poesys.db.memcached_test.IMap objects
   */
  private class BsMapsListBuilder 
      extends com.poesys.bs.dto.ListBuilder<com.poesys.db.memcached_test.IMap, com.poesys.bs.memcached_test.BsMap> {
    @Override
    public com.poesys.bs.memcached_test.BsMap get(com.poesys.db.memcached_test.IMap dto) {
  ...
  private class MapsListBuilder 
      extends com.poesys.bs.dto.ListBuilder<com.poesys.bs.memcached_test.BsMap, com.poesys.db.memcached_test.IMap> {
    @Override
    public com.poesys.db.memcached_test.IMap get(com.poesys.bs.memcached_test.BsMap dto) {
      return dto.toDto();
    }
  }
   ...
   * </ul>
   * </p>
   * @return a com.poesys.bs.memcached_test.BsMap sequence
   */
  public java.util.List<com.poesys.bs.memcached_test.BsMap> getMaps() {
   ...
   *                 the data-access status to CHANGED
   */
  public void setMap(java.util.List<com.poesys.bs.memcached_test.BsMap> sequence) 
   ...
   * </ul>
   * </p>
   * @return a com.poesys.bs.memcached_test.BsMapElement sequence
   */
   ...
   *                 required but the input parameter sequence is null
   */
  public void setMapElement(java.util.Collection<com.poesys.bs.memcached_test.BsMapElement> sequence) 
      throws com.poesys.db.dto.DtoStatusException, com.poesys.db.InvalidParametersException {
   ...
   */
  public void addMapsMap(com.poesys.bs.memcached_test.BsMap object) {
