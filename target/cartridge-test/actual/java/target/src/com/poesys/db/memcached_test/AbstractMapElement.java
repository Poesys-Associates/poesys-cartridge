 ...
 */
public abstract class AbstractMapElement extends com.poesys.db.memcached_test.TairObject implements IMapElement {
   ...
   * @author Poesys/DB Cartridge
   */
  private class QueryMapSetter extends com.poesys.db.dto.AbstractObjectSetter<com.poesys.db.memcached_test.IMap> {
    private static final long serialVersionUID = 1L;
    ...
    @Override
    protected void set(com.poesys.db.memcached_test.IMap dto) {
  ...
  private class UpdateMapSetter 
      extends com.poesys.db.dto.AbstractProcessNestedObject<com.poesys.db.memcached_test.IMap> {
    private static final long serialVersionUID = 1L;
    ...
    @Override
    protected void doChanged(java.sql.Connection connection, com.poesys.db.memcached_test.IMap dto)
    ...
    @Override
    protected void doDeleted(java.sql.Connection connection, com.poesys.db.memcached_test.IMap dto)
        throws java.sql.SQLException, com.poesys.db.BatchException, com.poesys.db.ConstraintViolationException,
        com.poesys.db.dto.DtoStatusException {
      ...
      com.poesys.db.dao.delete.IDelete<com.poesys.db.memcached_test.IMap> dao = 
        factory.getDelete(new com.poesys.db.memcached_test.sql.DeleteMap());
      dao.delete(connection, dto);
    }

    @Override
    protected void doNew(java.sql.Connection connection, com.poesys.db.memcached_test.IMap dto)
        throws java.sql.SQLException, com.poesys.db.BatchException, com.poesys.db.ConstraintViolationException,
        com.poesys.db.dto.DtoStatusException {
      com.poesys.db.dao.IDaoManager manager = 
        com.poesys.db.dao.DaoManagerFactory.getManager(subsystem);
      com.poesys.db.dao.IDaoFactory<com.poesys.db.memcached_test.IMap> factory = 
        manager.getFactory(com.poesys.db.memcached_test.Map.class.getName(), subsystem, 2147483647);
      com.poesys.db.dao.insert.IInsert<com.poesys.db.memcached_test.IMap> inserter =
        factory.getInsert(new com.poesys.db.memcached_test.sql.InsertMap(), createKey());
      ...
      com.poesys.db.dao.insert.IInsert<com.poesys.db.memcached_test.ITairObject> tairObjectInserter =
        tairObjectFactory.getInsert(new com.poesys.db.memcached_test.sql.InsertTairObject(), false);
    ...
    @Override
    protected com.poesys.db.memcached_test.IMap getDto() {
      return map;
    }
   ...
   * @author Poesys/DB Cartridge
   */
  private class QueryPolySetter extends com.poesys.db.dto.AbstractObjectSetter<com.poesys.db.memcached_test.IPoly> {
    private static final long serialVersionUID = 1L;
    ...
    @Override
    protected void set(com.poesys.db.memcached_test.IPoly dto) {
      // No status change, this is just filling in the object data.
      poly = dto;
    }
  ...
  private class UpdatePolySetter 
      extends com.poesys.db.dto.AbstractProcessNestedObject<com.poesys.db.memcached_test.IPoly> {
    private static final long serialVersionUID = 1L;
    ...
    @Override
    protected void doChanged(java.sql.Connection connection, com.poesys.db.memcached_test.IPoly dto)
        throws java.sql.SQLException, com.poesys.db.BatchException, com.poesys.db.ConstraintViolationException,
        com.poesys.db.dto.DtoStatusException {
    ...
    @Override
    protected void doDeleted(java.sql.Connection connection, com.poesys.db.memcached_test.IPoly dto)
        throws java.sql.SQLException, com.poesys.db.BatchException, com.poesys.db.ConstraintViolationException,
        com.poesys.db.dto.DtoStatusException {
      com.poesys.db.dao.IDaoManager manager = 
        com.poesys.db.dao.DaoManagerFactory.getManager(subsystem);
      ...
      com.poesys.db.dao.delete.IDelete<com.poesys.db.memcached_test.IPoly> dao = 
        factory.getDelete(new com.poesys.db.memcached_test.sql.DeletePoly());
      dao.delete(connection, dto);
    }

    @Override
    protected void doNew(java.sql.Connection connection, com.poesys.db.memcached_test.IPoly dto)
        throws java.sql.SQLException, com.poesys.db.BatchException, com.poesys.db.ConstraintViolationException,
        com.poesys.db.dto.DtoStatusException {
      com.poesys.db.dao.IDaoManager manager = 
        com.poesys.db.dao.DaoManagerFactory.getManager(subsystem);
      com.poesys.db.dao.IDaoFactory<com.poesys.db.memcached_test.IPoly> factory = 
        manager.getFactory(com.poesys.db.memcached_test.Poly.class.getName(), subsystem, 2147483647);
      com.poesys.db.dao.insert.IInsert<com.poesys.db.memcached_test.IPoly> inserter =
        factory.getInsert(new com.poesys.db.memcached_test.sql.InsertPoly(), createKey());
    ...
    @Override
    protected com.poesys.db.memcached_test.IPoly getDto() {
      return poly;
    }
   ...
   * @param elementType 
   */
  public AbstractMapElement(IPrimaryKey key, com.poesys.db.memcached_test.IMap mapsObject, com.poesys.db.memcached_test.IPoly polysObject, java.math.BigInteger tairObjectId, java.math.BigInteger mapId, java.math.BigInteger polyId, java.lang.Integer version, java.lang.String elementType) {
   ...
   * Property is lazy: false
   */
  private com.poesys.db.memcached_test.IMap map;
   ...
   * Property is lazy: false
   */
  private com.poesys.db.memcached_test.IPoly poly;
  ...
  private void createInserters() {
    ...
    final com.poesys.db.dao.IDaoFactory<com.poesys.db.memcached_test.IMapElement> mapElementFactory =
      manager.getFactory("com.poesys.db.memcached_test.MapElement",
                         getSubsystem(),
                         2147483647);
    com.poesys.db.dao.insert.IInsertSql<IMapElement> sql =
      new com.poesys.db.memcached_test.sql.InsertMapElement();
