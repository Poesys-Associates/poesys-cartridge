...
public abstract class AbstractPoly extends AbstractDto implements IPoly {
   ...
   *
   * @see com.poesys.db.memcached_test.sql.QueryMapsByPoly
   */
  private class QueryMapsSetter 
      extends com.poesys.db.dto.AbstractListSetter<com.poesys.db.memcached_test.IMap, IPoly, java.util.List<com.poesys.db.memcached_test.IMap>> {
    private static final long serialVersionUID = 1L;
    ...
    @Override
    protected com.poesys.db.dao.query.IParameterizedQuerySql<com.poesys.db.memcached_test.IMap, IPoly> getSql() {
      return new com.poesys.db.memcached_test.sql.QueryMapsByPoly();
    }

    @Override
    protected void set(java.util.List<com.poesys.db.memcached_test.IMap> list) {
   ...
   * Source: TransformToProperty + AddToManyAssociationCollectionProperties
   *
   * @see com.poesys.db.memcached_test.sql.QueryMap
   */
  private class ReadMapsSetter 
      extends com.poesys.db.dto.AbstractListReadSetter<com.poesys.db.memcached_test.IMap> {
    private static final long serialVersionUID = 1L;
    ...
    @Override
    protected java.util.List<com.poesys.db.memcached_test.IMap> getObjectList() {
      return maps;
    }
    ...
    @Override
    protected com.poesys.db.dao.query.IKeyQuerySql<com.poesys.db.memcached_test.IMap> getSql() {
   ...
   *
   * @see com.poesys.db.memcached_test.sql.InsertMap
   */
  ...
  private class UpdateMapsSetter 
      extends com.poesys.db.dto.AbstractProcessNestedObjects<com.poesys.db.memcached_test.IMap, java.util.List<com.poesys.db.memcached_test.IMap>> {
    private static final long serialVersionUID = 1L;
    ...
    @Override
    protected void doChanged(java.sql.Connection connection, java.util.List<com.poesys.db.memcached_test.IMap> dtos)
      ...
      com.poesys.db.dao.IDaoFactory<com.poesys.db.memcached_test.IMap> factory = 
        manager.getFactory(com.poesys.db.memcached_test.Map.class.getName(), subsystem, 2147483647);
      com.poesys.db.dao.update.IUpdateBatch<com.poesys.db.memcached_test.IMap> updater =
        factory.getUpdateBatch(new com.poesys.db.memcached_test.sql.UpdateMap());
    ...
    @Override
    protected void doDeleted(java.sql.Connection connection, java.util.List<com.poesys.db.memcached_test.IMap> dtos)
        throws java.sql.SQLException, com.poesys.db.BatchException, com.poesys.db.ConstraintViolationException,
        com.poesys.db.dto.DtoStatusException {
      com.poesys.db.dao.IDaoManager manager = 
        com.poesys.db.dao.DaoManagerFactory.getManager(subsystem);
      com.poesys.db.dao.IDaoFactory<com.poesys.db.memcached_test.IMap> factory = 
        manager.getFactory(com.poesys.db.memcached_test.Map.class.getName(), subsystem, 2147483647);
      com.poesys.db.dao.delete.IDeleteBatch<com.poesys.db.memcached_test.IMap> dao = 
        factory.getDeleteBatch(new com.poesys.db.memcached_test.sql.DeleteMap());
      dao.delete(connection, dtos, BATCH_SIZE);
    }

    @Override
    protected void doNew(java.sql.Connection connection, java.util.List<com.poesys.db.memcached_test.IMap> dtos)
        throws java.sql.SQLException, com.poesys.db.BatchException, com.poesys.db.ConstraintViolationException,
        com.poesys.db.dto.DtoStatusException {
      com.poesys.db.dao.IDaoManager manager = 
        com.poesys.db.dao.DaoManagerFactory.getManager(subsystem);
      ...
      com.poesys.db.dao.IDaoFactory<com.poesys.db.memcached_test.IMap> factory = 
        manager.getFactory(com.poesys.db.memcached_test.Map.class.getName(), subsystem, 2147483647);
      com.poesys.db.dao.insert.IInsertBatch<com.poesys.db.memcached_test.IMap> inserter =
        factory.getInsertBatch(new com.poesys.db.memcached_test.sql.InsertMap());
      ...
      inserter.insert(connection, (java.util.Collection<com.poesys.db.memcached_test.IMap>)dtos, dtos.size() / 2);
    }

    @Override
    protected java.util.List<com.poesys.db.memcached_test.IMap> getDtos() {
      return maps;
    }
  ...
  /**
   * Add com.poesys.db.memcached_test.IMap object to maps collection.
   * 
   * @param object the com.poesys.db.memcached_test.IMap object
   */
  public void addMapsMap(com.poesys.db.memcached_test.IMap object) {
    if (maps == null) {
      // Association not yet created, create it.
      maps = new java.util.concurrent.CopyOnWriteArrayList<com.poesys.db.memcached_test.IMap>();
    }
    maps.add(object);
   ...
   *
   * @see com.poesys.db.memcached_test.sql.QueryMapElementByPoly
   */
  private class QueryMapElementSetter 
      extends com.poesys.db.dto.AbstractListSetter<com.poesys.db.memcached_test.IMapElement, IPoly, java.util.Collection<com.poesys.db.memcached_test.IMapElement>> {
    private static final long serialVersionUID = 1L;
    private static final int FETCH_SIZE = 10;
    ...
    @Override
    protected com.poesys.db.dao.query.IParameterizedQuerySql<com.poesys.db.memcached_test.IMapElement, IPoly> getSql() {
      return new com.poesys.db.memcached_test.sql.QueryMapElementByPoly();
    }
  ...
  transient java.util.List<com.poesys.db.memcached_test.IMap> maps;
  // Ordered list of keys of the objects in the maps list
  java.util.List<com.poesys.db.pk.IPrimaryKey> mapKeys = 
    new java.util.ArrayList<com.poesys.db.pk.IPrimaryKey>();
  
  /**
   * Get a list of com.poesys.db.memcached_test.IMap.
   *
   * Source: TransformToProperty + AddToManyAssociationCollectionProperties
   * 
   * @return a java.util.List<com.poesys.db.memcached_test.IMap>
   */
   ...
   */
  public  void setMap(java.util.List<com.poesys.db.memcached_test.IMap> maps) {
    this.maps = maps;
  ...
  private void createInserters() {
    ...
    final com.poesys.db.dao.IDaoFactory<com.poesys.db.memcached_test.IPoly> polyFactory =
      manager.getFactory("com.poesys.db.memcached_test.Poly",
                         getSubsystem(),
                         2147483647);
    com.poesys.db.dao.insert.IInsertSql<IPoly> sql =
      new com.poesys.db.memcached_test.sql.InsertPoly();
