 ...
 * TestZ objects in the database; use with caution
 * </p>
 * 
 * @author Poesys/DB Cartridge
 */
public abstract class AbstractQueryAllTestZ implements IQuerySql<com.poesys.db.memcached_test.ITestZ> {
  /** SQL query statement for TestZ */
  private static final String SQL =
    "SELECT testXId, testYId, zAttr FROM TestZ";

  public com.poesys.db.memcached_test.ITestZ getData(ResultSet rs) throws SQLException {
    IPrimaryKey key = 
      Memcached_testFactory.getTestZPrimaryKey(rs, "");
      
    return Memcached_testFactory.getTestZData(key, rs);
  }
