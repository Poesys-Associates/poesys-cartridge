...
import com.poesys.db.memcached_test.ITestA;
import com.poesys.db.memcached_test.TestAProxy;
import com.poesys.db.memcached_test.TestA;
...
public abstract class AbstractBsTestA 
    extends AbstractDto<com.poesys.db.memcached_test.ITestA> {

  /**
   * A List builder helper class for building a business-layer List 
   * of BsTestB objects from a List bs of data-access-layer 
   * com.poesys.db.memcached_test.ITestB objects
   */
  private class BsBsListBuilder 
      extends com.poesys.bs.dto.ListBuilder<com.poesys.db.memcached_test.ITestB, com.poesys.bs.memcached_test.BsTestB> {
    @Override
    public com.poesys.bs.memcached_test.BsTestB get(com.poesys.db.memcached_test.ITestB dto) {
   ...
   * </ul>
   * </p>
   * @return a com.poesys.bs.memcached_test.BsTestB testAId
   */
  public java.util.List<com.poesys.bs.memcached_test.BsTestB> getBs() {
