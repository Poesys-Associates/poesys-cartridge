 ...
 */
public abstract class AbstractLeafB extends com.poesys.db.test.Middle implements ILeafB {
  ...
  private void createInserters() {
    ...
    final com.poesys.db.dao.IDaoFactory<com.poesys.db.test.ILeafB> leafBFactory =
      manager.getFactory("com.poesys.db.test.LeafB",
                         getSubsystem(),
                         2147483647);
    com.poesys.db.dao.insert.IInsertSql<ILeafB> sql =
      new com.poesys.db.test.sql.InsertLeafB();
