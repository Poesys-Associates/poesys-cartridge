...
public abstract class AbstractLeafCDelegate
    extends AbstractDataDelegate<BsLeafC, com.poesys.db.test.ILeafC, com.poesys.db.pk.SequencePrimaryKey> {
  /**
  ...
  protected String getClassName() {
    return com.poesys.db.test.LeafC.class.getName();
  }

  @Override
  protected IInsertSql<com.poesys.db.test.ILeafC> getInsertSql() {
    return new com.poesys.db.test.sql.InsertLeafC();
  }

  @Override
  protected IDeleteSql<com.poesys.db.test.ILeafC> getDeleteSql() {
    return new com.poesys.db.test.sql.DeleteLeafC();
  }

  @Override
  protected IUpdateSql<com.poesys.db.test.ILeafC> getUpdateSql() {
    return new com.poesys.db.test.sql.UpdateLeafC();
  }

  @Override
  protected IKeyQuerySql<com.poesys.db.test.ILeafC> getQueryByKeySql() {
    return new com.poesys.db.test.sql.QueryLeafC();
  }

  @Override
  protected IQuerySql<com.poesys.db.test.ILeafC> getQueryListSql() {
    // Query-All method not required
    return new com.poesys.db.test.sql.QueryAllLeafC();
  }

  @Override
  protected com.poesys.bs.test.BsLeafC wrapData(com.poesys.db.test.ILeafC dto) {
    return new com.poesys.bs.test.BsLeafC(dto);
  }
   ...
   *             creating the object
   */
  public com.poesys.bs.test.BsLeafC createLeafC(java.math.BigInteger baseId, java.lang.String baseString, java.lang.String middleString, java.lang.String cString)
    ...
    com.poesys.db.test.ILeafC dto =
      new com.poesys.db.test.LeafC(key, baseId, baseString, middleString, cString);
  ...
  public void insert(java.util.List<BsLeafC> list) throws DelegateException {
    ...
    final com.poesys.db.dao.IDaoFactory<com.poesys.db.test.IConcreteMiddle> concreteMiddleFactory =
      manager.getFactory("com.poesys.db.test.ConcreteMiddle", "com.poesys.db.test", 2147483647);
    ...
    com.poesys.db.dao.insert.IInsertBatch<com.poesys.db.test.IConcreteMiddle> concreteMiddleInserter =
      concreteMiddleFactory.getInsertBatch(new com.poesys.db.test.sql.InsertConcreteMiddle());
    ...
    com.poesys.db.dao.insert.IInsertBatch<com.poesys.db.test.ILeafC> leafCInserter =
      factory.getInsertBatch(getInsertSql());
    java.util.Collection<com.poesys.db.test.ILeafC> leafCDtos = convertDtoList(list);
  ...
  public void process(java.util.List<BsLeafC> list) throws DelegateException {
    ...
    com.poesys.db.dao.insert.IInsertBatch<com.poesys.db.test.ILeafC> inserter = 
      factory.getInsertBatch(getInsertSql());
    com.poesys.db.dao.update.IUpdateBatch<com.poesys.db.test.ILeafC> updater = 
      factory.getUpdateBatch(getUpdateSql());
    java.util.Collection<com.poesys.db.test.ILeafC> dtos = convertDtoList(list);
    ...
    try {
      ...
      // ConcreteMiddle
      final com.poesys.db.dao.IDaoFactory<com.poesys.db.test.IConcreteMiddle> concreteMiddleFactory =
        manager.getFactory("com.poesys.db.test.ConcreteMiddle", "com.poesys.db.test.ConcreteMiddle", 2147483647);
      com.poesys.db.dao.insert.IInsertBatch<com.poesys.db.test.IConcreteMiddle> concreteMiddleInserter =
        concreteMiddleFactory.getInsertBatch(new com.poesys.db.test.sql.InsertConcreteMiddle());
      com.poesys.db.dao.update.IUpdateBatch<com.poesys.db.test.IConcreteMiddle> concreteMiddleUpdater =
        concreteMiddleFactory.getUpdateBatch(new com.poesys.db.test.sql.UpdateConcreteMiddle());
      java.util.Collection<com.poesys.db.test.IConcreteMiddle> concreteMiddleDtos = convertDtoList(list);
