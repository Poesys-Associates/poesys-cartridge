...
import com.poesys.db.test.ITestX;
import com.poesys.db.test.TestXProxy;
import com.poesys.db.test.TestX;
...
public abstract class AbstractBsTestX 
    extends AbstractDto<com.poesys.db.test.ITestX> {
   ...
   * com.poesys.db.test.ITestY objects
   */
  private class BsYsCollectionBuilder 
      extends com.poesys.bs.dto.CollectionBuilder<com.poesys.db.test.ITestY, com.poesys.bs.test.BsTestY> {
    @Override
    public com.poesys.bs.test.BsTestY get(com.poesys.db.test.ITestY dto) {
  ...
  private class YsCollectionBuilder 
      extends com.poesys.bs.dto.CollectionBuilder<com.poesys.bs.test.BsTestY, com.poesys.db.test.ITestY> {
    @Override
    public com.poesys.db.test.ITestY get(com.poesys.bs.test.BsTestY dto) {
      return dto.toDto();
    }
  }
   ...
   * </ul>
   * </p>
   * @return a com.poesys.bs.test.BsTestY xAttr
   * @throws java.sql.SQLException when the method can't get a SQL connection to 
   *                               load the property lazily
   */
  public java.util.Collection<com.poesys.bs.test.BsTestY> getYs() throws java.sql.SQLException {
   ...
   *                 the data-access status to CHANGED
   */
  public void setY(java.util.Collection<com.poesys.bs.test.BsTestY> xAttr) 
      throws com.poesys.db.dto.DtoStatusException{
   ...
   * </ul>
   * </p>
   * @return a com.poesys.bs.test.BsTestZ xAttr
   */
   ...
   */
  public void setZs(java.util.Collection<com.poesys.bs.test.BsTestZ> xAttr) 
   ...
   *                               load the property lazily
   */
  public void addYsTestY(com.poesys.bs.test.BsTestY object) throws java.sql.SQLException {
