...
public abstract class AbstractTestSequenceKeyDelegate
    extends AbstractDataDelegate<BsTestSequenceKey, com.poesys.db.test.ITestSequenceKey, com.poesys.db.pk.SequencePrimaryKey> {
  /**
  ...
  protected String getClassName() {
    return com.poesys.db.test.TestSequenceKey.class.getName();
  }

  @Override
  protected IInsertSql<com.poesys.db.test.ITestSequenceKey> getInsertSql() {
    return new com.poesys.db.test.sql.InsertTestSequenceKey();
  }

  @Override
  protected IDeleteSql<com.poesys.db.test.ITestSequenceKey> getDeleteSql() {
    return new com.poesys.db.test.sql.DeleteTestSequenceKey();
  }

  @Override
  protected IUpdateSql<com.poesys.db.test.ITestSequenceKey> getUpdateSql() {
    return new com.poesys.db.test.sql.UpdateTestSequenceKey();
  }

  @Override
  protected IKeyQuerySql<com.poesys.db.test.ITestSequenceKey> getQueryByKeySql() {
    return new com.poesys.db.test.sql.QueryTestSequenceKey();
  }

  @Override
  protected IQuerySql<com.poesys.db.test.ITestSequenceKey> getQueryListSql() {
    // Query-All method not required
    return new com.poesys.db.test.sql.QueryAllTestSequenceKey();
  }

  @Override
  protected com.poesys.bs.test.BsTestSequenceKey wrapData(com.poesys.db.test.ITestSequenceKey dto) {
    return new com.poesys.bs.test.BsTestSequenceKey(dto);
  }
   ...
   *             creating the object
   */
  public com.poesys.bs.test.BsTestSequenceKey createTestSequenceKey(java.math.BigInteger testSequenceKeyId, java.lang.String data1)
        ...
        if (dbms.equals(DBMS.MYSQL) || dbms.equals(DBMS.JNDI_MYSQL)) {
          key =
            com.poesys.db.pk.PrimaryKeyFactory.createMySqlSequenceKey(connection,
                                                                      "TestSequenceKey",
                                                                      "testSequenceKeyId",
                                                                      "com.poesys.db.test.TestSequenceKey");
    ...
    com.poesys.db.test.ITestSequenceKey dto =
      new com.poesys.db.test.TestSequenceKey(key, testSequenceKeyId, data1);
