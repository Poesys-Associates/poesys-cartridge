...
public abstract class AbstractLeafBDelegate
    extends AbstractDataDelegate<BsLeafB, com.poesys.db.test.ILeafB, com.poesys.db.pk.SequencePrimaryKey> {
  /**
  ...
  protected String getClassName() {
    return com.poesys.db.test.LeafB.class.getName();
  }

  @Override
  protected IInsertSql<com.poesys.db.test.ILeafB> getInsertSql() {
    return new com.poesys.db.test.sql.InsertLeafB();
  }

  @Override
  protected IDeleteSql<com.poesys.db.test.ILeafB> getDeleteSql() {
    return new com.poesys.db.test.sql.DeleteLeafB();
  }

  @Override
  protected IUpdateSql<com.poesys.db.test.ILeafB> getUpdateSql() {
    return new com.poesys.db.test.sql.UpdateLeafB();
  }

  @Override
  protected IKeyQuerySql<com.poesys.db.test.ILeafB> getQueryByKeySql() {
    return new com.poesys.db.test.sql.QueryLeafB();
  }

  @Override
  protected IQuerySql<com.poesys.db.test.ILeafB> getQueryListSql() {
    // Query-All method not required
    return new com.poesys.db.test.sql.QueryAllLeafB();
  }

  @Override
  protected com.poesys.bs.test.BsLeafB wrapData(com.poesys.db.test.ILeafB dto) {
    return new com.poesys.bs.test.BsLeafB(dto);
  }
   ...
   *             creating the object
   */
  public com.poesys.bs.test.BsLeafB createLeafB(java.math.BigInteger baseId, java.lang.String baseString, java.lang.String middleString, java.lang.String bString)
    ...
    com.poesys.db.test.ILeafB dto =
      new com.poesys.db.test.LeafB(key, baseId, baseString, middleString, bString);
  ...
  public void insert(java.util.List<BsLeafB> list) throws DelegateException {
    ...
    com.poesys.db.dao.insert.IInsertBatch<com.poesys.db.test.ILeafB> leafBInserter =
      factory.getInsertBatch(getInsertSql());
    java.util.Collection<com.poesys.db.test.ILeafB> leafBDtos = convertDtoList(list);
  ...
  public void process(java.util.List<BsLeafB> list) throws DelegateException {
    ...
    com.poesys.db.dao.insert.IInsertBatch<com.poesys.db.test.ILeafB> inserter = 
      factory.getInsertBatch(getInsertSql());
    com.poesys.db.dao.update.IUpdateBatch<com.poesys.db.test.ILeafB> updater = 
      factory.getUpdateBatch(getUpdateSql());
    java.util.Collection<com.poesys.db.test.ILeafB> dtos = convertDtoList(list);
