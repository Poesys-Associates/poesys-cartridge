...
public abstract class AbstractTestChild extends AbstractDto implements ITestChild {
   ...
   * @author Poesys/DB Cartridge
   */
  private class QueryTestParentSetter extends com.poesys.db.dto.AbstractObjectSetter<com.poesys.db.test.ITestParent> {
    private static final long serialVersionUID = 1L;
   ...
   *
   * @see com.poesys.db.test.sql.QueryUpByTestChild
   */
  private class QueryUpSetter 
      extends com.poesys.db.dto.AbstractListSetter<com.poesys.db.test.ITestChild, ITestChild, java.util.Collection<com.poesys.db.test.ITestChild>> {
    private static final long serialVersionUID = 1L;
    ...
    @Override
    protected com.poesys.db.dao.query.IParameterizedQuerySql<com.poesys.db.test.ITestChild, ITestChild> getSql() {
      return new com.poesys.db.test.sql.QueryUpByTestChild();
    }

    @Override
    protected void set(java.util.Collection<com.poesys.db.test.ITestChild> list) {
      // No status change; this is just filling in the object data.
      up = list;
   ...
   *
   * @see com.poesys.db.test.sql.InsertTestChild
   */
   ...
   * Source: TransformToProperty + AddToManyAssociationCollectionProperties
   *
   * @see com.poesys.db.test.sql.QueryDownByTestChild
   */
  private class QueryDownSetter 
    ...
    @Override
    protected com.poesys.db.dao.query.IParameterizedQuerySql<com.poesys.db.test.ITestChild, ITestChild> getSql() {
      return new com.poesys.db.test.sql.QueryDownByTestChild();
    }
   ...
   *
   * @see com.poesys.db.test.sql.QueryGrandchildrenByTestChild
   */
  private class QueryGrandchildrenSetter 
      extends com.poesys.db.dto.AbstractListSetter<com.poesys.db.test.ITestChildChild, ITestChild, java.util.Collection<com.poesys.db.test.ITestChildChild>> {
    private static final long serialVersionUID = 1L;
    private static final int FETCH_SIZE = 10;
    ...
    @Override
    protected com.poesys.db.dao.query.IParameterizedQuerySql<com.poesys.db.test.ITestChildChild, ITestChild> getSql() {
      return new com.poesys.db.test.sql.QueryGrandchildrenByTestChild();
    }

    @Override
    protected void set(java.util.Collection<com.poesys.db.test.ITestChildChild> list) {
      // No status change; this is just filling in the object data.
      grandchildren = list;
      // Add the primary keys to the serialized key list if there are any.
   ...
   *
   * @see com.poesys.db.test.sql.InsertTestChildChild
   */
   ...
   *
   * @see com.poesys.db.test.sql.QueryUpTest2Child2TestChildLinksByTestChild
   */
  private class QueryUpTest2Child2TestChildLinksSetter 
      extends com.poesys.db.dto.AbstractListSetter<com.poesys.db.test.ITestChild2TestChild, ITestChild, java.util.Collection<com.poesys.db.test.ITestChild2TestChild>> {
    private static final long serialVersionUID = 1L;
    private static final int FETCH_SIZE = 10;
    ...
    @Override
    protected com.poesys.db.dao.query.IParameterizedQuerySql<com.poesys.db.test.ITestChild2TestChild, ITestChild> getSql() {
      return new com.poesys.db.test.sql.QueryUpTest2Child2TestChildLinksByTestChild();
    }

    @Override
    protected void set(java.util.Collection<com.poesys.db.test.ITestChild2TestChild> list) {
      // No status change; this is just filling in the object data.
   ...
   *
   * @see com.poesys.db.test.sql.InsertTestChild2TestChild
   */
   ...
   * Source: AddAssociationClassCollectionProperties
   *
   * @see com.poesys.db.test.sql.QueryDownTest2Child2TestChildLinksByTestChild
   */
  private class QueryDownTest2Child2TestChildLinksSetter 
    ...
    @Override
    protected com.poesys.db.dao.query.IParameterizedQuerySql<com.poesys.db.test.ITestChild2TestChild, ITestChild> getSql() {
      return new com.poesys.db.test.sql.QueryDownTest2Child2TestChildLinksByTestChild();
    }
   ...
   * Property is lazy: false
   */
  private com.poesys.db.test.ITestParent testParent;
  ...
  transient java.util.Collection<com.poesys.db.test.ITestChild> up;
   ...
   */
  // Doesn't serialize; package access allows proxy to set on readObject()
  transient java.util.Collection<com.poesys.db.test.ITestChild> down;
   ...
   */
  // Doesn't serialize; package access allows proxy to set on readObject()
  transient java.util.Collection<com.poesys.db.test.ITestChildChild> grandchildren;
   ...
   */
  // Doesn't serialize; package access allows proxy to set on readObject()
  transient java.util.Collection<com.poesys.db.test.ITestChild2TestChild> upTest2Child2TestChildLinks;
   ...
   */
  // Doesn't serialize; package access allows proxy to set on readObject()
  transient java.util.Collection<com.poesys.db.test.ITestChild2TestChild> downTest2Child2TestChildLinks;
  ...
  public void update(com.poesys.db.dto.ISubject subject,
    ...
    if (subject != null && subject instanceof com.poesys.db.test.ITestChildChild && 
    ...
    if (subject != null && subject instanceof com.poesys.db.test.ITestChild2TestChild && 
        event == com.poesys.db.dao.DataEvent.DELETE &&
    ...
    if (event == com.poesys.db.dao.DataEvent.MARKED_DELETED &&
      ...
      outer: for (com.poesys.db.test.ITestChild2TestChild value : upTest2Child2TestChildLinks) {
    ...
    if (event == com.poesys.db.dao.DataEvent.MARKED_DELETED &&
      ...
      outer: for (com.poesys.db.test.ITestChild2TestChild value : downTest2Child2TestChildLinks) {
        com.poesys.db.pk.AssociationPrimaryKey keys = 
          (com.poesys.db.pk.AssociationPrimaryKey) value.getPrimaryKey();
        for (com.poesys.db.pk.IPrimaryKey key : keys.getKeyListCopy()) {
          if (key.equals(subject.getPrimaryKey())) {
  ...
  private void createInserters() {
    ...
    final com.poesys.db.dao.IDaoFactory<com.poesys.db.test.ITestChild> testChildFactory =
      manager.getFactory("com.poesys.db.test.TestChild",
                         getSubsystem(),
                         2147483647);
    com.poesys.db.dao.insert.IInsertSql<ITestChild> sql =
      new com.poesys.db.test.sql.InsertTestChild();
