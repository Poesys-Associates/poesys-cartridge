 ...
 */
public abstract class AbstractQueryTestSequenceKey implements IKeyQuerySql<com.poesys.db.memcached_test.ITestSequenceKey> {
  /** SQL query statement for TestSequenceKey */
  private static final String SQL =
    "SELECT testSequenceKeyId, data1 FROM TestSequenceKey WHERE ";

  public com.poesys.db.memcached_test.ITestSequenceKey getData(IPrimaryKey key, ResultSet rs) throws SQLException {
    return com.poesys.db.memcached_test.Memcached_testFactory.getTestSequenceKeyData(key, rs);
  }
