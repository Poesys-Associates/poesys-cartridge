...
// Read/Write property: true
   ...
   * </p>
   * @return a java.util.List<com.poesys.db.memcached_test.IPoly> polys
   */
...
// Read/Write property: true
   ...
   * @throws com.poesys.db.dto.DtoStatusException when the status cannot be set to CHANGED
   */
  public void setPoly(java.util.List<com.poesys.db.memcached_test.IPoly> polys) throws com.poesys.db.dto.DtoStatusException;
