...
public abstract class AbstractTestZProxy extends AbstractLazyLoadingDtoProxy implements ITestZ {
  ...
  private class QueryYSetter 
      extends com.poesys.db.dto.AbstractLazyObjectSetter<com.poesys.db.test.ITestY> {
    ...
    protected com.poesys.db.pk.IPrimaryKey getKey() {
      // Generate an com.poesys.db.test.ITestY primary key with the value 
      // from the com.poesys.db.test.ITestZ object
      return com.poesys.db.test.TestFactory.getTestYPrimaryKey(((ITestZ)dto).getTestYId());
    }
    ...
    @Override
    protected void set(com.poesys.db.test.ITestY dto)
  ...
  private class ReadTestsSetter 
    ...
    protected java.util.Collection<com.poesys.db.test.ITestAssociationChild> getObjectCollection() {
      java.util.Collection<com.poesys.db.test.ITestAssociationChild> tests =  ((com.poesys.db.test.TestZ)dto).getTests();
      return tests;
    }

    @Override
    protected java.util.List<com.poesys.db.pk.IPrimaryKey> getPrimaryKeys() {
      return ((com.poesys.db.test.TestZ)dto).testsKeys;
    }
    ...
    protected void set(java.util.Collection<com.poesys.db.test.ITestAssociationChild> collection) {
      ((com.poesys.db.test.TestZ)dto).tests = collection;
    }
  }


  /**
   * Add a com.poesys.db.test.ITestAssociationChild object to the Tests collection. The method
   ...
   * Source: AddToManyAssociatedKeyCollectionProperties
   * 
   * @param object the com.poesys.db.test.ITestAssociationChild object to add to the collection
   */
