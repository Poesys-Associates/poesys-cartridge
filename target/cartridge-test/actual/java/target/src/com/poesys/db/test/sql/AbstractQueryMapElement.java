 ...
 */
public abstract class AbstractQueryMapElement implements IKeyQuerySql<com.poesys.db.test.IMapElement> {
  ...
  public com.poesys.db.test.IMapElement getData(IPrimaryKey key, ResultSet rs) throws SQLException {
    return com.poesys.db.test.TestFactory.getMapElementData(key, rs);
  }
