...
import com.poesys.db.memcached_test.ISelf2;
import com.poesys.db.memcached_test.Self2Proxy;
import com.poesys.db.memcached_test.Self2;
...
public abstract class AbstractBsSelf2 
    extends AbstractDto<com.poesys.db.memcached_test.ISelf2> {
   ...
   * com.poesys.db.memcached_test.ISelf2 objects
   */
  private class BsParents2CollectionBuilder 
      extends com.poesys.bs.dto.CollectionBuilder<com.poesys.db.memcached_test.ISelf2, com.poesys.bs.memcached_test.BsSelf2> {
    @Override
    public com.poesys.bs.memcached_test.BsSelf2 get(com.poesys.db.memcached_test.ISelf2 dto) {
   ...
   * com.poesys.db.memcached_test.ISelf2Self objects
   */
  private class BsParents2Self2SelfLinksCollectionBuilder 
      extends com.poesys.bs.dto.CollectionBuilder<com.poesys.db.memcached_test.ISelf2Self, com.poesys.bs.memcached_test.BsSelf2Self> {
    @Override
    public com.poesys.bs.memcached_test.BsSelf2Self get(com.poesys.db.memcached_test.ISelf2Self dto) {
   ...
   * </ul>
   * </p>
   * @return a com.poesys.bs.memcached_test.BsSelf2 self2Id
   */
  public java.util.Collection<com.poesys.bs.memcached_test.BsSelf2> getParents2() {
   ...
   * @return a com.poesys.bs.memcached_test.BsSelf2 self2Id
   */
  public java.util.Collection<com.poesys.bs.memcached_test.BsSelf2> getChildren2() {
   ...
   * </ul>
   * </p>
   * @return a com.poesys.bs.memcached_test.BsSelf2Self self2Id
   */
  public java.util.Collection<com.poesys.bs.memcached_test.BsSelf2Self> getParents2Self2SelfLinks() {
   ...
   * @return a com.poesys.bs.memcached_test.BsSelf2Self self2Id
   */
  public java.util.Collection<com.poesys.bs.memcached_test.BsSelf2Self> getChildren2Self2SelfLinks() {
