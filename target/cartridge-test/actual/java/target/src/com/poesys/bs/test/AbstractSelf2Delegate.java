...
public abstract class AbstractSelf2Delegate
    extends AbstractDataDelegate<BsSelf2, com.poesys.db.test.ISelf2, com.poesys.db.pk.SequencePrimaryKey> {
  /**
  ...
  @Override
  protected IInsertSql<com.poesys.db.test.ISelf2> getInsertSql() {
    return new com.poesys.db.test.sql.InsertSelf2();
  }

  @Override
  protected IDeleteSql<com.poesys.db.test.ISelf2> getDeleteSql() {
    return new com.poesys.db.test.sql.DeleteSelf2();
  }

  @Override
  protected IUpdateSql<com.poesys.db.test.ISelf2> getUpdateSql() {
    return null;
  }

  @Override
  protected IKeyQuerySql<com.poesys.db.test.ISelf2> getQueryByKeySql() {
    return new com.poesys.db.test.sql.QuerySelf2();
  }

  @Override
  protected IQuerySql<com.poesys.db.test.ISelf2> getQueryListSql() {
    // Query-All method not required
    return new com.poesys.db.test.sql.QueryAllSelf2();
  }

  @Override
  protected com.poesys.bs.test.BsSelf2 wrapData(com.poesys.db.test.ISelf2 dto) {
   ...
   *             creating the object
   */
  public com.poesys.bs.test.BsSelf2 createSelf2(java.math.BigInteger self2Id)
    ...
    com.poesys.db.test.ISelf2 dto =
      new com.poesys.db.test.Self2(key, self2Id);
   ...
   */
  public com.poesys.bs.test.BsSelf2Self createSelf2Self(com.poesys.bs.test.BsSelf2 children2Object, com.poesys.bs.test.BsSelf2 parents2Object, java.math.BigInteger children2Self2Id, java.math.BigInteger parents2Self2Id) throws DelegateException {
    // Create the key.
    ...
    try {
      ...
      key = 
        com.poesys.db.pk.PrimaryKeyFactory.createAssociationKey(list, "com.poesys.db.test.Self2Self");
    } catch (com.poesys.db.InvalidParametersException e) {
      Object[] args = e.getParameters().toArray();
      String message = com.poesys.db.Message.getMessage(e.getMessage(), args);
      throw new DelegateException(message, e);
    ...
    com.poesys.db.test.ISelf2Self dto =
      new com.poesys.db.test.Self2Self(key, children2Object.toDto(), parents2Object.toDto(), children2Self2Id, parents2Self2Id);
