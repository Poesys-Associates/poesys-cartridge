...
public abstract class AbstractTestChild2TestChildProxy extends AbstractLazyLoadingDtoProxy implements ITestChild2TestChild {
  ...
  private class ReadTc1Setter 
    ...
    protected java.util.Collection<com.poesys.db.memcached_test.ITestChild2TestChild> getObjectCollection() {
      java.util.Collection<com.poesys.db.memcached_test.ITestChild2TestChild> tc1 =  ((com.poesys.db.memcached_test.TestChild2TestChild)dto).getTc1();
      return tc1;
    }

    @Override
    protected java.util.List<com.poesys.db.pk.IPrimaryKey> getPrimaryKeys() {
      return ((com.poesys.db.memcached_test.TestChild2TestChild)dto).tc1Keys;
    }
    ...
    protected void set(java.util.Collection<com.poesys.db.memcached_test.ITestChild2TestChild> collection) {
      ((com.poesys.db.memcached_test.TestChild2TestChild)dto).tc1 = collection;
    }
  }
  ...
  private class ReadTc2Setter 
    ...
    @Override
    protected java.util.Collection<com.poesys.db.memcached_test.ITestChild2TestChild> getObjectCollection() {
      java.util.Collection<com.poesys.db.memcached_test.ITestChild2TestChild> tc2 =  ((com.poesys.db.memcached_test.TestChild2TestChild)dto).getTc2();
      return tc2;
    }

    @Override
    protected java.util.List<com.poesys.db.pk.IPrimaryKey> getPrimaryKeys() {
      return ((com.poesys.db.memcached_test.TestChild2TestChild)dto).tc2Keys;
    }
    ...
    @Override
    protected void set(java.util.Collection<com.poesys.db.memcached_test.ITestChild2TestChild> collection) {
      ((com.poesys.db.memcached_test.TestChild2TestChild)dto).tc2 = collection;
    }
  }
  ...
  private class ReadTc1TC2TC2TC2TCLinksSetter 
    ...
    protected java.util.Collection<com.poesys.db.memcached_test.ITC2TC2TC2TC> getObjectCollection() {
      java.util.Collection<com.poesys.db.memcached_test.ITC2TC2TC2TC> tc1TC2TC2TC2TCLinks =  ((com.poesys.db.memcached_test.TestChild2TestChild)dto).getTc1TC2TC2TC2TCLinks();
      return tc1TC2TC2TC2TCLinks;
    }

    @Override
    protected java.util.List<com.poesys.db.pk.IPrimaryKey> getPrimaryKeys() {
      return ((com.poesys.db.memcached_test.TestChild2TestChild)dto).tc1TC2TC2TC2TCLinksKeys;
    }
    ...
    protected void set(java.util.Collection<com.poesys.db.memcached_test.ITC2TC2TC2TC> collection) {
      ((com.poesys.db.memcached_test.TestChild2TestChild)dto).tc1TC2TC2TC2TCLinks = collection;
    }
  }
  ...
  private class ReadTc2TC2TC2TC2TCLinksSetter 
    ...
    @Override
    protected java.util.Collection<com.poesys.db.memcached_test.ITC2TC2TC2TC> getObjectCollection() {
      java.util.Collection<com.poesys.db.memcached_test.ITC2TC2TC2TC> tc2TC2TC2TC2TCLinks =  ((com.poesys.db.memcached_test.TestChild2TestChild)dto).getTc2TC2TC2TC2TCLinks();
      return tc2TC2TC2TC2TCLinks;
    }

    @Override
    protected java.util.List<com.poesys.db.pk.IPrimaryKey> getPrimaryKeys() {
      return ((com.poesys.db.memcached_test.TestChild2TestChild)dto).tc2TC2TC2TC2TCLinksKeys;
    }
    ...
    @Override
    protected void set(java.util.Collection<com.poesys.db.memcached_test.ITC2TC2TC2TC> collection) {
      ((com.poesys.db.memcached_test.TestChild2TestChild)dto).tc2TC2TC2TC2TCLinks = collection;
    }
  }
