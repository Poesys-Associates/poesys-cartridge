...
public abstract class AbstractTestZ extends AbstractDto implements ITestZ {
   ...
   * @author Poesys/DB Cartridge
   */
  private class QueryXSetter extends com.poesys.db.dto.AbstractObjectSetter<com.poesys.db.test.ITestX> {
    private static final long serialVersionUID = 1L;
    ...
    @Override
    protected void set(com.poesys.db.test.ITestX dto) {
   ...
   *
   * @see com.poesys.db.test.sql.QueryTestsByTestZ
   */
  private class QueryTestsSetter 
      extends com.poesys.db.dto.AbstractListSetter<com.poesys.db.test.ITestAssociationChild, ITestZ, java.util.Collection<com.poesys.db.test.ITestAssociationChild>> {
    private static final long serialVersionUID = 1L;
    ...
    @Override
    protected com.poesys.db.dao.query.IParameterizedQuerySql<com.poesys.db.test.ITestAssociationChild, ITestZ> getSql() {
      return new com.poesys.db.test.sql.QueryTestsByTestZ();
    }
  ...
  /**
   * Add com.poesys.db.test.ITestAssociationChild object to tests collection.
   * 
   * @param object the com.poesys.db.test.ITestAssociationChild object
   */
  public void addTestsTestAssociationChild(com.poesys.db.test.ITestAssociationChild object) {
    if (tests == null) {
      ...
      tests = new java.util.concurrent.CopyOnWriteArrayList<com.poesys.db.test.ITestAssociationChild>();
    }
    tests.add(object);
   ...
   * @param zAttr 
   */
  public AbstractTestZ(IPrimaryKey key, com.poesys.db.test.ITestX xsObject, com.poesys.db.test.ITestY ysObject, java.math.BigInteger testXId, java.math.BigInteger testYId, java.lang.String zAttr) {
    this.key = key;
  ...
  transient java.util.Collection<com.poesys.db.test.ITestAssociationChild> tests;
   ...
   */
  public  void setTests(java.util.Collection<com.poesys.db.test.ITestAssociationChild> tests) {
    this.tests = tests;
   ...
   */
  private com.poesys.db.test.ITestY y;
  
  /**
   * Get an object of com.poesys.db.test.ITestY.
   *
   * Source: AddAssociationKeyObjectProperties
   * 
   * @return a com.poesys.db.test.ITestY
  ...
  void setY(com.poesys.db.test.ITestY y)
   ...
   * Property is lazy: false
   */
  private com.poesys.db.test.ITestX x;
  
  /**
   * Get an object of com.poesys.db.test.ITestX.
   *
   * Source: AddAssociationKeyObjectProperties
   * 
   * @return a com.poesys.db.test.ITestX
   */
  ...
  private void createInserters() {
    ...
    final com.poesys.db.dao.IDaoFactory<com.poesys.db.test.ITestZ> testZFactory =
      manager.getFactory("com.poesys.db.test.TestZ",
                         getSubsystem(),
                         2147483647);
    com.poesys.db.dao.insert.IInsertSql<ITestZ> sql =
      new com.poesys.db.test.sql.InsertTestZ();
