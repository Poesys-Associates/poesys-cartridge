...
public abstract class AbstractTestXDelegate
    extends AbstractDataDelegate<BsTestX, com.poesys.db.test.ITestX, com.poesys.db.pk.SequencePrimaryKey> {
  /**
  ...
  @Override
  protected IInsertSql<com.poesys.db.test.ITestX> getInsertSql() {
    return new com.poesys.db.test.sql.InsertTestX();
  }

  @Override
  protected IDeleteSql<com.poesys.db.test.ITestX> getDeleteSql() {
    return new com.poesys.db.test.sql.DeleteTestX();
  }

  @Override
  protected IUpdateSql<com.poesys.db.test.ITestX> getUpdateSql() {
    return new com.poesys.db.test.sql.UpdateTestX();
  }

  @Override
  protected IKeyQuerySql<com.poesys.db.test.ITestX> getQueryByKeySql() {
    return new com.poesys.db.test.sql.QueryTestX();
  }

  @Override
  protected IQuerySql<com.poesys.db.test.ITestX> getQueryListSql() {
    // Query-All method not required
    return new com.poesys.db.test.sql.QueryAllTestX();
  }

  @Override
  protected com.poesys.bs.test.BsTestX wrapData(com.poesys.db.test.ITestX dto) {
   ...
   *             creating the object
   */
  public com.poesys.bs.test.BsTestX createTestX(java.math.BigInteger testXId, java.lang.String xAttr)
    ...
    com.poesys.db.test.ITestX dto =
      new com.poesys.db.test.TestXProxy(new com.poesys.db.test.TestX(key, testXId, xAttr));
...
Natural Parent, identified by the zKey TestZ object
   ...
   */
  public com.poesys.bs.test.BsTestAssociationChild createTestAssociationChild(com.poesys.bs.test.BsTestX parent, java.lang.Long key1, java.lang.Long key2, java.math.BigInteger testXId, java.math.BigInteger testYId, java.lang.Long tsACAttr) throws DelegateException {
    // Create the key.
