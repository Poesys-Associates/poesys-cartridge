 ...
 */
public class AbstractUpdateTestSequenceKey implements IUpdateSql<com.poesys.db.memcached_test.ITestSequenceKey> {
  ...
  @Override
  public int setParams(PreparedStatement stmt, int index, com.poesys.db.memcached_test.ITestSequenceKey object)
      throws SQLException {
