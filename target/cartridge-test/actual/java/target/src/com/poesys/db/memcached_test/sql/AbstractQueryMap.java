 ...
 */
public abstract class AbstractQueryMap implements IKeyQuerySql<com.poesys.db.memcached_test.IMap> {
  /** SQL query statement for Map */
  private static final String SQL =
    "SELECT mapId, location FROM Map WHERE ";

  public com.poesys.db.memcached_test.IMap getData(IPrimaryKey key, ResultSet rs) throws SQLException {
