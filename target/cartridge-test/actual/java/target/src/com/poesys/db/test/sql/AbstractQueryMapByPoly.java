 ...
 * Poly object through the association Map using the 
 ...
 */
public abstract class AbstractQueryMapByPoly 
    implements IParameterizedQuerySql<com.poesys.db.test.IMap, com.poesys.db.test.IPoly> {
  ...
  public com.poesys.db.test.IMap getData(ResultSet rs) 
      throws SQLException, ConstraintViolationException {
    IPrimaryKey key = 
      com.poesys.db.test.TestFactory.getMapPrimaryKey(rs, "");
    return com.poesys.db.test.TestFactory.getMapData(key, rs);
  }

  public IPrimaryKey getPrimaryKey(ResultSet rs) throws SQLException,
      InvalidParametersException {
    return com.poesys.db.test.TestFactory.getMapPrimaryKey(rs, "");
  }
