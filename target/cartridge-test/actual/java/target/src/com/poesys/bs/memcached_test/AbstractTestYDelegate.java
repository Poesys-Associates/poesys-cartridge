...
public abstract class AbstractTestYDelegate
    extends AbstractDataDelegate<BsTestY, com.poesys.db.memcached_test.ITestY, com.poesys.db.pk.SequencePrimaryKey> {
  /**
  ...
  @Override
  protected IInsertSql<com.poesys.db.memcached_test.ITestY> getInsertSql() {
    return new com.poesys.db.memcached_test.sql.InsertTestY();
  }

  @Override
  protected IDeleteSql<com.poesys.db.memcached_test.ITestY> getDeleteSql() {
    return new com.poesys.db.memcached_test.sql.DeleteTestY();
  }

  @Override
  protected IUpdateSql<com.poesys.db.memcached_test.ITestY> getUpdateSql() {
    return new com.poesys.db.memcached_test.sql.UpdateTestY();
  }

  @Override
  protected IKeyQuerySql<com.poesys.db.memcached_test.ITestY> getQueryByKeySql() {
    return new com.poesys.db.memcached_test.sql.QueryTestY();
  }

  @Override
  protected IQuerySql<com.poesys.db.memcached_test.ITestY> getQueryListSql() {
    // Query-All method not required
    return new com.poesys.db.memcached_test.sql.QueryAllTestY();
  }

  @Override
  protected com.poesys.bs.memcached_test.BsTestY wrapData(com.poesys.db.memcached_test.ITestY dto) {
   ...
   *             creating the object
   */
  public com.poesys.bs.memcached_test.BsTestY createTestY(java.math.BigInteger testYId, java.lang.String yAttr)
        ...
        if (dbms.equals(DBMS.MYSQL) || dbms.equals(DBMS.JNDI_MYSQL)) {
          key =
            com.poesys.db.pk.PrimaryKeyFactory.createMySqlSequenceKey(connection,
                                                                      "TestY",
                                                                      "testYId",
                                                                      "com.poesys.db.memcached_test.TestY");
    ...
    com.poesys.db.memcached_test.ITestY dto =
      new com.poesys.db.memcached_test.TestY(key, testYId, yAttr);
...
Natural Parent, identified by the zKey TestZ object
   ...
   */
  public com.poesys.bs.memcached_test.BsTestAssociationChild createTestAssociationChild(com.poesys.bs.memcached_test.BsTestY parent, java.lang.Long key1, java.lang.Long key2, java.math.BigInteger testXId, java.math.BigInteger testYId, java.lang.Long tsACAttr) throws DelegateException {
    // Create the key.
