...
public abstract class AbstractTestNaturalParent extends AbstractDto implements ITestNaturalParent {
   ...
   *
   * @see com.poesys.db.memcached_test.sql.QueryChildrenByTestNaturalParent
   */
  private class QueryChildrenSetter 
      extends com.poesys.db.dto.AbstractListSetter<com.poesys.db.memcached_test.ITestNaturalChild, ITestNaturalParent, java.util.Collection<com.poesys.db.memcached_test.ITestNaturalChild>> {
    private static final long serialVersionUID = 1L;
    ...
    @Override
    protected com.poesys.db.dao.query.IParameterizedQuerySql<com.poesys.db.memcached_test.ITestNaturalChild, ITestNaturalParent> getSql() {
      return new com.poesys.db.memcached_test.sql.QueryChildrenByTestNaturalParent();
    }

    @Override
    protected void set(java.util.Collection<com.poesys.db.memcached_test.ITestNaturalChild> list) {
   ...
   *
   * @see com.poesys.db.memcached_test.sql.InsertTestNaturalChild
   */
   ...
   * Source: AddToManyChildCollectionProperties
   *
   * @see com.poesys.db.memcached_test.sql.QueryAssocChildrenByTestNaturalParent
   */
  private class QueryAssocChildrenSetter 
      extends com.poesys.db.dto.AbstractListSetter<com.poesys.db.memcached_test.ITestAssociationChild, ITestNaturalParent, java.util.Collection<com.poesys.db.memcached_test.ITestAssociationChild>> {
    private static final long serialVersionUID = 1L;
    private static final int FETCH_SIZE = 10;
    ...
    @Override
    protected com.poesys.db.dao.query.IParameterizedQuerySql<com.poesys.db.memcached_test.ITestAssociationChild, ITestNaturalParent> getSql() {
      return new com.poesys.db.memcached_test.sql.QueryAssocChildrenByTestNaturalParent();
    }
  ...
  transient java.util.Collection<com.poesys.db.memcached_test.ITestNaturalChild> children;
   ...
   */
  // Doesn't serialize; package access allows proxy to set on readObject()
  transient java.util.Collection<com.poesys.db.memcached_test.ITestAssociationChild> assocChildren;
  ...
  public void update(com.poesys.db.dto.ISubject subject,
    ...
    // Clean up children.
    if (subject != null && subject instanceof com.poesys.db.memcached_test.ITestNaturalChild && 
  ...
  private void createInserters() {
    ...
    final com.poesys.db.dao.IDaoFactory<com.poesys.db.memcached_test.ITestNaturalParent> testNaturalParentFactory =
      manager.getFactory("com.poesys.db.memcached_test.TestNaturalParent",
                         getSubsystem(),
                         2147483647);
    com.poesys.db.dao.insert.IInsertSql<ITestNaturalParent> sql =
      new com.poesys.db.memcached_test.sql.InsertTestNaturalParent();
