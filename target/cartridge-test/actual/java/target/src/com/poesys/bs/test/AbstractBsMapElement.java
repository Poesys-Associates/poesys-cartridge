...
import com.poesys.db.test.MapElementProxy;
...
public abstract class AbstractBsMapElement 
    extends AbstractDto<com.poesys.db.test.IMapElement> {
   ...
   * @param elementType 
   */
  public AbstractBsMapElement(IPrimaryKey key, com.poesys.db.test.IMap mapsObject, com.poesys.db.test.IPoly polysObject, java.math.BigInteger tairObjectId, java.math.BigInteger mapId, java.math.BigInteger polyId, java.lang.Integer version, java.lang.String elementType) {
...
// Read/Write property: true
   ...
   * </ul>
   * </p>
   * @return a com.poesys.bs.test.BsMap map
   */
  public com.poesys.bs.test.BsMap getMap() {
    // Return 4
    return new com.poesys.bs.test.BsMap(dto.getMap());
  }
   ...
   * </ul>
   * </p>
   * @return a com.poesys.bs.test.BsPoly poly
   */
  public com.poesys.bs.test.BsPoly getPoly() {
    // Return 4
    return new com.poesys.bs.test.BsPoly(dto.getPoly());
  }
