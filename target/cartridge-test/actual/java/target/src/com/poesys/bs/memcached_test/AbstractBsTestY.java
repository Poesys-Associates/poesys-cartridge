...
import com.poesys.db.memcached_test.ITestY;
import com.poesys.db.memcached_test.TestYProxy;
import com.poesys.db.memcached_test.TestY;
...
public abstract class AbstractBsTestY 
    extends AbstractDto<com.poesys.db.memcached_test.ITestY> {
   ...
   * com.poesys.db.memcached_test.ITestX objects
   */
  private class BsXsCollectionBuilder 
      extends com.poesys.bs.dto.CollectionBuilder<com.poesys.db.memcached_test.ITestX, com.poesys.bs.memcached_test.BsTestX> {
    @Override
    public com.poesys.bs.memcached_test.BsTestX get(com.poesys.db.memcached_test.ITestX dto) {
  ...
  private class XsCollectionBuilder 
      extends com.poesys.bs.dto.CollectionBuilder<com.poesys.bs.memcached_test.BsTestX, com.poesys.db.memcached_test.ITestX> {
    @Override
    public com.poesys.db.memcached_test.ITestX get(com.poesys.bs.memcached_test.BsTestX dto) {
      return dto.toDto();
    }
  }
   ...
   * </ul>
   * </p>
   * @return a com.poesys.bs.memcached_test.BsTestX yAttr
   */
  public java.util.Collection<com.poesys.bs.memcached_test.BsTestX> getXs() {
   ...
   *                 the data-access status to CHANGED
   */
  public void setX(java.util.Collection<com.poesys.bs.memcached_test.BsTestX> yAttr) 
      throws com.poesys.db.dto.DtoStatusException{
   ...
   * </ul>
   * </p>
   * @return a com.poesys.bs.memcached_test.BsTestZ yAttr
   */
   ...
   */
  public void setZs(java.util.Collection<com.poesys.bs.memcached_test.BsTestZ> yAttr) 
   ...
   */
  public void addXsTestX(com.poesys.bs.memcached_test.BsTestX object) {
