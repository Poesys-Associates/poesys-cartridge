...
public abstract class AbstractQueryTestsByTestZ 
    implements IParameterizedQuerySql<com.poesys.db.memcached_test.ITestAssociationChild, com.poesys.db.memcached_test.ITestZ> {
  ...
  public void bindParameters(PreparedStatement stmt, com.poesys.db.memcached_test.ITestZ parameters)
      throws SQLException {
    // Set the parameters starting with the first parameter.
    parameters.getPrimaryKey().setParams(stmt, 1);
  }

  public String getParameterValues(com.poesys.db.memcached_test.ITestZ parameters) {
