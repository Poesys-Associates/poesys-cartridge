 ...
 */
public class AbstractInsertLeafB implements IInsertSql<com.poesys.db.memcached_test.ILeafB> {
  ...
  public void setParams(PreparedStatement stmt, int index, com.poesys.db.memcached_test.ILeafB object)
      throws SQLException {
