 ...
 */
public abstract class AbstractQueryConcreteMiddle implements IKeyQuerySql<com.poesys.db.memcached_test.IConcreteMiddle> {
  ...
  public com.poesys.db.memcached_test.IConcreteMiddle getData(IPrimaryKey key, ResultSet rs) throws SQLException {
