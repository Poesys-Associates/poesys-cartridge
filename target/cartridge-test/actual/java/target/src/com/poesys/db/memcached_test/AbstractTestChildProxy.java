...
public abstract class AbstractTestChildProxy extends AbstractLazyLoadingDtoProxy implements ITestChild {
  ...
  private class ReadUpSetter 
    ...
    protected java.util.Collection<com.poesys.db.memcached_test.ITestChild> getObjectCollection() {
      java.util.Collection<com.poesys.db.memcached_test.ITestChild> up =  ((com.poesys.db.memcached_test.TestChild)dto).getUp();
      return up;
    }

    @Override
    protected java.util.List<com.poesys.db.pk.IPrimaryKey> getPrimaryKeys() {
      return ((com.poesys.db.memcached_test.TestChild)dto).upKeys;
    }
    ...
    protected void set(java.util.Collection<com.poesys.db.memcached_test.ITestChild> collection) {
      ((com.poesys.db.memcached_test.TestChild)dto).up = collection;
    }
  }
  ...
  private class ReadDownSetter 
    ...
    @Override
    protected java.util.Collection<com.poesys.db.memcached_test.ITestChild> getObjectCollection() {
      java.util.Collection<com.poesys.db.memcached_test.ITestChild> down =  ((com.poesys.db.memcached_test.TestChild)dto).getDown();
      return down;
    }

    @Override
    protected java.util.List<com.poesys.db.pk.IPrimaryKey> getPrimaryKeys() {
      return ((com.poesys.db.memcached_test.TestChild)dto).downKeys;
    }
    ...
    @Override
    protected void set(java.util.Collection<com.poesys.db.memcached_test.ITestChild> collection) {
      ((com.poesys.db.memcached_test.TestChild)dto).down = collection;
    }
  }
  ...
  private class ReadGrandchildrenSetter 
    ...
    protected java.util.Collection<com.poesys.db.memcached_test.ITestChildChild> getObjectCollection() {
      java.util.Collection<com.poesys.db.memcached_test.ITestChildChild> grandchildren =  ((com.poesys.db.memcached_test.TestChild)dto).getGrandchildren();
      return grandchildren;
    }

    @Override
    protected java.util.List<com.poesys.db.pk.IPrimaryKey> getPrimaryKeys() {
      return ((com.poesys.db.memcached_test.TestChild)dto).grandchildrenKeys;
    }
    ...
    protected void set(java.util.Collection<com.poesys.db.memcached_test.ITestChildChild> collection) {
      ((com.poesys.db.memcached_test.TestChild)dto).grandchildren = collection;
    }
  }
  ...
  private class ReadUpTest2Child2TestChildLinksSetter 
    ...
    protected java.util.Collection<com.poesys.db.memcached_test.ITestChild2TestChild> getObjectCollection() {
      java.util.Collection<com.poesys.db.memcached_test.ITestChild2TestChild> upTest2Child2TestChildLinks =  ((com.poesys.db.memcached_test.TestChild)dto).getUpTest2Child2TestChildLinks();
      return upTest2Child2TestChildLinks;
    }

    @Override
    protected java.util.List<com.poesys.db.pk.IPrimaryKey> getPrimaryKeys() {
      return ((com.poesys.db.memcached_test.TestChild)dto).upTest2Child2TestChildLinksKeys;
    }
    ...
    protected void set(java.util.Collection<com.poesys.db.memcached_test.ITestChild2TestChild> collection) {
      ((com.poesys.db.memcached_test.TestChild)dto).upTest2Child2TestChildLinks = collection;
    }
  }
  ...
  private class ReadDownTest2Child2TestChildLinksSetter 
    ...
    @Override
    protected java.util.Collection<com.poesys.db.memcached_test.ITestChild2TestChild> getObjectCollection() {
      java.util.Collection<com.poesys.db.memcached_test.ITestChild2TestChild> downTest2Child2TestChildLinks =  ((com.poesys.db.memcached_test.TestChild)dto).getDownTest2Child2TestChildLinks();
      return downTest2Child2TestChildLinks;
    }

    @Override
    protected java.util.List<com.poesys.db.pk.IPrimaryKey> getPrimaryKeys() {
      return ((com.poesys.db.memcached_test.TestChild)dto).downTest2Child2TestChildLinksKeys;
    }
    ...
    @Override
    protected void set(java.util.Collection<com.poesys.db.memcached_test.ITestChild2TestChild> collection) {
      ((com.poesys.db.memcached_test.TestChild)dto).downTest2Child2TestChildLinks = collection;
    }
  }
