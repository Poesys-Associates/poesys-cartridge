...
import com.poesys.db.memcached_test.ILeafB;
import com.poesys.db.memcached_test.LeafBProxy;
import com.poesys.db.memcached_test.LeafB;


/**
 * <p>
 * A business layer data-transfer object (DTO) for the LeafB. This class
 ...
 */
public abstract class AbstractBsLeafB 
    extends AbstractDto<com.poesys.db.memcached_test.ILeafB> {
   ...
   */
  public AbstractBsLeafB(ILeafB dto) throws DelegateException {
    super(dto);
  }

  /**
   * Create a LeafB from new data.
   *
   ...
   * @param bString 
   */
  public AbstractBsLeafB(IPrimaryKey key, java.math.BigInteger baseId, java.lang.String baseString, java.lang.String middleString, java.lang.String bString) {
    super(new LeafBProxy(new LeafB(key, baseId, baseString, middleString, bString)));
  }
  ...
  public boolean equals(Object arg0) {
    // Unchecked cast here
    IDto<ILeafB> other = (IDto<ILeafB>)arg0;
  ...
  public int compareTo(IDto<ILeafB> o) {
...
// Read/Write property: true
   ...
   * <ul>
   * <li>Property is read/write: true</li>
   * <li>Property is defined in the data-access object LeafB</li>
   * </ul>
   * </p>
   * @return a java.lang.String bString
   */
  public java.lang.String getBString() {
    return dto.getBString();
  }
   ...
   * </ul>
   * </p>
   * @param bString the associated business object
   * @throws com.poesys.db.dto.DtoStatusException when the system can't set
   *                 the data-access status to CHANGED
   * @throws com.poesys.db.InvalidParametersException when the property is
   *                 required but the input parameter bString is null
   */
