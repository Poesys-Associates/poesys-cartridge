...
/**
 * <p>
 * A separate, shareable set of factory methods for all the test
 ...
 * concrete subclass, TestFactory, that you can modify to override
...
public abstract class AbstractTestFactory {
   ...
   * a LeafB object.
   * 
   * @param key the primary key for the Test
  ...
  public static IPrimaryKey getLeafBPrimaryKey(ResultSet rs, String prefix)
    ...
    // superclass Base
    // superclass subsystem Test
    // superclass Middle
    // superclass subsystem Test
    key = com.poesys.db.test.TestFactory.getMiddlePrimaryKey(rs, "");
    return key;
  }
  ...
  public static IPrimaryKey getLeafBPrimaryKey(java.math.BigInteger baseId)
    ...
    if (baseId != null) {
      key = com.poesys.db.pk.PrimaryKeyFactory.createSequenceKey("baseId", baseId, "com.poesys.db.test.LeafB");
    }
    return key;
  }
  ...
  public static IPrimaryKey getTestYPrimaryKey(ResultSet rs, String prefix)
    ...
    java.math.BigInteger testYIdValue = rs.getBigDecimal("testYId") == null ? null : rs.getBigDecimal("testYId").toBigInteger();;
    key = com.poesys.db.pk.PrimaryKeyFactory.createSequenceKey(prefix + "testYId", testYIdValue, "com.poesys.db.test.TestY");
    return key;
  }
  ...
  public static IPrimaryKey getTairObjectPrimaryKey(ResultSet rs, String prefix)
    ...
    key = com.poesys.db.pk.PrimaryKeyFactory.createIdentityKey(prefix + "tairObjectId", tairObjectIdValue, "com.poesys.db.test.TairObject");
    return key;
  }
  ...
  public static IPrimaryKey getTairObjectPrimaryKey(java.math.BigInteger tairObjectId)
    ...
    IPrimaryKey key = null;
    // Always create a key.
      key = com.poesys.db.pk.PrimaryKeyFactory.createIdentityKey("tairObjectId", tairObjectId, "com.poesys.db.test.TairObject");
    return key;
  }
  ...
  public static IPrimaryKey getSelf4PrimaryKey(ResultSet rs, String prefix)
    ...
    key = com.poesys.db.pk.PrimaryKeyFactory.createNaturalKey(list, "com.poesys.db.test.Self4");
    return key;
  }
  ...
  public static IPrimaryKey getTestChildPrimaryKey(ResultSet rs, String prefix)
	...
	IPrimaryKey subKey = com.poesys.db.pk.PrimaryKeyFactory.createNaturalKey(list, "com.poesys.db.test.TestChild");
    key = com.poesys.db.pk.PrimaryKeyFactory.createCompositeKey(parentKey, subKey, "com.poesys.db.test.TestChild");
    return key;
  }
  ...
  public static IPrimaryKey getTestParentPrimaryKey(ResultSet rs, String prefix)
    ...
    java.math.BigInteger testParentIdValue = rs.getBigDecimal("testParentId") == null ? null : rs.getBigDecimal("testParentId").toBigInteger();;
    key = com.poesys.db.pk.PrimaryKeyFactory.createSequenceKey(prefix + "testParentId", testParentIdValue, "com.poesys.db.test.TestParent");
    return key;
  }
  ...
  public static IMapElement getMapElementData(IPrimaryKey key, ResultSet rs)
    ...
    com.poesys.db.test.IMap mapsObject = null;
    // Assign null to association key object, as this is set by QuerySetter
    com.poesys.db.test.IPoly polysObject = null;
  ...
  public static IPrimaryKey getMapElementPrimaryKey(ResultSet rs, String prefix)
    ...
    // superclass subsystem Test
    key = com.poesys.db.test.TestFactory.getTairObjectPrimaryKey(rs, "");
    return key;
  }
  ...
  public static IPrimaryKey getMapElementPrimaryKey(java.math.BigInteger tairObjectId)
    ...
    IPrimaryKey key = null;
    // Always create a key.
      key = com.poesys.db.pk.PrimaryKeyFactory.createIdentityKey("tairObjectId", tairObjectId, "com.poesys.db.test.MapElement");
    return key;
  }
  ...
  public static ITestChild2TestChild getTestChild2TestChildData(IPrimaryKey key, ResultSet rs)
      throws SQLException, InvalidParametersException {
    // Assign null to association key object, as this is set by QuerySetter
    com.poesys.db.test.ITestChild downObject = null;
    // Assign null to association key object, as this is set by QuerySetter
    com.poesys.db.test.ITestChild upObject = null;
  ...
  public static IPrimaryKey getTestChild2TestChildPrimaryKey(ResultSet rs, String prefix)
	...
	IPrimaryKey downSubKey = com.poesys.db.pk.PrimaryKeyFactory.createNaturalKey(downKeys, "com.poesys.db.test.TestChild2TestChild");
    list.add(com.poesys.db.pk.PrimaryKeyFactory.createCompositeKey(downKey, downSubKey, "com.poesys.db.test.TestChild2TestChild"));
    // Associated key type CompositeKey
	...
	IPrimaryKey upSubKey = com.poesys.db.pk.PrimaryKeyFactory.createNaturalKey(upKeys, "com.poesys.db.test.TestChild2TestChild");
    list.add(com.poesys.db.pk.PrimaryKeyFactory.createCompositeKey(upKey, upSubKey, "com.poesys.db.test.TestChild2TestChild"));
	key = com.poesys.db.pk.PrimaryKeyFactory.createAssociationKey(list, "com.poesys.db.test.TestChild2TestChild");
    return key;
  }
  ...
  public static IPrimaryKey getTestChild2TestChildPrimaryKey(java.math.BigInteger downChildNo, java.math.BigInteger upChildNo, java.math.BigInteger downTestParentId, java.math.BigInteger upTestParentId)
    ...
    if (downParentKey != null) {
      java.util.ArrayList<com.poesys.db.col.AbstractColumnValue> downTestParentList =
        new java.util.ArrayList<com.poesys.db.col.AbstractColumnValue>();
	  IPrimaryKey downSubKey = com.poesys.db.pk.PrimaryKeyFactory.createNaturalKey(downTestParentList, "com.poesys.db.test.TestChild2TestChild");
      key = com.poesys.db.pk.PrimaryKeyFactory.createCompositeKey(downParentKey, downSubKey, "com.poesys.db.test.TestChild2TestChild");
    } else {
      noNulls = false;
    }
    ...
    if (upParentKey != null) {
      java.util.ArrayList<com.poesys.db.col.AbstractColumnValue> upTestParentList =
        new java.util.ArrayList<com.poesys.db.col.AbstractColumnValue>();
	  IPrimaryKey upSubKey = com.poesys.db.pk.PrimaryKeyFactory.createNaturalKey(upTestParentList, "com.poesys.db.test.TestChild2TestChild");
      key = com.poesys.db.pk.PrimaryKeyFactory.createCompositeKey(upParentKey, upSubKey, "com.poesys.db.test.TestChild2TestChild");
    } else {
      noNulls = false;
    }
    if (noNulls) {
  ...
  public static IPrimaryKey getLeafCPrimaryKey(ResultSet rs, String prefix)
    ...
    // superclass subsystem Test
    key = com.poesys.db.test.TestFactory.getConcreteMiddlePrimaryKey(rs, "");
    return key;
  }
  ...
  public static IPrimaryKey getLeafCPrimaryKey(java.math.BigInteger baseId)
    ...
    // Only create a key if the input value is present.
    if (baseId != null) {
      key = com.poesys.db.pk.PrimaryKeyFactory.createSequenceKey("baseId", baseId, "com.poesys.db.test.LeafC");
    }
    return key;
  }
  ...
  public static IPrimaryKey getTestAssociationChildPrimaryKey(ResultSet rs, String prefix)
	...
	IPrimaryKey subKey = com.poesys.db.pk.PrimaryKeyFactory.createNaturalKey(list, "com.poesys.db.test.TestAssociationChild");
    key = com.poesys.db.pk.PrimaryKeyFactory.createCompositeKey(parentKey, subKey, "com.poesys.db.test.TestAssociationChild");
    return key;
  }
  ...
  public static IPrimaryKey getBasePrimaryKey(ResultSet rs, String prefix)
    ...
    java.math.BigInteger baseIdValue = rs.getBigDecimal("baseId") == null ? null : rs.getBigDecimal("baseId").toBigInteger();;
    key = com.poesys.db.pk.PrimaryKeyFactory.createSequenceKey(prefix + "baseId", baseIdValue, "com.poesys.db.test.Base");
    return key;
  }
  ...
  public static IPrimaryKey getBasePrimaryKey(java.math.BigInteger baseId)
    ...
    // Only create a key if the input value is present.
    if (baseId != null) {
      key = com.poesys.db.pk.PrimaryKeyFactory.createSequenceKey("baseId", baseId, "com.poesys.db.test.Base");
    }
    return key;
  }
  ...
  public static IPrimaryKey getTestSequenceKeyPrimaryKey(ResultSet rs, String prefix)
    ...
    java.math.BigInteger testSequenceKeyIdValue = rs.getBigDecimal("testSequenceKeyId") == null ? null : rs.getBigDecimal("testSequenceKeyId").toBigInteger();;
    key = com.poesys.db.pk.PrimaryKeyFactory.createSequenceKey(prefix + "testSequenceKeyId", testSequenceKeyIdValue, "com.poesys.db.test.TestSequenceKey");
    return key;
  }
  ...
  public static IPrimaryKey getTestSequenceKeyPrimaryKey(java.math.BigInteger testSequenceKeyId)
    ...
    if (testSequenceKeyId != null) {
      key = com.poesys.db.pk.PrimaryKeyFactory.createSequenceKey("testSequenceKeyId", testSequenceKeyId, "com.poesys.db.test.TestSequenceKey");
    }
    return key;
  }
  ...
  public static ISelf4Self getSelf4SelfData(IPrimaryKey key, ResultSet rs)
      throws SQLException, InvalidParametersException {
    // Assign null to association key object, as this is set by QuerySetter
    com.poesys.db.test.ISelf4 children4Object = null;
    // Assign null to association key object, as this is set by QuerySetter
    com.poesys.db.test.ISelf4 parents4Object = null;
    ...
    ISelf4Self newObject = 
      new Self4Self(key, children4Object, parents4Object, children4Key1Value, parents4Key1Value, children4Key2Value, parents4Key2Value);
    return newObject;
  }
  ...
  public static IPrimaryKey getSelf4SelfPrimaryKey(ResultSet rs, String prefix)
    ...
    list.add(com.poesys.db.pk.PrimaryKeyFactory.createNaturalKey(children4Keys, "com.poesys.db.test.Self4Self"));
    // Associated key type NaturalKey
    ...
    list.add(com.poesys.db.pk.PrimaryKeyFactory.createNaturalKey(parents4Keys, "com.poesys.db.test.Self4Self"));
	key = com.poesys.db.pk.PrimaryKeyFactory.createAssociationKey(list, "com.poesys.db.test.Self4Self");
    return key;
  }
   ...
   * @throws InvalidParametersException when there is a problem creating a key
   */
  public static IPrimaryKey getSelf4SelfPrimaryKey(java.lang.Long children4Key1, java.lang.Long parents4Key1, java.lang.Long children4Key2, java.lang.Long parents4Key2)
      throws InvalidParametersException {
    IPrimaryKey key = null;
    // Track whether any input keys are null.
    boolean noNulls = true;
  ...
  public static IPrimaryKey getTestNaturalKeyPrimaryKey(ResultSet rs, String prefix)
    ...
    key = com.poesys.db.pk.PrimaryKeyFactory.createNaturalKey(list, "com.poesys.db.test.TestNaturalKey");
    return key;
  }
  ...
  public static IPrimaryKey getTestExplicitKeyChildPrimaryKey(ResultSet rs, String prefix)
	...
	IPrimaryKey subKey = com.poesys.db.pk.PrimaryKeyFactory.createNaturalKey(list, "com.poesys.db.test.TestExplicitKeyChild");
    key = com.poesys.db.pk.PrimaryKeyFactory.createCompositeKey(parentKey, subKey, "com.poesys.db.test.TestExplicitKeyChild");
    return key;
  }
  ...
  public static ITC2TC2TC2TC getTC2TC2TC2TCData(IPrimaryKey key, ResultSet rs)
      throws SQLException, InvalidParametersException {
    // Assign null to association key object, as this is set by QuerySetter
    com.poesys.db.test.ITestChild2TestChild tc1Object = null;
    // Assign null to association key object, as this is set by QuerySetter
    com.poesys.db.test.ITestChild2TestChild tc2Object = null;
  ...
  public static IPrimaryKey getTC2TC2TC2TCPrimaryKey(ResultSet rs, String prefix)
	...
	key = com.poesys.db.pk.PrimaryKeyFactory.createAssociationKey(list, "com.poesys.db.test.TC2TC2TC2TC");
    return key;
  }
  ...
  public static IPrimaryKey getTestChildChildPrimaryKey(ResultSet rs, String prefix)
	...
	IPrimaryKey subKey = com.poesys.db.pk.PrimaryKeyFactory.createNaturalKey(list, "com.poesys.db.test.TestChildChild");
    key = com.poesys.db.pk.PrimaryKeyFactory.createCompositeKey(parentKey, subKey, "com.poesys.db.test.TestChildChild");
    return key;
  }
  ...
  public static IPrimaryKey getTestXPrimaryKey(ResultSet rs, String prefix)
    ...
    java.math.BigInteger testXIdValue = rs.getBigDecimal("testXId") == null ? null : rs.getBigDecimal("testXId").toBigInteger();;
    key = com.poesys.db.pk.PrimaryKeyFactory.createSequenceKey(prefix + "testXId", testXIdValue, "com.poesys.db.test.TestX");
    return key;
  }
  ...
  public static IPrimaryKey getTestXPrimaryKey(java.math.BigInteger testXId)
    ...
    // Only create a key if the input value is present.
    if (testXId != null) {
      key = com.poesys.db.pk.PrimaryKeyFactory.createSequenceKey("testXId", testXId, "com.poesys.db.test.TestX");
    }
    return key;
  }
  ...
  public static IPrimaryKey getMapPrimaryKey(ResultSet rs, String prefix)
    ...
    java.math.BigInteger mapIdValue = rs.getBigDecimal("mapId") == null ? null : rs.getBigDecimal("mapId").toBigInteger();;
    key = com.poesys.db.pk.PrimaryKeyFactory.createIdentityKey(prefix + "mapId", mapIdValue, "com.poesys.db.test.Map");
    return key;
  }
  ...
  public static IPrimaryKey getMapPrimaryKey(java.math.BigInteger mapId)
    ...
    IPrimaryKey key = null;
    // Always create a key.
      key = com.poesys.db.pk.PrimaryKeyFactory.createIdentityKey("mapId", mapId, "com.poesys.db.test.Map");
    return key;
  }
  ...
  public static IPrimaryKey getTestNaturalParentPrimaryKey(ResultSet rs, String prefix)
    ...
    list.add(new com.poesys.db.col.LongColumnValue(prefix + "key2", key2Value));
    key = com.poesys.db.pk.PrimaryKeyFactory.createNaturalKey(list, "com.poesys.db.test.TestNaturalParent");
    return key;
  }
  ...
  public static IPrimaryKey getSelf2PrimaryKey(ResultSet rs, String prefix)
    ...
    java.math.BigInteger self2IdValue = rs.getBigDecimal("self2Id") == null ? null : rs.getBigDecimal("self2Id").toBigInteger();;
    key = com.poesys.db.pk.PrimaryKeyFactory.createSequenceKey(prefix + "self2Id", self2IdValue, "com.poesys.db.test.Self2");
    return key;
  }
  ...
  public static IPrimaryKey getSelf2PrimaryKey(java.math.BigInteger self2Id)
    ...
    // Only create a key if the input value is present.
    if (self2Id != null) {
      key = com.poesys.db.pk.PrimaryKeyFactory.createSequenceKey("self2Id", self2Id, "com.poesys.db.test.Self2");
    }
    return key;
  }
  ...
  public static IPrimaryKey getConcreteMiddlePrimaryKey(ResultSet rs, String prefix)
    ...
    // superclass Base
    // superclass subsystem Test
    key = com.poesys.db.test.TestFactory.getBasePrimaryKey(rs, "");
    return key;
  }
  ...
  public static ITestZ getTestZData(IPrimaryKey key, ResultSet rs)
      throws SQLException, InvalidParametersException {
    // Assign null to association key object, as this is set by QuerySetter
    com.poesys.db.test.ITestX xsObject = null;
    // Assign null to association key object, as this is set by QuerySetter
    com.poesys.db.test.ITestY ysObject = null;
    // Constructor argument testXId gets the JDBC value with a function call.
    java.math.BigInteger testXIdValue = rs.getBigDecimal("testXId") == null ? null : rs.getBigDecimal("testXId").toBigInteger();;
    // Constructor argument testYId gets the JDBC value with a function call.
    java.math.BigInteger testYIdValue = rs.getBigDecimal("testYId") == null ? null : rs.getBigDecimal("testYId").toBigInteger();;
  ...
  public static IPrimaryKey getTestZPrimaryKey(ResultSet rs, String prefix)
    ...
    java.math.BigInteger testXIdValue = rs.getBigDecimal("testXId") == null ? null : rs.getBigDecimal("testXId").toBigInteger();
    list.add(com.poesys.db.pk.PrimaryKeyFactory.createSequenceKey(prefix + "testXId", testXIdValue, "com.poesys.db.test.TestZ"));
    // Associated key type SequenceKey
    // Property source: AddGeneratedKeyProperties + getAssociatedKeys
    java.math.BigInteger testYIdValue = rs.getBigDecimal("testYId") == null ? null : rs.getBigDecimal("testYId").toBigInteger();
    list.add(com.poesys.db.pk.PrimaryKeyFactory.createSequenceKey(prefix + "testYId", testYIdValue, "com.poesys.db.test.TestZ"));
	key = com.poesys.db.pk.PrimaryKeyFactory.createAssociationKey(list, "com.poesys.db.test.TestZ");
    return key;
  }
  ...
  public static IPrimaryKey getTestZPrimaryKey(java.math.BigInteger testXId, java.math.BigInteger testYId)
    ...
    if (testXId != null) {
      list.add(com.poesys.db.pk.PrimaryKeyFactory.createSequenceKey("testXId", testXId, "com.poesys.db.test.TestZ"));
    } else {
      noNulls = false;
    }
    // Associated key: ys with type SequenceKey
    if (testYId != null) {
      list.add(com.poesys.db.pk.PrimaryKeyFactory.createSequenceKey("testYId", testYId, "com.poesys.db.test.TestZ"));
    } else {
      noNulls = false;
    }
    if (noNulls) {
  ...
  public static IPrimaryKey getTestBPrimaryKey(ResultSet rs, String prefix)
    ...
    java.math.BigInteger testBIdValue = rs.getBigDecimal("b_id") == null ? null : rs.getBigDecimal("b_id").toBigInteger();;
    key = com.poesys.db.pk.PrimaryKeyFactory.createSequenceKey(prefix + "b_id", testBIdValue, "com.poesys.db.test.TestB");
    return key;
  }
  ...
  public static IPrimaryKey getTestAPrimaryKey(ResultSet rs, String prefix)
    ...
    java.math.BigInteger testAIdValue = rs.getBigDecimal("testAId") == null ? null : rs.getBigDecimal("testAId").toBigInteger();;
    key = com.poesys.db.pk.PrimaryKeyFactory.createSequenceKey(prefix + "testAId", testAIdValue, "com.poesys.db.test.TestA");
    return key;
  }
  ...
  public static IPrimaryKey getTestIdentityKeyPrimaryKey(ResultSet rs, String prefix)
    ...
    java.math.BigInteger testIdentityKeyIdValue = rs.getBigDecimal("testIdentityKeyId") == null ? null : rs.getBigDecimal("testIdentityKeyId").toBigInteger();;
    key = com.poesys.db.pk.PrimaryKeyFactory.createIdentityKey(prefix + "testIdentityKeyId", testIdentityKeyIdValue, "com.poesys.db.test.TestIdentityKey");
    return key;
  }
  ...
  public static IPrimaryKey getTestIdentityKeyPrimaryKey(java.math.BigInteger testIdentityKeyId)
    ...
    IPrimaryKey key = null;
    // Always create a key.
      key = com.poesys.db.pk.PrimaryKeyFactory.createIdentityKey("testIdentityKeyId", testIdentityKeyId, "com.poesys.db.test.TestIdentityKey");
    return key;
  }
  ...
  public static IPrimaryKey getPolyPrimaryKey(ResultSet rs, String prefix)
    ...
    java.math.BigInteger polyIdValue = rs.getBigDecimal("polyId") == null ? null : rs.getBigDecimal("polyId").toBigInteger();;
    key = com.poesys.db.pk.PrimaryKeyFactory.createIdentityKey(prefix + "polyId", polyIdValue, "com.poesys.db.test.Poly");
    return key;
  }
  ...
  public static IPrimaryKey getPolyPrimaryKey(java.math.BigInteger polyId)
    ...
    IPrimaryKey key = null;
    // Always create a key.
      key = com.poesys.db.pk.PrimaryKeyFactory.createIdentityKey("polyId", polyId, "com.poesys.db.test.Poly");
    return key;
  }
  ...
  public static IPrimaryKey getMiddlePrimaryKey(java.math.BigInteger baseId)
    ...
    // Only create a key if the input value is present.
    if (baseId != null) {
      key = com.poesys.db.pk.PrimaryKeyFactory.createSequenceKey("baseId", baseId, "com.poesys.db.test.Middle");
    }
    return key;
  }
  ...
  public static IPrimaryKey getTestNaturalChildPrimaryKey(ResultSet rs, String prefix)
	...
	IPrimaryKey subKey = com.poesys.db.pk.PrimaryKeyFactory.createNaturalKey(list, "com.poesys.db.test.TestNaturalChild");
    key = com.poesys.db.pk.PrimaryKeyFactory.createCompositeKey(parentKey, subKey, "com.poesys.db.test.TestNaturalChild");
    return key;
  }
  ...
  public static ISelf2Self getSelf2SelfData(IPrimaryKey key, ResultSet rs)
      throws SQLException, InvalidParametersException {
    // Assign null to association key object, as this is set by QuerySetter
    com.poesys.db.test.ISelf2 children2Object = null;
    // Assign null to association key object, as this is set by QuerySetter
    com.poesys.db.test.ISelf2 parents2Object = null;
  ...
  public static IPrimaryKey getSelf2SelfPrimaryKey(ResultSet rs, String prefix)
    ...
    // Property source: AddGeneratedKeyProperties + getAssociatedKeys
    java.math.BigInteger children2Self2IdValue = rs.getBigDecimal("children2Self2Id") == null ? null : rs.getBigDecimal("children2Self2Id").toBigInteger();
    list.add(com.poesys.db.pk.PrimaryKeyFactory.createSequenceKey(prefix + "children2Self2Id", children2Self2IdValue, "com.poesys.db.test.Self2Self"));
    // Associated key type SequenceKey
    // Property source: AddGeneratedKeyProperties + getAssociatedKeys
    java.math.BigInteger parents2Self2IdValue = rs.getBigDecimal("parents2Self2Id") == null ? null : rs.getBigDecimal("parents2Self2Id").toBigInteger();
    list.add(com.poesys.db.pk.PrimaryKeyFactory.createSequenceKey(prefix + "parents2Self2Id", parents2Self2IdValue, "com.poesys.db.test.Self2Self"));
	key = com.poesys.db.pk.PrimaryKeyFactory.createAssociationKey(list, "com.poesys.db.test.Self2Self");
    return key;
  }
  ...
  public static IPrimaryKey getSelf2SelfPrimaryKey(java.math.BigInteger children2Self2Id, java.math.BigInteger parents2Self2Id)
    ...
    if (children2Self2Id != null) {
      list.add(com.poesys.db.pk.PrimaryKeyFactory.createSequenceKey("children2Self2Id", children2Self2Id, "com.poesys.db.test.Self2Self"));
    } else {
      noNulls = false;
    }
    // Associated key: parents2 with type SequenceKey
    if (parents2Self2Id != null) {
      list.add(com.poesys.db.pk.PrimaryKeyFactory.createSequenceKey("parents2Self2Id", parents2Self2Id, "com.poesys.db.test.Self2Self"));
    } else {
      noNulls = false;
    }
    if (noNulls) {
