...
public abstract class AbstractTestNaturalParentProxy extends AbstractLazyLoadingDtoProxy implements ITestNaturalParent {
  ...
  private class ReadChildrenSetter 
    ...
    protected java.util.Collection<com.poesys.db.test.ITestNaturalChild> getObjectCollection() {
      java.util.Collection<com.poesys.db.test.ITestNaturalChild> children =  ((com.poesys.db.test.TestNaturalParent)dto).getChildren();
      return children;
    }

    @Override
    protected java.util.List<com.poesys.db.pk.IPrimaryKey> getPrimaryKeys() {
      return ((com.poesys.db.test.TestNaturalParent)dto).childrenKeys;
    }
    ...
    protected void set(java.util.Collection<com.poesys.db.test.ITestNaturalChild> collection) {
      ((com.poesys.db.test.TestNaturalParent)dto).children = collection;
    }
  }
  ...
  private class ReadAssocChildrenSetter 
    ...
    protected java.util.Collection<com.poesys.db.test.ITestAssociationChild> getObjectCollection() {
      java.util.Collection<com.poesys.db.test.ITestAssociationChild> assocChildren =  ((com.poesys.db.test.TestNaturalParent)dto).getAssocChildren();
      return assocChildren;
    }

    @Override
    protected java.util.List<com.poesys.db.pk.IPrimaryKey> getPrimaryKeys() {
      return ((com.poesys.db.test.TestNaturalParent)dto).assocChildrenKeys;
    }
    ...
    protected void set(java.util.Collection<com.poesys.db.test.ITestAssociationChild> collection) {
      ((com.poesys.db.test.TestNaturalParent)dto).assocChildren = collection;
    }
  }
