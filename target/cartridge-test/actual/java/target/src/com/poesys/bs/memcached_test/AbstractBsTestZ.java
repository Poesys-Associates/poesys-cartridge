...
import com.poesys.db.memcached_test.ITestZ;
import com.poesys.db.memcached_test.TestZProxy;
import com.poesys.db.memcached_test.TestZ;
...
public abstract class AbstractBsTestZ 
    extends AbstractDto<com.poesys.db.memcached_test.ITestZ> {
   ...
   * com.poesys.db.memcached_test.ITestAssociationChild objects
   */
  private class BsTestsCollectionBuilder 
      extends com.poesys.bs.dto.CollectionBuilder<com.poesys.db.memcached_test.ITestAssociationChild, com.poesys.bs.memcached_test.BsTestAssociationChild> {
    @Override
    public com.poesys.bs.memcached_test.BsTestAssociationChild get(com.poesys.db.memcached_test.ITestAssociationChild dto) {
  ...
  private class TestsCollectionBuilder 
      extends com.poesys.bs.dto.CollectionBuilder<com.poesys.bs.memcached_test.BsTestAssociationChild, com.poesys.db.memcached_test.ITestAssociationChild> {
    @Override
    public com.poesys.db.memcached_test.ITestAssociationChild get(com.poesys.bs.memcached_test.BsTestAssociationChild dto) {
      return dto.toDto();
    }
  }
   ...
   * @param zAttr 
   */
  public AbstractBsTestZ(IPrimaryKey key, com.poesys.db.memcached_test.ITestX xsObject, com.poesys.db.memcached_test.ITestY ysObject, java.math.BigInteger testXId, java.math.BigInteger testYId, java.lang.String zAttr) {
   ...
   * </ul>
   * </p>
   * @return a com.poesys.bs.memcached_test.BsTestAssociationChild zAttr
   */
  public java.util.Collection<com.poesys.bs.memcached_test.BsTestAssociationChild> getTests() {
   ...
   *                 the data-access status to CHANGED
   */
  public void setTests(java.util.Collection<com.poesys.bs.memcached_test.BsTestAssociationChild> zAttr) 
      throws com.poesys.db.dto.DtoStatusException{
   ...
   * </ul>
   * </p>
   * @return a com.poesys.bs.memcached_test.BsTestY y
   * @throws java.sql.SQLException when the method can't get a SQL connection to 
   *                               load the property lazily
   */
  public com.poesys.bs.memcached_test.BsTestY getY() throws java.sql.SQLException {
    // Return 4
    return new com.poesys.bs.memcached_test.BsTestY(dto.getY());
  }
   ...
   * </ul>
   * </p>
   * @return a com.poesys.bs.memcached_test.BsTestX x
   */
  public com.poesys.bs.memcached_test.BsTestX getX() {
    // Return 4
    return new com.poesys.bs.memcached_test.BsTestX(dto.getX());
  }
   ...
   */
  public void addTestsTestAssociationChild(com.poesys.bs.memcached_test.BsTestAssociationChild object) {
