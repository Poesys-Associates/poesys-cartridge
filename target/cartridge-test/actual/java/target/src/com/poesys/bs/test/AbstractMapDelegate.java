...
public abstract class AbstractMapDelegate
    extends AbstractIdentityDataDelegate<BsMap, com.poesys.db.test.IMap, com.poesys.db.pk.IdentityPrimaryKey> {
  /**
  ...
  @Override
  protected IInsertSql<com.poesys.db.test.IMap> getInsertSql() {
    return new com.poesys.db.test.sql.InsertMap();
  }

  @Override
  protected IDeleteSql<com.poesys.db.test.IMap> getDeleteSql() {
    return new com.poesys.db.test.sql.DeleteMap();
  }

  @Override
  protected IUpdateSql<com.poesys.db.test.IMap> getUpdateSql() {
    return new com.poesys.db.test.sql.UpdateMap();
  }

  @Override
  protected IKeyQuerySql<com.poesys.db.test.IMap> getQueryByKeySql() {
    return new com.poesys.db.test.sql.QueryMap();
  }

  @Override
  protected IQuerySql<com.poesys.db.test.IMap> getQueryListSql() {
    // Query-All method not required
    return new com.poesys.db.test.sql.QueryAllMap();
  }

  @Override
  protected com.poesys.bs.test.BsMap wrapData(com.poesys.db.test.IMap dto) {
   ...
   *             creating the object
   */
  public com.poesys.bs.test.BsMap createMap(java.math.BigInteger mapId, java.lang.Long location)
      throws DelegateException {
    com.poesys.db.pk.IPrimaryKey key = 
      com.poesys.db.test.TestFactory.getMapPrimaryKey(mapId);
      
    // Create a data-access DTO for direct access, no proxy required.
    com.poesys.db.test.IMap dto =
      new com.poesys.db.test.Map(key, mapId, location);
