...
public abstract class AbstractTestXProxy extends AbstractLazyLoadingDtoProxy implements ITestX {
   ...
   *
   * @see com.poesys.db.memcached_test.sql.QueryYsByTestX
   */
  private class QueryYsSetter 
      extends com.poesys.db.dto.AbstractLazyListSetter<com.poesys.db.memcached_test.ITestY, ITestX, java.util.Collection<com.poesys.db.memcached_test.ITestY>> {
    ...
    @Override
    protected com.poesys.db.dao.query.IParameterizedQuerySql<com.poesys.db.memcached_test.ITestY, ITestX> getSql() {
      return new com.poesys.db.memcached_test.sql.QueryYsByTestX();
    }

    @Override
    protected void set(java.util.Collection<com.poesys.db.memcached_test.ITestY> collection) {
      try {
        // Register the observer parent with the subject children.
        for (com.poesys.db.memcached_test.ITestY child : collection) {
  ...
  private class ReadYsSetter 
      extends com.poesys.db.dto.AbstractCollectionReadSetter<com.poesys.db.memcached_test.ITestY> {
    private static final long serialVersionUID = 1L;
    ...
    @Override
    protected java.util.Collection<com.poesys.db.memcached_test.ITestY> getObjectCollection() {
      java.util.Collection<com.poesys.db.memcached_test.ITestY> ys = null;
      try {
        ys = ((com.poesys.db.memcached_test.TestX)dto).getYs();
    ...
    protected java.util.List<com.poesys.db.pk.IPrimaryKey> getPrimaryKeys() {
      return ((com.poesys.db.memcached_test.TestX)dto).yKeys;
    }
    ...
    @Override
    protected void set(java.util.Collection<com.poesys.db.memcached_test.ITestY> collection) {
      ((com.poesys.db.memcached_test.TestX)dto).ys = collection;
    }
  }


  /**
   * Add a com.poesys.db.memcached_test.ITestY object to the Ys collection. The method
   ...
   * Source: TransformToProperty + AddToManyAssociationCollectionProperties
   * 
   * @param object the com.poesys.db.memcached_test.ITestY object to add to the collection
   * @throws java.sql.SQLException when there is a database problem
   */
  public void addYsTestY(com.poesys.db.memcached_test.ITestY object)throws java.sql.SQLException {
  ...
  private class ReadZsSetter 
    ...
    protected java.util.Collection<com.poesys.db.memcached_test.ITestZ> getObjectCollection() {
      java.util.Collection<com.poesys.db.memcached_test.ITestZ> zs =  ((com.poesys.db.memcached_test.TestX)dto).getZs();
      return zs;
    }

    @Override
    protected java.util.List<com.poesys.db.pk.IPrimaryKey> getPrimaryKeys() {
      return ((com.poesys.db.memcached_test.TestX)dto).zsKeys;
    }
    ...
    protected void set(java.util.Collection<com.poesys.db.memcached_test.ITestZ> collection) {
      ((com.poesys.db.memcached_test.TestX)dto).zs = collection;
    }
  }
