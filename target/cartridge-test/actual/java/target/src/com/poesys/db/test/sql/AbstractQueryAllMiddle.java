 ...
 */
public abstract class AbstractQueryAllMiddle implements IQuerySql<com.poesys.db.test.IMiddle> {
  ...
  public com.poesys.db.test.IMiddle getData(ResultSet rs) throws SQLException {
    IPrimaryKey key = 
      TestFactory.getMiddlePrimaryKey(rs, "");
    ...
    if (discriminant.equals("LeafB") && data == null) {
      ...
      data = 
        (com.poesys.db.test.IMiddle)com.poesys.db.test.TestFactory.getLeafBData(key, rs);
    }
    // Check for LeafA, set return only if not already set
    if (discriminant.equals("LeafA") && data == null) {
      // Use the test factory to get the data.
      data = 
        (com.poesys.db.test.IMiddle)com.poesys.db.test.TestFactory.getLeafAData(key, rs);
    }
    return data;
  }
  ...
  public IPrimaryKey getPrimaryKey(ResultSet rs) throws SQLException,
    ...
    return TestFactory.getMiddlePrimaryKey(rs, "");
  }
