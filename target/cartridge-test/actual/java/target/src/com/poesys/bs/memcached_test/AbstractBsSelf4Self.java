...
import com.poesys.db.memcached_test.ISelf4Self;
import com.poesys.db.memcached_test.Self4SelfProxy;
import com.poesys.db.memcached_test.Self4Self;
...
public abstract class AbstractBsSelf4Self 
    extends AbstractDto<com.poesys.db.memcached_test.ISelf4Self> {
   ...
   */
  public AbstractBsSelf4Self(IPrimaryKey key, com.poesys.db.memcached_test.ISelf4 children4Object, com.poesys.db.memcached_test.ISelf4 parents4Object, java.lang.Long parents4Key1, java.lang.Long children4Key1, java.lang.Long parents4Key2, java.lang.Long children4Key2) {
    super(new Self4SelfProxy(new Self4Self(key, children4Object, parents4Object, parents4Key1, children4Key1, parents4Key2, children4Key2)));
  }
   ...
   * </ul>
   * </p>
   * @return a com.poesys.bs.memcached_test.BsSelf4 parent4
   */
  public com.poesys.bs.memcached_test.BsSelf4 getParent4() {
    // Return 4
    return new com.poesys.bs.memcached_test.BsSelf4(dto.getParent4());
  }
   ...
   * </ul>
   * </p>
   * @return a com.poesys.bs.memcached_test.BsSelf4 child4
   */
  public com.poesys.bs.memcached_test.BsSelf4 getChild4() {
    // Return 4
    return new com.poesys.bs.memcached_test.BsSelf4(dto.getChild4());
  }
