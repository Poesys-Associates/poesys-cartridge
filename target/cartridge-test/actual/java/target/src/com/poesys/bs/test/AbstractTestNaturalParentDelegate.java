...
public abstract class AbstractTestNaturalParentDelegate
    extends AbstractDataDelegate<BsTestNaturalParent, com.poesys.db.test.ITestNaturalParent, com.poesys.db.pk.NaturalPrimaryKey> {
  /**
  ...
  @Override
  protected IInsertSql<com.poesys.db.test.ITestNaturalParent> getInsertSql() {
    return new com.poesys.db.test.sql.InsertTestNaturalParent();
  }

  @Override
  protected IDeleteSql<com.poesys.db.test.ITestNaturalParent> getDeleteSql() {
    return new com.poesys.db.test.sql.DeleteTestNaturalParent();
  }

  @Override
  protected IUpdateSql<com.poesys.db.test.ITestNaturalParent> getUpdateSql() {
    return null;
  }

  @Override
  protected IKeyQuerySql<com.poesys.db.test.ITestNaturalParent> getQueryByKeySql() {
    return new com.poesys.db.test.sql.QueryTestNaturalParent();
  }

  @Override
  protected IQuerySql<com.poesys.db.test.ITestNaturalParent> getQueryListSql() {
    // Query-All method not required
    return new com.poesys.db.test.sql.QueryAllTestNaturalParent();
  }

  @Override
  protected com.poesys.bs.test.BsTestNaturalParent wrapData(com.poesys.db.test.ITestNaturalParent dto) {
    return new com.poesys.bs.test.BsTestNaturalParent(dto);
  }
   ...
   *             creating the object
   */
  public com.poesys.bs.test.BsTestNaturalParent createTestNaturalParent(java.lang.Long key1, java.lang.Long key2)
    ...
    try {
      ...
      key = 
        com.poesys.db.pk.PrimaryKeyFactory.createNaturalKey(list, "com.poesys.db.test.TestNaturalParent");
    ...
    com.poesys.db.test.ITestNaturalParent dto =
      new com.poesys.db.test.TestNaturalParent(key, key1, key2);
   ...
   */
  public com.poesys.bs.test.BsTestNaturalChild createTestNaturalChild(com.poesys.bs.test.BsTestNaturalParent parent, java.lang.Long key1, java.lang.Long key2, java.lang.Long subkey) throws DelegateException {
    // Create the key.
    ...
    try {
	  ...
	  com.poesys.db.pk.IPrimaryKey subKey = 
	    com.poesys.db.pk.PrimaryKeyFactory.createNaturalKey(list, "com.poesys.db.test.TestNaturalChild");
      key = 
        com.poesys.db.pk.PrimaryKeyFactory.createCompositeKey(parent.getPrimaryKey(), 
                                                              subKey,
                                                              "com.poesys.db.test.TestNaturalChild");
    } catch (com.poesys.db.InvalidParametersException e) {
      Object[] args = e.getParameters().toArray();
      String message = com.poesys.db.Message.getMessage(e.getMessage(), args);
      throw new DelegateException(message, e);
    ...
    com.poesys.db.test.ITestNaturalChild dto =
      new com.poesys.db.test.TestNaturalChild(key, key1, key2, subkey);
...
Natural Parent, identified by the zKey TestZ object
   ...
   * @throws DelegateException when a parameter causes a problem
   */
  public com.poesys.bs.test.BsTestAssociationChild createTestAssociationChild(com.poesys.bs.test.BsTestNaturalParent parent, java.lang.Long key1, java.lang.Long key2, java.math.BigInteger testXId, java.math.BigInteger testYId, java.lang.Long tsACAttr) throws DelegateException {
    // Create the key.
    com.poesys.db.pk.CompositePrimaryKey key = null;
    try {
      java.util.ArrayList<com.poesys.db.col.AbstractColumnValue> list =
