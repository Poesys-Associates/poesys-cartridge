 ...
 */
public abstract class AbstractQueryAllPoly implements IQuerySql<com.poesys.db.test.IPoly> {
  /** SQL query statement for Poly */
  private static final String SQL =
    "SELECT polyId, sequence FROM Poly";

  public com.poesys.db.test.IPoly getData(ResultSet rs) throws SQLException {
    IPrimaryKey key = 
      TestFactory.getPolyPrimaryKey(rs, "");
      
    return TestFactory.getPolyData(key, rs);
  }
  
  public IPrimaryKey getPrimaryKey(ResultSet rs) throws SQLException,
      InvalidParametersException {
    return TestFactory.getPolyPrimaryKey(rs, "");
  }
