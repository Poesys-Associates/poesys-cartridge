...
import com.poesys.db.memcached_test.ISelf4;
import com.poesys.db.memcached_test.Self4Proxy;
import com.poesys.db.memcached_test.Self4;
...
public abstract class AbstractBsSelf4 
    extends AbstractDto<com.poesys.db.memcached_test.ISelf4> {
   ...
   * com.poesys.db.memcached_test.ISelf4 objects
   */
  private class BsParents4CollectionBuilder 
      extends com.poesys.bs.dto.CollectionBuilder<com.poesys.db.memcached_test.ISelf4, com.poesys.bs.memcached_test.BsSelf4> {
    @Override
    public com.poesys.bs.memcached_test.BsSelf4 get(com.poesys.db.memcached_test.ISelf4 dto) {
   ...
   * com.poesys.db.memcached_test.ISelf4Self objects
   */
  private class BsParents4Self4SelfLinksCollectionBuilder 
      extends com.poesys.bs.dto.CollectionBuilder<com.poesys.db.memcached_test.ISelf4Self, com.poesys.bs.memcached_test.BsSelf4Self> {
    @Override
    public com.poesys.bs.memcached_test.BsSelf4Self get(com.poesys.db.memcached_test.ISelf4Self dto) {
   ...
   * </ul>
   * </p>
   * @return a com.poesys.bs.memcached_test.BsSelf4 key2
   */
  public java.util.Collection<com.poesys.bs.memcached_test.BsSelf4> getParents4() {
   ...
   * @return a com.poesys.bs.memcached_test.BsSelf4 key2
   */
  public java.util.Collection<com.poesys.bs.memcached_test.BsSelf4> getChildren4() {
   ...
   * </ul>
   * </p>
   * @return a com.poesys.bs.memcached_test.BsSelf4Self key2
   */
  public java.util.Collection<com.poesys.bs.memcached_test.BsSelf4Self> getParents4Self4SelfLinks() {
   ...
   * @return a com.poesys.bs.memcached_test.BsSelf4Self key2
   */
  public java.util.Collection<com.poesys.bs.memcached_test.BsSelf4Self> getChildren4Self4SelfLinks() {
