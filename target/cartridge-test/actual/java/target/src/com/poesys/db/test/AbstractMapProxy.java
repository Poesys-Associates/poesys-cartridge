...
public abstract class AbstractMapProxy extends AbstractLazyLoadingDtoProxy implements IMap {
  ...
  private class ReadPolysSetter 
    ...
    protected java.util.List<com.poesys.db.test.IPoly> getObjectList() {
      java.util.List<com.poesys.db.test.IPoly> polys =  ((com.poesys.db.test.Map)dto).getPolys();
      return polys;
    }

    @Override
    protected java.util.List<com.poesys.db.pk.IPrimaryKey> getPrimaryKeys() {
      return ((com.poesys.db.test.Map)dto).polyKeys;
    }
    ...
    protected void set(java.util.List<com.poesys.db.test.IPoly> list) {
      ((com.poesys.db.test.Map)dto).polys = list;
    }
  }

  /**
   * Add a com.poesys.db.test.IPoly object to the Polys collection. The method
   ...
   * Source: TransformToProperty + AddToManyAssociationCollectionProperties
   * 
   * @param object the com.poesys.db.test.IPoly object to add to the collection
   */
  ...
  private class ReadMapElementSetter 
    ...
    protected java.util.Collection<com.poesys.db.test.IMapElement> getObjectCollection() {
      java.util.Collection<com.poesys.db.test.IMapElement> mapElement =  ((com.poesys.db.test.Map)dto).getMapElement();
      return mapElement;
    }

    @Override
    protected java.util.List<com.poesys.db.pk.IPrimaryKey> getPrimaryKeys() {
      return ((com.poesys.db.test.Map)dto).mapElementKeys;
    }
    ...
    protected void set(java.util.Collection<com.poesys.db.test.IMapElement> collection) {
      ((com.poesys.db.test.Map)dto).mapElement = collection;
    }
  }
