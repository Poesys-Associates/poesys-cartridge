...
public abstract class AbstractTestYProxy extends AbstractLazyLoadingDtoProxy implements ITestY {
  ...
  private class ReadXsSetter 
    ...
    protected java.util.Collection<com.poesys.db.test.ITestX> getObjectCollection() {
      java.util.Collection<com.poesys.db.test.ITestX> xs =  ((com.poesys.db.test.TestY)dto).getXs();
      return xs;
    }

    @Override
    protected java.util.List<com.poesys.db.pk.IPrimaryKey> getPrimaryKeys() {
      return ((com.poesys.db.test.TestY)dto).xKeys;
    }
    ...
    protected void set(java.util.Collection<com.poesys.db.test.ITestX> collection) {
      ((com.poesys.db.test.TestY)dto).xs = collection;
    }
  }


  /**
   * Add a com.poesys.db.test.ITestX object to the Xs collection. The method
   ...
   * Source: TransformToProperty + AddToManyAssociationCollectionProperties
   * 
   * @param object the com.poesys.db.test.ITestX object to add to the collection
   */
  ...
  private class ReadZsSetter 
    ...
    protected java.util.Collection<com.poesys.db.test.ITestZ> getObjectCollection() {
      java.util.Collection<com.poesys.db.test.ITestZ> zs =  ((com.poesys.db.test.TestY)dto).getZs();
      return zs;
    }

    @Override
    protected java.util.List<com.poesys.db.pk.IPrimaryKey> getPrimaryKeys() {
      return ((com.poesys.db.test.TestY)dto).zsKeys;
    }
    ...
    protected void set(java.util.Collection<com.poesys.db.test.ITestZ> collection) {
      ((com.poesys.db.test.TestY)dto).zs = collection;
    }
  }
