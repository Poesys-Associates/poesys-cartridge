...
public abstract class AbstractConcreteMiddleDelegate
    extends AbstractDataDelegate<BsConcreteMiddle, com.poesys.db.memcached_test.IConcreteMiddle, com.poesys.db.pk.SequencePrimaryKey> {
  /**
  ...
  protected String getClassName() {
    return com.poesys.db.memcached_test.ConcreteMiddle.class.getName();
  }

  @Override
  protected IInsertSql<com.poesys.db.memcached_test.IConcreteMiddle> getInsertSql() {
    return new com.poesys.db.memcached_test.sql.InsertConcreteMiddle();
  }

  @Override
  protected IDeleteSql<com.poesys.db.memcached_test.IConcreteMiddle> getDeleteSql() {
    return new com.poesys.db.memcached_test.sql.DeleteConcreteMiddle();
  }

  @Override
  protected IUpdateSql<com.poesys.db.memcached_test.IConcreteMiddle> getUpdateSql() {
    return new com.poesys.db.memcached_test.sql.UpdateConcreteMiddle();
  }

  @Override
  protected IKeyQuerySql<com.poesys.db.memcached_test.IConcreteMiddle> getQueryByKeySql() {
    return new com.poesys.db.memcached_test.sql.QueryConcreteMiddle();
  }

  @Override
  protected IQuerySql<com.poesys.db.memcached_test.IConcreteMiddle> getQueryListSql() {
    // Query-All method not required
    return new com.poesys.db.memcached_test.sql.QueryAllConcreteMiddle();
  }

  @Override
  protected com.poesys.bs.memcached_test.BsConcreteMiddle wrapData(com.poesys.db.memcached_test.IConcreteMiddle dto) {
    return new com.poesys.bs.memcached_test.BsConcreteMiddle(dto);
  }
   ...
   *             creating the object
   */
  public com.poesys.bs.memcached_test.BsConcreteMiddle createConcreteMiddle(java.math.BigInteger baseId, java.lang.String baseString, java.lang.String middleString)
        ...
        if (dbms.equals(DBMS.MYSQL) || dbms.equals(DBMS.JNDI_MYSQL)) {
          key =
            com.poesys.db.pk.PrimaryKeyFactory.createMySqlSequenceKey(connection,
                                                                      "Base",
                                                                      "baseId",
                                                                      "com.poesys.db.memcached_test.ConcreteMiddle");
    ...
    com.poesys.db.memcached_test.IConcreteMiddle dto =
      new com.poesys.db.memcached_test.ConcreteMiddle(key, baseId, baseString, middleString);
  ...
  public void process(java.util.List<BsConcreteMiddle> list) throws DelegateException {
    ...
    com.poesys.db.dao.insert.IInsertBatch<com.poesys.db.memcached_test.IConcreteMiddle> inserter = 
      factory.getInsertBatch(getInsertSql());
    com.poesys.db.dao.update.IUpdateBatch<com.poesys.db.memcached_test.IConcreteMiddle> updater = 
      factory.getUpdateBatch(getUpdateSql());
    java.util.Collection<com.poesys.db.memcached_test.IConcreteMiddle> dtos = convertDtoList(list);
