...
import com.poesys.db.memcached_test.ITestNaturalParent;
import com.poesys.db.memcached_test.TestNaturalParentProxy;
import com.poesys.db.memcached_test.TestNaturalParent;
...
public abstract class AbstractBsTestNaturalParent 
    extends AbstractDto<com.poesys.db.memcached_test.ITestNaturalParent> {
   ...
   * com.poesys.db.memcached_test.ITestNaturalChild objects
   */
  private class BsChildrenCollectionBuilder 
      extends com.poesys.bs.dto.CollectionBuilder<com.poesys.db.memcached_test.ITestNaturalChild, com.poesys.bs.memcached_test.BsTestNaturalChild> {
    @Override
    public com.poesys.bs.memcached_test.BsTestNaturalChild get(com.poesys.db.memcached_test.ITestNaturalChild dto) {
   ...
   * </ul>
   * </p>
   * @return a com.poesys.bs.memcached_test.BsTestNaturalChild key2
   */
  public java.util.Collection<com.poesys.bs.memcached_test.BsTestNaturalChild> getChildren() {
   ...
   * </ul>
   * </p>
   * @return a com.poesys.bs.memcached_test.BsTestAssociationChild key2
   */
  public java.util.Collection<com.poesys.bs.memcached_test.BsTestAssociationChild> getAssocChildren() {
