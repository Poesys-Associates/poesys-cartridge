...
public abstract class AbstractSelf2Proxy extends AbstractLazyLoadingDtoProxy implements ISelf2 {
  ...
  private class ReadParents2Setter 
    ...
    protected java.util.Collection<com.poesys.db.test.ISelf2> getObjectCollection() {
      java.util.Collection<com.poesys.db.test.ISelf2> parents2 =  ((com.poesys.db.test.Self2)dto).getParents2();
      return parents2;
    }

    @Override
    protected java.util.List<com.poesys.db.pk.IPrimaryKey> getPrimaryKeys() {
      return ((com.poesys.db.test.Self2)dto).parents2Keys;
    }
    ...
    protected void set(java.util.Collection<com.poesys.db.test.ISelf2> collection) {
      ((com.poesys.db.test.Self2)dto).parents2 = collection;
    }
  }
  ...
  private class ReadChildren2Setter 
    ...
    @Override
    protected java.util.Collection<com.poesys.db.test.ISelf2> getObjectCollection() {
      java.util.Collection<com.poesys.db.test.ISelf2> children2 =  ((com.poesys.db.test.Self2)dto).getChildren2();
      return children2;
    }

    @Override
    protected java.util.List<com.poesys.db.pk.IPrimaryKey> getPrimaryKeys() {
      return ((com.poesys.db.test.Self2)dto).children2Keys;
    }
    ...
    @Override
    protected void set(java.util.Collection<com.poesys.db.test.ISelf2> collection) {
      ((com.poesys.db.test.Self2)dto).children2 = collection;
    }
  }
  ...
  private class ReadParents2Self2SelfLinksSetter 
    ...
    protected java.util.Collection<com.poesys.db.test.ISelf2Self> getObjectCollection() {
      java.util.Collection<com.poesys.db.test.ISelf2Self> parents2Self2SelfLinks =  ((com.poesys.db.test.Self2)dto).getParents2Self2SelfLinks();
      return parents2Self2SelfLinks;
    }

    @Override
    protected java.util.List<com.poesys.db.pk.IPrimaryKey> getPrimaryKeys() {
      return ((com.poesys.db.test.Self2)dto).parents2Self2SelfLinksKeys;
    }
    ...
    protected void set(java.util.Collection<com.poesys.db.test.ISelf2Self> collection) {
      ((com.poesys.db.test.Self2)dto).parents2Self2SelfLinks = collection;
    }
  }
  ...
  private class ReadChildren2Self2SelfLinksSetter 
    ...
    @Override
    protected java.util.Collection<com.poesys.db.test.ISelf2Self> getObjectCollection() {
      java.util.Collection<com.poesys.db.test.ISelf2Self> children2Self2SelfLinks =  ((com.poesys.db.test.Self2)dto).getChildren2Self2SelfLinks();
      return children2Self2SelfLinks;
    }

    @Override
    protected java.util.List<com.poesys.db.pk.IPrimaryKey> getPrimaryKeys() {
      return ((com.poesys.db.test.Self2)dto).children2Self2SelfLinksKeys;
    }
    ...
    @Override
    protected void set(java.util.Collection<com.poesys.db.test.ISelf2Self> collection) {
      ((com.poesys.db.test.Self2)dto).children2Self2SelfLinks = collection;
    }
  }
