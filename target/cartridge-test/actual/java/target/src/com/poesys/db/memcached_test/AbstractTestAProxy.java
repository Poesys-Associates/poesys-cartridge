...
public abstract class AbstractTestAProxy extends AbstractLazyLoadingDtoProxy implements ITestA {
  ...
  private class ReadBsSetter 
    ...
    protected java.util.List<com.poesys.db.memcached_test.ITestB> getObjectList() {
      java.util.List<com.poesys.db.memcached_test.ITestB> bs =  ((com.poesys.db.memcached_test.TestA)dto).getBs();
      return bs;
    }

    @Override
    protected java.util.List<com.poesys.db.pk.IPrimaryKey> getPrimaryKeys() {
      return ((com.poesys.db.memcached_test.TestA)dto).bsKeys;
    }
    ...
    protected void set(java.util.List<com.poesys.db.memcached_test.ITestB> list) {
      ((com.poesys.db.memcached_test.TestA)dto).bs = list;
    }
  }
  /**
