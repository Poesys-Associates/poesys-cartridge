...
public abstract class AbstractSelf4Self extends AbstractDto implements ISelf4Self {
   ...
   * @author Poesys/DB Cartridge
   */
  private class QueryParent4Setter extends com.poesys.db.dto.AbstractObjectSetter<com.poesys.db.memcached_test.ISelf4> {
    private static final long serialVersionUID = 1L;
    ...
    @Override
    protected void set(com.poesys.db.memcached_test.ISelf4 dto) {
   ...
   * @author Poesys/DB Cartridge
   */
  private class QueryChild4Setter extends com.poesys.db.dto.AbstractObjectSetter<com.poesys.db.memcached_test.ISelf4> {
    private static final long serialVersionUID = 1L;
   ...
   */
  public AbstractSelf4Self(IPrimaryKey key, com.poesys.db.memcached_test.ISelf4 children4Object, com.poesys.db.memcached_test.ISelf4 parents4Object, java.lang.Long parents4Key1, java.lang.Long children4Key1, java.lang.Long parents4Key2, java.lang.Long children4Key2) {
    this.key = key;
   ...
   */
  private com.poesys.db.memcached_test.ISelf4 parent4;
   ...
   * Property is lazy: false
   */
  private com.poesys.db.memcached_test.ISelf4 child4;
