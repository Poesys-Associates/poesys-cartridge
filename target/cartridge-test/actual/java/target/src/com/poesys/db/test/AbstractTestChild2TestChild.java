...
public abstract class AbstractTestChild2TestChild extends AbstractDto implements ITestChild2TestChild {
   ...
   * @author Poesys/DB Cartridge
   */
  private class QueryUpSetter extends com.poesys.db.dto.AbstractObjectSetter<com.poesys.db.test.ITestChild> {
    private static final long serialVersionUID = 1L;
   ...
   * @author Poesys/DB Cartridge
   */
  private class QueryDownSetter extends com.poesys.db.dto.AbstractObjectSetter<com.poesys.db.test.ITestChild> {
    private static final long serialVersionUID = 1L;
   ...
   *
   * @see com.poesys.db.test.sql.QueryTc1ByTestChild2TestChild
   */
  private class QueryTc1Setter 
      extends com.poesys.db.dto.AbstractListSetter<com.poesys.db.test.ITestChild2TestChild, ITestChild2TestChild, java.util.Collection<com.poesys.db.test.ITestChild2TestChild>> {
    private static final long serialVersionUID = 1L;
    ...
    @Override
    protected com.poesys.db.dao.query.IParameterizedQuerySql<com.poesys.db.test.ITestChild2TestChild, ITestChild2TestChild> getSql() {
      return new com.poesys.db.test.sql.QueryTc1ByTestChild2TestChild();
    }
   ...
   * Source: TransformToProperty + AddToManyAssociationCollectionProperties
   *
   * @see com.poesys.db.test.sql.QueryTc2ByTestChild2TestChild
   */
  private class QueryTc2Setter 
    ...
    @Override
    protected com.poesys.db.dao.query.IParameterizedQuerySql<com.poesys.db.test.ITestChild2TestChild, ITestChild2TestChild> getSql() {
      return new com.poesys.db.test.sql.QueryTc2ByTestChild2TestChild();
    }
   ...
   *
   * @see com.poesys.db.test.sql.QueryTc1TC2TC2TC2TCLinksByTestChild2TestChild
   */
  private class QueryTc1TC2TC2TC2TCLinksSetter 
      extends com.poesys.db.dto.AbstractListSetter<com.poesys.db.test.ITC2TC2TC2TC, ITestChild2TestChild, java.util.Collection<com.poesys.db.test.ITC2TC2TC2TC>> {
    private static final long serialVersionUID = 1L;
    private static final int FETCH_SIZE = 10;
    ...
    @Override
    protected com.poesys.db.dao.query.IParameterizedQuerySql<com.poesys.db.test.ITC2TC2TC2TC, ITestChild2TestChild> getSql() {
      return new com.poesys.db.test.sql.QueryTc1TC2TC2TC2TCLinksByTestChild2TestChild();
    }

    @Override
    protected void set(java.util.Collection<com.poesys.db.test.ITC2TC2TC2TC> list) {
      // No status change; this is just filling in the object data.
   ...
   *
   * @see com.poesys.db.test.sql.InsertTC2TC2TC2TC
   */
   ...
   * Source: AddAssociationClassCollectionProperties
   *
   * @see com.poesys.db.test.sql.QueryTc2TC2TC2TC2TCLinksByTestChild2TestChild
   */
  private class QueryTc2TC2TC2TC2TCLinksSetter 
    ...
    @Override
    protected com.poesys.db.dao.query.IParameterizedQuerySql<com.poesys.db.test.ITC2TC2TC2TC, ITestChild2TestChild> getSql() {
      return new com.poesys.db.test.sql.QueryTc2TC2TC2TC2TCLinksByTestChild2TestChild();
    }
   ...
   */
  public AbstractTestChild2TestChild(IPrimaryKey key, com.poesys.db.test.ITestChild downObject, com.poesys.db.test.ITestChild upObject, java.math.BigInteger downChildNo, java.math.BigInteger upChildNo, java.math.BigInteger downTestParentId, java.math.BigInteger upTestParentId) {
    this.key = key;
  ...
  transient java.util.Collection<com.poesys.db.test.ITestChild2TestChild> tc1;
   ...
   */
  // Doesn't serialize; package access allows proxy to set on readObject()
  transient java.util.Collection<com.poesys.db.test.ITestChild2TestChild> tc2;
   ...
   */
  // Doesn't serialize; package access allows proxy to set on readObject()
  transient java.util.Collection<com.poesys.db.test.ITC2TC2TC2TC> tc1TC2TC2TC2TCLinks;
   ...
   */
  // Doesn't serialize; package access allows proxy to set on readObject()
  transient java.util.Collection<com.poesys.db.test.ITC2TC2TC2TC> tc2TC2TC2TC2TCLinks;
   ...
   * Property is lazy: false
   */
  private com.poesys.db.test.ITestChild up;
   ...
   * Property is lazy: false
   */
  private com.poesys.db.test.ITestChild down;
  ...
  public void update(com.poesys.db.dto.ISubject subject,
    ...
    if (subject != null && subject instanceof com.poesys.db.test.ITC2TC2TC2TC && 
    ...
    if (event == com.poesys.db.dao.DataEvent.MARKED_DELETED &&
      ...
      outer: for (com.poesys.db.test.ITestChild2TestChild value : tc1) {
    ...
    if (event == com.poesys.db.dao.DataEvent.MARKED_DELETED &&
      ...
      outer: for (com.poesys.db.test.ITestChild2TestChild value : tc2) {
        com.poesys.db.pk.AssociationPrimaryKey keys = 
          (com.poesys.db.pk.AssociationPrimaryKey) value.getPrimaryKey();
        for (com.poesys.db.pk.IPrimaryKey key : keys.getKeyListCopy()) {
          if (key.equals(subject.getPrimaryKey())) {
    ...
    if (event == com.poesys.db.dao.DataEvent.MARKED_DELETED &&
      ...
      outer: for (com.poesys.db.test.ITC2TC2TC2TC value : tc1TC2TC2TC2TCLinks) {
        com.poesys.db.pk.AssociationPrimaryKey keys = 
          (com.poesys.db.pk.AssociationPrimaryKey) value.getPrimaryKey();
        for (com.poesys.db.pk.IPrimaryKey key : keys.getKeyListCopy()) {
          if (key.equals(subject.getPrimaryKey())) {
    ...
    if (event == com.poesys.db.dao.DataEvent.MARKED_DELETED &&
      ...
      outer: for (com.poesys.db.test.ITC2TC2TC2TC value : tc2TC2TC2TC2TCLinks) {
        com.poesys.db.pk.AssociationPrimaryKey keys = 
          (com.poesys.db.pk.AssociationPrimaryKey) value.getPrimaryKey();
        for (com.poesys.db.pk.IPrimaryKey key : keys.getKeyListCopy()) {
          if (key.equals(subject.getPrimaryKey())) {
  ...
  private void createInserters() {
    ...
    final com.poesys.db.dao.IDaoFactory<com.poesys.db.test.ITestChild2TestChild> testChild2TestChildFactory =
      manager.getFactory("com.poesys.db.test.TestChild2TestChild",
                         getSubsystem(),
                         2147483647);
    com.poesys.db.dao.insert.IInsertSql<ITestChild2TestChild> sql =
      new com.poesys.db.test.sql.InsertTestChild2TestChild();
