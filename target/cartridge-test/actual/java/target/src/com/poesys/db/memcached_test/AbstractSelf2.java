...
public abstract class AbstractSelf2 extends AbstractDto implements ISelf2 {
   ...
   *
   * @see com.poesys.db.memcached_test.sql.QueryParents2BySelf2
   */
  private class QueryParents2Setter 
      extends com.poesys.db.dto.AbstractListSetter<com.poesys.db.memcached_test.ISelf2, ISelf2, java.util.Collection<com.poesys.db.memcached_test.ISelf2>> {
    private static final long serialVersionUID = 1L;
    ...
    @Override
    protected com.poesys.db.dao.query.IParameterizedQuerySql<com.poesys.db.memcached_test.ISelf2, ISelf2> getSql() {
      return new com.poesys.db.memcached_test.sql.QueryParents2BySelf2();
    }

    @Override
    protected void set(java.util.Collection<com.poesys.db.memcached_test.ISelf2> list) {
   ...
   *
   * @see com.poesys.db.memcached_test.sql.InsertSelf2
   */
   ...
   * Source: TransformToProperty + AddToManyAssociationCollectionProperties
   *
   * @see com.poesys.db.memcached_test.sql.QueryChildren2BySelf2
   */
  private class QueryChildren2Setter 
    ...
    @Override
    protected com.poesys.db.dao.query.IParameterizedQuerySql<com.poesys.db.memcached_test.ISelf2, ISelf2> getSql() {
      return new com.poesys.db.memcached_test.sql.QueryChildren2BySelf2();
    }
   ...
   *
   * @see com.poesys.db.memcached_test.sql.QueryParents2Self2SelfLinksBySelf2
   */
  private class QueryParents2Self2SelfLinksSetter 
      extends com.poesys.db.dto.AbstractListSetter<com.poesys.db.memcached_test.ISelf2Self, ISelf2, java.util.Collection<com.poesys.db.memcached_test.ISelf2Self>> {
    private static final long serialVersionUID = 1L;
    private static final int FETCH_SIZE = 10;
    ...
    @Override
    protected com.poesys.db.dao.query.IParameterizedQuerySql<com.poesys.db.memcached_test.ISelf2Self, ISelf2> getSql() {
      return new com.poesys.db.memcached_test.sql.QueryParents2Self2SelfLinksBySelf2();
    }

    @Override
    protected void set(java.util.Collection<com.poesys.db.memcached_test.ISelf2Self> list) {
      // No status change; this is just filling in the object data.
   ...
   *
   * @see com.poesys.db.memcached_test.sql.InsertSelf2Self
   */
   ...
   * Source: AddAssociationClassCollectionProperties
   *
   * @see com.poesys.db.memcached_test.sql.QueryChildren2Self2SelfLinksBySelf2
   */
  private class QueryChildren2Self2SelfLinksSetter 
    ...
    @Override
    protected com.poesys.db.dao.query.IParameterizedQuerySql<com.poesys.db.memcached_test.ISelf2Self, ISelf2> getSql() {
      return new com.poesys.db.memcached_test.sql.QueryChildren2Self2SelfLinksBySelf2();
    }
  ...
  transient java.util.Collection<com.poesys.db.memcached_test.ISelf2> parents2;
   ...
   */
  // Doesn't serialize; package access allows proxy to set on readObject()
  transient java.util.Collection<com.poesys.db.memcached_test.ISelf2> children2;
   ...
   */
  // Doesn't serialize; package access allows proxy to set on readObject()
  transient java.util.Collection<com.poesys.db.memcached_test.ISelf2Self> parents2Self2SelfLinks;
   ...
   */
  // Doesn't serialize; package access allows proxy to set on readObject()
  transient java.util.Collection<com.poesys.db.memcached_test.ISelf2Self> children2Self2SelfLinks;
  ...
  public void update(com.poesys.db.dto.ISubject subject,
    ...
    if (subject != null && subject instanceof com.poesys.db.memcached_test.ISelf2Self && 
    ...
    if (event == com.poesys.db.dao.DataEvent.MARKED_DELETED &&
      ...
      outer: for (com.poesys.db.memcached_test.ISelf2Self value : parents2Self2SelfLinks) {
    ...
    if (event == com.poesys.db.dao.DataEvent.MARKED_DELETED &&
      ...
      outer: for (com.poesys.db.memcached_test.ISelf2Self value : children2Self2SelfLinks) {
        com.poesys.db.pk.AssociationPrimaryKey keys = 
          (com.poesys.db.pk.AssociationPrimaryKey) value.getPrimaryKey();
        for (com.poesys.db.pk.IPrimaryKey key : keys.getKeyListCopy()) {
          if (key.equals(subject.getPrimaryKey())) {
  ...
  private void createInserters() {
    ...
    final com.poesys.db.dao.IDaoFactory<com.poesys.db.memcached_test.ISelf2> self2Factory =
      manager.getFactory("com.poesys.db.memcached_test.Self2",
                         getSubsystem(),
                         2147483647);
    com.poesys.db.dao.insert.IInsertSql<ISelf2> sql =
      new com.poesys.db.memcached_test.sql.InsertSelf2();
