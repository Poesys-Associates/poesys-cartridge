...
public abstract class AbstractSelf2Self extends AbstractDto implements ISelf2Self {
   ...
   * @author Poesys/DB Cartridge
   */
  private class QueryChildren2Setter extends com.poesys.db.dto.AbstractObjectSetter<com.poesys.db.memcached_test.ISelf2> {
    private static final long serialVersionUID = 1L;
    ...
    @Override
    protected void set(com.poesys.db.memcached_test.ISelf2 dto) {
   ...
   * @author Poesys/DB Cartridge
   */
  private class QueryParents2Setter extends com.poesys.db.dto.AbstractObjectSetter<com.poesys.db.memcached_test.ISelf2> {
    private static final long serialVersionUID = 1L;
   ...
   */
  public AbstractSelf2Self(IPrimaryKey key, com.poesys.db.memcached_test.ISelf2 children2Object, com.poesys.db.memcached_test.ISelf2 parents2Object, java.math.BigInteger children2Self2Id, java.math.BigInteger parents2Self2Id) {
    this.key = key;
   ...
   */
  private com.poesys.db.memcached_test.ISelf2 children2;
  
  /**
   * Get an object of com.poesys.db.memcached_test.ISelf2.
   *
   * Source: AddAssociationKeyObjectProperties
   * 
   * @return a com.poesys.db.memcached_test.ISelf2
   */
   ...
   * Property is lazy: false
   */
  private com.poesys.db.memcached_test.ISelf2 parents2;
  ...
  private void createInserters() {
    ...
    final com.poesys.db.dao.IDaoFactory<com.poesys.db.memcached_test.ISelf2Self> self2SelfFactory =
      manager.getFactory("com.poesys.db.memcached_test.Self2Self",
                         getSubsystem(),
                         2147483647);
    com.poesys.db.dao.insert.IInsertSql<ISelf2Self> sql =
      new com.poesys.db.memcached_test.sql.InsertSelf2Self();
