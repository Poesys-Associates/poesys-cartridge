...
public abstract class AbstractTestA extends AbstractDto implements ITestA {
   ...
   *
   * @see com.poesys.db.memcached_test.sql.QueryBsByTestA
   */
  private class QueryBsSetter 
      extends com.poesys.db.dto.AbstractListSetter<com.poesys.db.memcached_test.ITestB, ITestA, java.util.List<com.poesys.db.memcached_test.ITestB>> {
    private static final long serialVersionUID = 1L;
    ...
    @Override
    protected com.poesys.db.dao.query.IParameterizedQuerySql<com.poesys.db.memcached_test.ITestB, ITestA> getSql() {
      return new com.poesys.db.memcached_test.sql.QueryBsByTestA();
    }

    @Override
    protected void set(java.util.List<com.poesys.db.memcached_test.ITestB> list) {
   ...
   * Source: TransformToProperty + AddToManyAssociationCollectionProperties
   *
   * @see com.poesys.db.memcached_test.sql.QueryTestB
   */
  private class ReadBsSetter 
      extends com.poesys.db.dto.AbstractListReadSetter<com.poesys.db.memcached_test.ITestB> {
    private static final long serialVersionUID = 1L;
    ...
    @Override
    protected java.util.List<com.poesys.db.memcached_test.ITestB> getObjectList() {
      return bs;
    }
    ...
    @Override
    protected com.poesys.db.dao.query.IKeyQuerySql<com.poesys.db.memcached_test.ITestB> getSql() {
   ...
   *
   * @see com.poesys.db.memcached_test.sql.InsertTestB
   */
  ...
  transient java.util.List<com.poesys.db.memcached_test.ITestB> bs;
  // Ordered list of keys of the objects in the bs list
  java.util.List<com.poesys.db.pk.IPrimaryKey> bsKeys = 
    new java.util.ArrayList<com.poesys.db.pk.IPrimaryKey>();
  
  /**
   * Get a list of com.poesys.db.memcached_test.ITestB.
   *
   * Source: TransformToProperty + AddToManyAssociationCollectionProperties
   * 
   * @return a java.util.List<com.poesys.db.memcached_test.ITestB>
   */
  ...
  private void createInserters() {
    ...
    final com.poesys.db.dao.IDaoFactory<com.poesys.db.memcached_test.ITestA> testAFactory =
      manager.getFactory("com.poesys.db.memcached_test.TestA",
                         getSubsystem(),
                         2147483647);
    com.poesys.db.dao.insert.IInsertSql<ITestA> sql =
      new com.poesys.db.memcached_test.sql.InsertTestA();
