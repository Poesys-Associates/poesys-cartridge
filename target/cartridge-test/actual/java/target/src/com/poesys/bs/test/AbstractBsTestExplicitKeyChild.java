...
import com.poesys.db.test.ITestExplicitKeyChild;
import com.poesys.db.test.TestExplicitKeyChildProxy;
import com.poesys.db.test.TestExplicitKeyChild;
...
public abstract class AbstractBsTestExplicitKeyChild 
    extends AbstractDto<com.poesys.db.test.ITestExplicitKeyChild> {
   ...
   * </ul>
   * </p>
   * @return a com.poesys.bs.test.BsTestParent explicitParent
   */
  public com.poesys.bs.test.BsTestParent getExplicitParent() {
    // Return 4
    return new com.poesys.bs.test.BsTestParent(dto.getExplicitParent());
  }
}