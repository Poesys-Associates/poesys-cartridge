...
public abstract class AbstractQueryChildrenByTestNaturalParent 
    implements IParameterizedQuerySql<com.poesys.db.test.ITestNaturalChild, com.poesys.db.test.ITestNaturalParent> {
  ...
  public com.poesys.db.test.ITestNaturalChild getData(ResultSet rs) throws SQLException,
    ...
    return com.poesys.db.test.TestFactory.getTestNaturalChildData(getPrimaryKey(rs), rs);
  }

  public IPrimaryKey getPrimaryKey(ResultSet rs) throws SQLException,
      InvalidParametersException {
    return com.poesys.db.test.TestFactory.getTestNaturalChildPrimaryKey(rs, "");
  }
