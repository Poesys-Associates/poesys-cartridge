...
public abstract class AbstractTestB extends AbstractDto implements ITestB {
   ...
   * @author Poesys/DB Cartridge
   */
  private class QueryASetter extends com.poesys.db.dto.AbstractObjectSetter<com.poesys.db.memcached_test.ITestA> {
    private static final long serialVersionUID = 1L;
    ...
    @Override
    protected com.poesys.db.dao.query.IKeyQuerySql<com.poesys.db.memcached_test.ITestA> getSql() {
      return new com.poesys.db.memcached_test.sql.QueryTestA();
    }

    @Override
    protected void set(com.poesys.db.memcached_test.ITestA dto) {
  ...
  private class UpdateASetter 
      extends com.poesys.db.dto.AbstractProcessNestedObject<com.poesys.db.memcached_test.ITestA> {
    private static final long serialVersionUID = 1L;
    ...
    @Override
    protected void doChanged(java.sql.Connection connection, com.poesys.db.memcached_test.ITestA dto)
    ...
    @Override
    protected void doDeleted(java.sql.Connection connection, com.poesys.db.memcached_test.ITestA dto)
        throws java.sql.SQLException, com.poesys.db.BatchException, com.poesys.db.ConstraintViolationException,
        com.poesys.db.dto.DtoStatusException {
      com.poesys.db.dao.IDaoManager manager = 
        com.poesys.db.dao.DaoManagerFactory.getManager(subsystem);
      com.poesys.db.dao.IDaoFactory<com.poesys.db.memcached_test.ITestA> factory = 
        manager.getFactory(com.poesys.db.memcached_test.TestA.class.getName(), subsystem, 2147483647);
      com.poesys.db.dao.delete.IDelete<com.poesys.db.memcached_test.ITestA> dao = 
        factory.getDelete(new com.poesys.db.memcached_test.sql.DeleteTestA());
      dao.delete(connection, dto);
    }

    @Override
    protected void doNew(java.sql.Connection connection, com.poesys.db.memcached_test.ITestA dto)
        throws java.sql.SQLException, com.poesys.db.BatchException, com.poesys.db.ConstraintViolationException,
        com.poesys.db.dto.DtoStatusException {
      com.poesys.db.dao.IDaoManager manager = 
        com.poesys.db.dao.DaoManagerFactory.getManager(subsystem);
      com.poesys.db.dao.IDaoFactory<com.poesys.db.memcached_test.ITestA> factory = 
        manager.getFactory(com.poesys.db.memcached_test.TestA.class.getName(), subsystem, 2147483647);
      com.poesys.db.dao.insert.IInsert<com.poesys.db.memcached_test.ITestA> inserter =
        factory.getInsert(new com.poesys.db.memcached_test.sql.InsertTestA(), createKey());
    ...
    @Override
    protected com.poesys.db.memcached_test.ITestA getDto() {
      return a;
    }
   ...
   * Property is lazy: false
   */
  private com.poesys.db.memcached_test.ITestA a;
  ...
  private void createInserters() {
    ...
    final com.poesys.db.dao.IDaoFactory<com.poesys.db.memcached_test.ITestB> testBFactory =
      manager.getFactory("com.poesys.db.memcached_test.TestB",
                         getSubsystem(),
                         2147483647);
    com.poesys.db.dao.insert.IInsertSql<ITestB> sql =
      new com.poesys.db.memcached_test.sql.InsertTestB();
