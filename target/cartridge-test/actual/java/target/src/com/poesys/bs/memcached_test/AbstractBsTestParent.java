...
import com.poesys.db.memcached_test.ITestParent;
import com.poesys.db.memcached_test.TestParentProxy;
import com.poesys.db.memcached_test.TestParent;
...
public abstract class AbstractBsTestParent 
    extends AbstractDto<com.poesys.db.memcached_test.ITestParent> {
  ...
  private class BsChildrenListBuilder 
      extends com.poesys.bs.dto.ListBuilder<com.poesys.db.memcached_test.ITestChild, com.poesys.bs.memcached_test.BsTestChild> {
    @Override
   ...
   * com.poesys.db.memcached_test.ITestExplicitKeyChild objects
   */
  private class BsExplicitChildrenCollectionBuilder 
      extends com.poesys.bs.dto.CollectionBuilder<com.poesys.db.memcached_test.ITestExplicitKeyChild, com.poesys.bs.memcached_test.BsTestExplicitKeyChild> {
    @Override
    public com.poesys.bs.memcached_test.BsTestExplicitKeyChild get(com.poesys.db.memcached_test.ITestExplicitKeyChild dto) {
   ...
   * </ul>
   * </p>
   * @return a com.poesys.bs.memcached_test.BsTestChild parentOccupation
   */
  public java.util.List<com.poesys.bs.memcached_test.BsTestChild> getChildren() {
   ...
   * </ul>
   * </p>
   * @return a com.poesys.bs.memcached_test.BsTestExplicitKeyChild parentOccupation
   */
  public java.util.Collection<com.poesys.bs.memcached_test.BsTestExplicitKeyChild> getExplicitChildren() {
