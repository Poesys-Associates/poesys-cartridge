...
public abstract class AbstractTestParent extends AbstractDto implements ITestParent {
   ...
   *
   * @see com.poesys.db.test.sql.QueryChildrenByTestParent
   */
  private class QueryChildrenSetter 
      extends com.poesys.db.dto.AbstractListSetter<com.poesys.db.test.ITestChild, ITestParent, java.util.List<com.poesys.db.test.ITestChild>> {
    private static final long serialVersionUID = 1L;
    ...
    @Override
    protected com.poesys.db.dao.query.IParameterizedQuerySql<com.poesys.db.test.ITestChild, ITestParent> getSql() {
      return new com.poesys.db.test.sql.QueryChildrenByTestParent();
    }
  ...
  /**
   * Add com.poesys.db.test.ITestChild object to children collection.
   * 
   * @param object the com.poesys.db.test.ITestChild object
   */
  public void addChildrenTestChild(com.poesys.db.test.ITestChild object) {
    if (children == null) {
      // Association not yet created, create it.
      children = new java.util.concurrent.CopyOnWriteArrayList<com.poesys.db.test.ITestChild>();
    }
    children.add(object);
   ...
   * Source: AddToManyChildCollectionProperties
   *
   * @see com.poesys.db.test.sql.QueryExplicitChildrenByTestParent
   */
  private class QueryExplicitChildrenSetter 
      extends com.poesys.db.dto.AbstractListSetter<com.poesys.db.test.ITestExplicitKeyChild, ITestParent, java.util.Collection<com.poesys.db.test.ITestExplicitKeyChild>> {
    private static final long serialVersionUID = 1L;
    private static final int FETCH_SIZE = 10;
    ...
    @Override
    protected com.poesys.db.dao.query.IParameterizedQuerySql<com.poesys.db.test.ITestExplicitKeyChild, ITestParent> getSql() {
      return new com.poesys.db.test.sql.QueryExplicitChildrenByTestParent();
    }

    @Override
    protected void set(java.util.Collection<com.poesys.db.test.ITestExplicitKeyChild> list) {
      // No status change; this is just filling in the object data.
   ...
   *
   * @see com.poesys.db.test.sql.InsertTestExplicitKeyChild
   */
  ...
  /**
   * Add com.poesys.db.test.ITestExplicitKeyChild object to explicitChildren collection.
   * 
   * @param object the com.poesys.db.test.ITestExplicitKeyChild object
   */
  public void addExplicitChildrenTestExplicitKeyChild(com.poesys.db.test.ITestExplicitKeyChild object) {
    if (explicitChildren == null) {
      // Association not yet created, create it.
      explicitChildren = new java.util.concurrent.CopyOnWriteArrayList<com.poesys.db.test.ITestExplicitKeyChild>();
    }
  ...
  transient java.util.List<com.poesys.db.test.ITestChild> children;
   ...
   */
  // Doesn't serialize; package access allows proxy to set on readObject()
  transient java.util.Collection<com.poesys.db.test.ITestExplicitKeyChild> explicitChildren;
  ...
  public void update(com.poesys.db.dto.ISubject subject,
    ...
    // Clean up children.
    if (subject != null && subject instanceof com.poesys.db.test.ITestChild && 
    ...
    if (subject != null && subject instanceof com.poesys.db.test.ITestExplicitKeyChild && 
        event == com.poesys.db.dao.DataEvent.DELETE &&
  ...
  private void createInserters() {
    ...
    final com.poesys.db.dao.IDaoFactory<com.poesys.db.test.ITestParent> testParentFactory =
      manager.getFactory("com.poesys.db.test.TestParent",
                         getSubsystem(),
                         2147483647);
    com.poesys.db.dao.insert.IInsertSql<ITestParent> sql =
      new com.poesys.db.test.sql.InsertTestParent();
