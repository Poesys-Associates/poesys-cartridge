...
public abstract class AbstractTC2TC2TC2TC extends AbstractDto implements ITC2TC2TC2TC {
   ...
   * @author Poesys/DB Cartridge
   */
  private class QueryTc1Setter extends com.poesys.db.dto.AbstractObjectSetter<com.poesys.db.test.ITestChild2TestChild> {
    private static final long serialVersionUID = 1L;
    ...
    @Override
    protected void set(com.poesys.db.test.ITestChild2TestChild dto) {
   ...
   * @author Poesys/DB Cartridge
   */
  private class QueryTc2Setter extends com.poesys.db.dto.AbstractObjectSetter<com.poesys.db.test.ITestChild2TestChild> {
    private static final long serialVersionUID = 1L;
   ...
   */
  private com.poesys.db.test.ITestChild2TestChild tc1;
   ...
   * Property is lazy: false
   */
  private com.poesys.db.test.ITestChild2TestChild tc2;
  ...
  private void createInserters() {
    ...
    final com.poesys.db.dao.IDaoFactory<com.poesys.db.test.ITC2TC2TC2TC> tC2TC2TC2TCFactory =
      manager.getFactory("com.poesys.db.test.TC2TC2TC2TC",
                         getSubsystem(),
                         2147483647);
    com.poesys.db.dao.insert.IInsertSql<ITC2TC2TC2TC> sql =
      new com.poesys.db.test.sql.InsertTC2TC2TC2TC();
