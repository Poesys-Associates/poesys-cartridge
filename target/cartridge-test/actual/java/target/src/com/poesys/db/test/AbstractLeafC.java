 ...
 */
public abstract class AbstractLeafC extends com.poesys.db.test.ConcreteMiddle implements ILeafC {
  ...
  private void createInserters() {
    ...
    final com.poesys.db.dao.IDaoFactory<com.poesys.db.test.ILeafC> leafCFactory =
      manager.getFactory("com.poesys.db.test.LeafC",
                         getSubsystem(),
                         2147483647);
    com.poesys.db.dao.insert.IInsertSql<ILeafC> sql =
      new com.poesys.db.test.sql.InsertLeafC();
