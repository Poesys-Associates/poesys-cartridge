...
public abstract class AbstractSelf4 extends AbstractDto implements ISelf4 {
   ...
   *
   * @see com.poesys.db.memcached_test.sql.QueryParents4BySelf4
   */
  private class QueryParents4Setter 
      extends com.poesys.db.dto.AbstractListSetter<com.poesys.db.memcached_test.ISelf4, ISelf4, java.util.Collection<com.poesys.db.memcached_test.ISelf4>> {
    private static final long serialVersionUID = 1L;
    ...
    @Override
    protected com.poesys.db.dao.query.IParameterizedQuerySql<com.poesys.db.memcached_test.ISelf4, ISelf4> getSql() {
      return new com.poesys.db.memcached_test.sql.QueryParents4BySelf4();
    }

    @Override
    protected void set(java.util.Collection<com.poesys.db.memcached_test.ISelf4> list) {
   ...
   *
   * @see com.poesys.db.memcached_test.sql.InsertSelf4
   */
   ...
   * Source: TransformToProperty + AddToManyAssociationCollectionProperties
   *
   * @see com.poesys.db.memcached_test.sql.QueryChildren4BySelf4
   */
  private class QueryChildren4Setter 
    ...
    @Override
    protected com.poesys.db.dao.query.IParameterizedQuerySql<com.poesys.db.memcached_test.ISelf4, ISelf4> getSql() {
      return new com.poesys.db.memcached_test.sql.QueryChildren4BySelf4();
    }
   ...
   *
   * @see com.poesys.db.memcached_test.sql.QueryParents4Self4SelfLinksBySelf4
   */
  private class QueryParents4Self4SelfLinksSetter 
      extends com.poesys.db.dto.AbstractListSetter<com.poesys.db.memcached_test.ISelf4Self, ISelf4, java.util.Collection<com.poesys.db.memcached_test.ISelf4Self>> {
    private static final long serialVersionUID = 1L;
    private static final int FETCH_SIZE = 10;
    ...
    @Override
    protected com.poesys.db.dao.query.IParameterizedQuerySql<com.poesys.db.memcached_test.ISelf4Self, ISelf4> getSql() {
      return new com.poesys.db.memcached_test.sql.QueryParents4Self4SelfLinksBySelf4();
    }

    @Override
    protected void set(java.util.Collection<com.poesys.db.memcached_test.ISelf4Self> list) {
      // No status change; this is just filling in the object data.
   ...
   *
   * @see com.poesys.db.memcached_test.sql.InsertSelf4Self
   */
   ...
   * Source: AddAssociationClassCollectionProperties
   *
   * @see com.poesys.db.memcached_test.sql.QueryChildren4Self4SelfLinksBySelf4
   */
  private class QueryChildren4Self4SelfLinksSetter 
    ...
    @Override
    protected com.poesys.db.dao.query.IParameterizedQuerySql<com.poesys.db.memcached_test.ISelf4Self, ISelf4> getSql() {
      return new com.poesys.db.memcached_test.sql.QueryChildren4Self4SelfLinksBySelf4();
    }
  ...
  transient java.util.Collection<com.poesys.db.memcached_test.ISelf4> parents4;
   ...
   */
  // Doesn't serialize; package access allows proxy to set on readObject()
  transient java.util.Collection<com.poesys.db.memcached_test.ISelf4> children4;
   ...
   */
  // Doesn't serialize; package access allows proxy to set on readObject()
  transient java.util.Collection<com.poesys.db.memcached_test.ISelf4Self> parents4Self4SelfLinks;
   ...
   */
  // Doesn't serialize; package access allows proxy to set on readObject()
  transient java.util.Collection<com.poesys.db.memcached_test.ISelf4Self> children4Self4SelfLinks;
  ...
  public void update(com.poesys.db.dto.ISubject subject,
    ...
    if (subject != null && subject instanceof com.poesys.db.memcached_test.ISelf4Self && 
    ...
    if (event == com.poesys.db.dao.DataEvent.MARKED_DELETED &&
      ...
      outer: for (com.poesys.db.memcached_test.ISelf4Self value : parents4Self4SelfLinks) {
    ...
    if (event == com.poesys.db.dao.DataEvent.MARKED_DELETED &&
      ...
      outer: for (com.poesys.db.memcached_test.ISelf4Self value : children4Self4SelfLinks) {
        com.poesys.db.pk.AssociationPrimaryKey keys = 
          (com.poesys.db.pk.AssociationPrimaryKey) value.getPrimaryKey();
        for (com.poesys.db.pk.IPrimaryKey key : keys.getKeyListCopy()) {
          if (key.equals(subject.getPrimaryKey())) {
  ...
  private void createInserters() {
    ...
    final com.poesys.db.dao.IDaoFactory<com.poesys.db.memcached_test.ISelf4> self4Factory =
      manager.getFactory("com.poesys.db.memcached_test.Self4",
                         getSubsystem(),
                         2147483647);
    com.poesys.db.dao.insert.IInsertSql<ISelf4> sql =
      new com.poesys.db.memcached_test.sql.InsertSelf4();
