...
public abstract class AbstractLeafCDelegateTest {
  ...
  @Before
  public void setUp() {
    delegate = Memcached_testDelegateFactory.getLeafCDelegate();
  ...
  protected void clearCaches() {
    ...
    if (manager != null) {
      manager.clearCache(com.poesys.db.memcached_test.LeafC.class.getName());
    }
  }
   ...
   * @throws DelegateException when a problem occurs during object creation
   */
  protected List<com.poesys.bs.memcached_test.BsLeafC> createMemcached_testLeafC(int count) 
      throws DelegateException, InvalidParametersException {
    List<com.poesys.bs.memcached_test.BsLeafC> objects = 
      new CopyOnWriteArrayList<com.poesys.bs.memcached_test.BsLeafC>();
  ...
  public void testInsert() {
    ...
    List<BsLeafC> objects = createMemcached_testLeafC(1);
  ...
  public void testGetAllObjects() 
    ...
    // Create a new LeafC object to perform the test.
    List<BsLeafC> insertedObjects = createMemcached_testLeafC(1);
  ...
  public void testUpdateBatch() throws InvalidParametersException,
      DelegateException {
    List<BsLeafC> objects = createMemcached_testLeafC(2);
    delegate.insert(objects);
  ...
  public void testProcess() throws InvalidParametersException,
    ...
    List<BsLeafC> allObjects = createMemcached_testLeafC(3);
