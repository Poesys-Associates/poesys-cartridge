...
public abstract class AbstractTestParentDelegateTest {
  ...
  @Before
  public void setUp() {
    delegate = TestDelegateFactory.getTestParentDelegate();
  ...
  protected void clearCaches() {
    ...
    if (manager != null) {
      manager.clearCache(com.poesys.db.test.TestParent.class.getName());
    }

    // Clear nested object caches
    
    // Child TestChildChild cache
    IDaoManager TestChildChildManager = DaoManagerFactory.getManager("com.poesys.db.test");
    if (TestChildChildManager != null) {
      TestChildChildManager.clearCache(com.poesys.db.test.TestChildChild.class.getName());
    }
    
    // Child TC2TC2TC2TC cache
    IDaoManager TC2TC2TC2TCManager = DaoManagerFactory.getManager("com.poesys.db.test");
    if (TC2TC2TC2TCManager != null) {
      TC2TC2TC2TCManager.clearCache(com.poesys.db.test.TC2TC2TC2TC.class.getName());
    }
    
    // Child TestChild2TestChild cache
    IDaoManager TestChild2TestChildManager = DaoManagerFactory.getManager("com.poesys.db.test");
    if (TestChild2TestChildManager != null) {
      TestChild2TestChildManager.clearCache(com.poesys.db.test.TestChild2TestChild.class.getName());
    }
    
    // Child TestChild cache
    IDaoManager TestChildManager = DaoManagerFactory.getManager("com.poesys.db.test");
    if (TestChildManager != null) {
      TestChildManager.clearCache(com.poesys.db.test.TestChild.class.getName());
    }
    
    // Child TestExplicitKeyChild cache
    IDaoManager TestExplicitKeyChildManager = DaoManagerFactory.getManager("com.poesys.db.test");
    if (TestExplicitKeyChildManager != null) {
      TestExplicitKeyChildManager.clearCache(com.poesys.db.test.TestExplicitKeyChild.class.getName());
    }
  }
   ...
   * @throws DelegateException when a problem occurs during object creation
   */
  protected List<com.poesys.bs.test.BsTestParent> createTestTestParent(int count) 
      throws DelegateException, InvalidParametersException {
    List<com.poesys.bs.test.BsTestParent> objects = 
      new CopyOnWriteArrayList<com.poesys.bs.test.BsTestParent>();
   ...
   */
  abstract protected List<com.poesys.bs.test.BsTestChildChild> createTestTestChildChild(com.poesys.db.test.ITestParent parent, 
                                                       int count) 
   ...
   *                                    input parameters for creating an object
   */
  abstract protected List<com.poesys.bs.test.BsTC2TC2TC2TC> createTestTC2TC2TC2TC(List<com.poesys.db.test.ITestChild2TestChild> tc1List, List<com.poesys.db.test.ITestChild2TestChild> tc2List, int count) 
   ...
   *                                    input parameters for creating an object
   */
  abstract protected List<com.poesys.bs.test.BsTestChild2TestChild> createTestTestChild2TestChild(List<com.poesys.db.test.ITestChild> downList, List<com.poesys.db.test.ITestChild> upList, int count) 
      throws DelegateException, InvalidParametersException; // create 1
   ...
   *                                    input parameters for creating an object
   */
  abstract protected List<com.poesys.bs.test.BsTestChild> createTestTestChild(com.poesys.db.test.ITestParent parent, 
                                                       int count) 
      throws DelegateException, InvalidParametersException; // create 2
   ...
   *                                    input parameters for creating an object
   */
  abstract protected List<com.poesys.bs.test.BsTestExplicitKeyChild> createTestTestExplicitKeyChild(com.poesys.db.test.ITestParent parent, 
                                                       int count) 
      throws DelegateException, InvalidParametersException; // create 2
  ...
  public void testInsert() {
    ...
    List<BsTestParent> objects = createTestTestParent(1);
  ...
  public void testGetAllObjects() 
    ...
    // Create a new TestParent object to perform the test.
    List<BsTestParent> insertedObjects = createTestTestParent(1);
  ...
  public void testUpdateBatch() throws InvalidParametersException,
      DelegateException {
    List<BsTestParent> objects = createTestTestParent(2);
    delegate.insert(objects);
  ...
  public void testProcess() throws InvalidParametersException,
    ...
    List<BsTestParent> allObjects = createTestTestParent(3);
