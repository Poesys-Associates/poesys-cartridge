...
public abstract class AbstractTestSequenceKeyDelegateTest {
  ...
  @Before
  public void setUp() {
    delegate = Memcached_testDelegateFactory.getTestSequenceKeyDelegate();
  ...
  protected void clearCaches() {
    ...
    if (manager != null) {
      manager.clearCache(com.poesys.db.memcached_test.TestSequenceKey.class.getName());
    }
  }
   ...
   * @throws DelegateException when a problem occurs during object creation
   */
  protected List<com.poesys.bs.memcached_test.BsTestSequenceKey> createMemcached_testTestSequenceKey(int count) 
      throws DelegateException, InvalidParametersException {
    List<com.poesys.bs.memcached_test.BsTestSequenceKey> objects = 
      new CopyOnWriteArrayList<com.poesys.bs.memcached_test.BsTestSequenceKey>();
  ...
  public void testInsert() {
    ...
    List<BsTestSequenceKey> objects = createMemcached_testTestSequenceKey(1);
  ...
  public void testGetAllObjects() 
    ...
    // Create a new TestSequenceKey object to perform the test.
    List<BsTestSequenceKey> insertedObjects = createMemcached_testTestSequenceKey(1);
  ...
  public void testUpdateBatch() throws InvalidParametersException,
      DelegateException {
    List<BsTestSequenceKey> objects = createMemcached_testTestSequenceKey(2);
    delegate.insert(objects);
  ...
  public void testProcess() throws InvalidParametersException,
    ...
    List<BsTestSequenceKey> allObjects = createMemcached_testTestSequenceKey(3);
