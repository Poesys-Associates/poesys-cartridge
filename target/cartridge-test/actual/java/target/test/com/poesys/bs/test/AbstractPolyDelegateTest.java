...
public abstract class AbstractPolyDelegateTest {
  ...
  @Before
  public void setUp() {
    delegate = TestDelegateFactory.getPolyDelegate();
  ...
  protected void clearCaches() {
    ...
    if (manager != null) {
      manager.clearCache(com.poesys.db.test.Poly.class.getName());
    }
   ...
   * @throws DelegateException when a problem occurs during object creation
   */
  protected List<com.poesys.bs.test.BsPoly> createTestPoly(int count) 
      throws DelegateException, InvalidParametersException {
    List<com.poesys.bs.test.BsPoly> objects = 
      new CopyOnWriteArrayList<com.poesys.bs.test.BsPoly>();
   ...
   */
  abstract protected List<com.poesys.bs.test.BsMapElement> createTestMapElement(com.poesys.db.test.IPoly parent, 
                                                       int count) 
  ...
  public void testInsert() {
    ...
    List<BsPoly> objects = createTestPoly(1);
  ...
  public void testGetAllObjects() 
    ...
    // Create a new Poly object to perform the test.
    List<BsPoly> insertedObjects = createTestPoly(1);
  ...
  public void testUpdateBatch() throws InvalidParametersException,
      DelegateException {
    List<BsPoly> objects = createTestPoly(2);
    delegate.insert(objects);
  ...
  public void testProcess() throws InvalidParametersException,
    ...
    List<BsPoly> allObjects = createTestPoly(3);
