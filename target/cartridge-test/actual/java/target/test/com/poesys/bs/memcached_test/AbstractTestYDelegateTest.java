...
public abstract class AbstractTestYDelegateTest {
  ...
  @Before
  public void setUp() {
    delegate = Memcached_testDelegateFactory.getTestYDelegate();
  ...
  protected void clearCaches() {
    ...
    if (manager != null) {
      manager.clearCache(com.poesys.db.memcached_test.TestY.class.getName());
    }
   ...
   * @throws DelegateException when a problem occurs during object creation
   */
  protected List<com.poesys.bs.memcached_test.BsTestY> createMemcached_testTestY(int count) 
      throws DelegateException, InvalidParametersException {
    List<com.poesys.bs.memcached_test.BsTestY> objects = 
      new CopyOnWriteArrayList<com.poesys.bs.memcached_test.BsTestY>();
   ...
   */
  abstract protected List<com.poesys.bs.memcached_test.BsTestAssociationChild> createMemcached_testTestAssociationChild(com.poesys.db.memcached_test.ITestY parent, 
                                                       int count) 
  ...
  public void testInsert() {
    ...
    List<BsTestY> objects = createMemcached_testTestY(1);
  ...
  public void testGetAllObjects() 
    ...
    // Create a new TestY object to perform the test.
    List<BsTestY> insertedObjects = createMemcached_testTestY(1);
  ...
  public void testUpdateBatch() throws InvalidParametersException,
      DelegateException {
    List<BsTestY> objects = createMemcached_testTestY(2);
    delegate.insert(objects);
  ...
  public void testProcess() throws InvalidParametersException,
    ...
    List<BsTestY> allObjects = createMemcached_testTestY(3);
