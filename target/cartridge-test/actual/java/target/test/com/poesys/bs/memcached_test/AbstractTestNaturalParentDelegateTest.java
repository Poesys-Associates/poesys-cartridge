...
public abstract class AbstractTestNaturalParentDelegateTest {
  ...
  @Before
  public void setUp() {
    delegate = Memcached_testDelegateFactory.getTestNaturalParentDelegate();
  ...
  protected void clearCaches() {
    ...
    if (manager != null) {
      manager.clearCache(com.poesys.db.memcached_test.TestNaturalParent.class.getName());
    }

    // Clear nested object caches
    
    // Child TestNaturalChild cache
    IDaoManager TestNaturalChildManager = DaoManagerFactory.getManager("com.poesys.db.memcached_test");
    if (TestNaturalChildManager != null) {
      TestNaturalChildManager.clearCache(com.poesys.db.memcached_test.TestNaturalChild.class.getName());
    }
   ...
   * @throws DelegateException when a problem occurs during object creation
   */
  protected List<com.poesys.bs.memcached_test.BsTestNaturalParent> createMemcached_testTestNaturalParent(int count) 
      throws DelegateException, InvalidParametersException {
    List<com.poesys.bs.memcached_test.BsTestNaturalParent> objects = 
      new CopyOnWriteArrayList<com.poesys.bs.memcached_test.BsTestNaturalParent>();
   ...
   */
  abstract protected List<com.poesys.bs.memcached_test.BsTestNaturalChild> createMemcached_testTestNaturalChild(com.poesys.db.memcached_test.ITestNaturalParent parent, 
                                                       int count) 
   ...
   *                                    input parameters for creating an object
   */
  abstract protected List<com.poesys.bs.memcached_test.BsTestAssociationChild> createMemcached_testTestAssociationChild(com.poesys.db.memcached_test.ITestNaturalParent parent, 
                                                       int count) 
      throws DelegateException, InvalidParametersException; // create 2
  ...
  public void testInsert() {
    ...
    List<BsTestNaturalParent> objects = createMemcached_testTestNaturalParent(1);
  ...
  public void testGetAllObjects() 
    ...
    // Create a new TestNaturalParent object to perform the test.
    List<BsTestNaturalParent> insertedObjects = createMemcached_testTestNaturalParent(1);
  ...
  public void testDeleteBatch() throws InvalidParametersException,
      DelegateException {
    List<BsTestNaturalParent> objects = createMemcached_testTestNaturalParent(2);
    delegate.insert(objects);
  ...
  public void testProcess() throws InvalidParametersException,
    ...
    List<BsTestNaturalParent> allObjects = createMemcached_testTestNaturalParent(3);
