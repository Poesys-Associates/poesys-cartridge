...
public abstract class AbstractSelf2DelegateTest {
  ...
  @Before
  public void setUp() {
    delegate = TestDelegateFactory.getSelf2Delegate();
  ...
  protected void clearCaches() {
    ...
    if (manager != null) {
      manager.clearCache(com.poesys.db.test.Self2.class.getName());
    }

    // Clear nested object caches
    
    // Child Self2Self cache
    IDaoManager Self2SelfManager = DaoManagerFactory.getManager("com.poesys.db.test");
    if (Self2SelfManager != null) {
      Self2SelfManager.clearCache(com.poesys.db.test.Self2Self.class.getName());
    }
  }
   ...
   * @throws DelegateException when a problem occurs during object creation
   */
  protected List<com.poesys.bs.test.BsSelf2> createTestSelf2(int count) 
      throws DelegateException, InvalidParametersException {
    List<com.poesys.bs.test.BsSelf2> objects = 
      new CopyOnWriteArrayList<com.poesys.bs.test.BsSelf2>();
   ...
   */
  abstract protected List<com.poesys.bs.test.BsSelf2Self> createTestSelf2Self(List<com.poesys.db.test.ISelf2> children2List, List<com.poesys.db.test.ISelf2> parents2List, int count) 
  ...
  public void testInsert() {
    ...
    List<BsSelf2> objects = createTestSelf2(1);
  ...
  public void testGetAllObjects() 
    ...
    // Create a new Self2 object to perform the test.
    List<BsSelf2> insertedObjects = createTestSelf2(1);
  ...
  public void testDeleteBatch() throws InvalidParametersException,
      DelegateException {
    List<BsSelf2> objects = createTestSelf2(2);
    delegate.insert(objects);
  ...
  public void testProcess() throws InvalidParametersException,
    ...
    List<BsSelf2> allObjects = createTestSelf2(3);
