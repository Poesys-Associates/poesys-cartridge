...
public abstract class AbstractTestADelegateTest {
  ...
  @Before
  public void setUp() {
    delegate = Memcached_testDelegateFactory.getTestADelegate();
  ...
  protected void clearCaches() {
    ...
    if (manager != null) {
      manager.clearCache(com.poesys.db.memcached_test.TestA.class.getName());
    }
  }
   ...
   * @throws DelegateException when a problem occurs during object creation
   */
  protected List<com.poesys.bs.memcached_test.BsTestA> createMemcached_testTestA(int count) 
      throws DelegateException, InvalidParametersException {
    List<com.poesys.bs.memcached_test.BsTestA> objects = 
      new CopyOnWriteArrayList<com.poesys.bs.memcached_test.BsTestA>();
  ...
  public void testInsert() {
    ...
    List<BsTestA> objects = createMemcached_testTestA(1);
  ...
  public void testGetAllObjects() 
    ...
    // Create a new TestA object to perform the test.
    List<BsTestA> insertedObjects = createMemcached_testTestA(1);
  ...
  public void testDeleteBatch() throws InvalidParametersException,
      DelegateException {
    List<BsTestA> objects = createMemcached_testTestA(2);
    delegate.insert(objects);
  ...
  public void testProcess() throws InvalidParametersException,
    ...
    List<BsTestA> allObjects = createMemcached_testTestA(3);
