...
public abstract class AbstractTestNaturalKeyDelegateTest {
  ...
  @Before
  public void setUp() {
    delegate = Memcached_testDelegateFactory.getTestNaturalKeyDelegate();
  ...
  protected void clearCaches() {
    ...
    if (manager != null) {
      manager.clearCache(com.poesys.db.memcached_test.TestNaturalKey.class.getName());
    }
  }
   ...
   * @throws DelegateException when a problem occurs during object creation
   */
  protected List<com.poesys.bs.memcached_test.BsTestNaturalKey> createMemcached_testTestNaturalKey(int count) 
      throws DelegateException, InvalidParametersException {
    List<com.poesys.bs.memcached_test.BsTestNaturalKey> objects = 
      new CopyOnWriteArrayList<com.poesys.bs.memcached_test.BsTestNaturalKey>();
  ...
  public void testInsert() {
    ...
    List<BsTestNaturalKey> objects = createMemcached_testTestNaturalKey(1);
  ...
  public void testGetAllObjects() 
    ...
    // Create a new TestNaturalKey object to perform the test.
    List<BsTestNaturalKey> insertedObjects = createMemcached_testTestNaturalKey(1);
  ...
  public void testDeleteBatch() throws InvalidParametersException,
      DelegateException {
    List<BsTestNaturalKey> objects = createMemcached_testTestNaturalKey(2);
    delegate.insert(objects);
  ...
  public void testProcess() throws InvalidParametersException,
    ...
    List<BsTestNaturalKey> allObjects = createMemcached_testTestNaturalKey(3);
