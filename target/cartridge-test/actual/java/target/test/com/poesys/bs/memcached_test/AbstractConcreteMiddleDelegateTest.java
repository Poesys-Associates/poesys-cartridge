...
public abstract class AbstractConcreteMiddleDelegateTest {
  ...
  @Before
  public void setUp() {
    delegate = Memcached_testDelegateFactory.getConcreteMiddleDelegate();
  ...
  protected void clearCaches() {
    ...
    if (manager != null) {
      manager.clearCache(com.poesys.db.memcached_test.ConcreteMiddle.class.getName());
    }
  }
   ...
   * @throws DelegateException when a problem occurs during object creation
   */
  protected List<com.poesys.bs.memcached_test.BsConcreteMiddle> createMemcached_testConcreteMiddle(int count) 
      throws DelegateException, InvalidParametersException {
    List<com.poesys.bs.memcached_test.BsConcreteMiddle> objects = 
      new CopyOnWriteArrayList<com.poesys.bs.memcached_test.BsConcreteMiddle>();
  ...
  public void testInsert() {
    ...
    List<BsConcreteMiddle> objects = createMemcached_testConcreteMiddle(1);
  ...
  public void testGetAllObjects() 
    ...
    // Create a new ConcreteMiddle object to perform the test.
    List<BsConcreteMiddle> insertedObjects = createMemcached_testConcreteMiddle(1);
  ...
  public void testUpdateBatch() throws InvalidParametersException,
      DelegateException {
    List<BsConcreteMiddle> objects = createMemcached_testConcreteMiddle(2);
    delegate.insert(objects);
  ...
  public void testProcess() throws InvalidParametersException,
    ...
    List<BsConcreteMiddle> allObjects = createMemcached_testConcreteMiddle(3);
