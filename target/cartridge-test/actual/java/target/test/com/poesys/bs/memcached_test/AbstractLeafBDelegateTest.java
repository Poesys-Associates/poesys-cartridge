...
public abstract class AbstractLeafBDelegateTest {
  ...
  @Before
  public void setUp() {
    delegate = Memcached_testDelegateFactory.getLeafBDelegate();
  ...
  protected void clearCaches() {
    ...
    if (manager != null) {
      manager.clearCache(com.poesys.db.memcached_test.LeafB.class.getName());
    }
  }
   ...
   * @throws DelegateException when a problem occurs during object creation
   */
  protected List<com.poesys.bs.memcached_test.BsLeafB> createMemcached_testLeafB(int count) 
      throws DelegateException, InvalidParametersException {
    List<com.poesys.bs.memcached_test.BsLeafB> objects = 
      new CopyOnWriteArrayList<com.poesys.bs.memcached_test.BsLeafB>();
  ...
  public void testInsert() {
    ...
    List<BsLeafB> objects = createMemcached_testLeafB(1);
  ...
  public void testGetAllObjects() 
    ...
    // Create a new LeafB object to perform the test.
    List<BsLeafB> insertedObjects = createMemcached_testLeafB(1);
  ...
  public void testUpdateBatch() throws InvalidParametersException,
      DelegateException {
    List<BsLeafB> objects = createMemcached_testLeafB(2);
    delegate.insert(objects);
  ...
  public void testProcess() throws InvalidParametersException,
    ...
    List<BsLeafB> allObjects = createMemcached_testLeafB(3);
