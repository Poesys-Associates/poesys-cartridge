...
public abstract class AbstractTestIdentityKeyDelegateTest {
  ...
  @Before
  public void setUp() {
    delegate = TestDelegateFactory.getTestIdentityKeyDelegate();
  ...
  protected void clearCaches() {
    ...
    if (manager != null) {
      manager.clearCache(com.poesys.db.test.TestIdentityKey.class.getName());
    }
  }
   ...
   * @throws DelegateException when a problem occurs during object creation
   */
  protected List<com.poesys.bs.test.BsTestIdentityKey> createTestTestIdentityKey(int count) 
      throws DelegateException, InvalidParametersException {
    List<com.poesys.bs.test.BsTestIdentityKey> objects = 
      new CopyOnWriteArrayList<com.poesys.bs.test.BsTestIdentityKey>();
  ...
  public void testInsert() {
    ...
    List<BsTestIdentityKey> objects = createTestTestIdentityKey(1);
  ...
  public void testGetAllObjects() 
    ...
    // Create a new TestIdentityKey object to perform the test.
    List<BsTestIdentityKey> insertedObjects = createTestTestIdentityKey(1);
  ...
  public void testUpdateBatch() throws InvalidParametersException,
      DelegateException {
    List<BsTestIdentityKey> objects = createTestTestIdentityKey(2);
    delegate.insert(objects);
  ...
  public void testProcess() throws InvalidParametersException,
    ...
    List<BsTestIdentityKey> allObjects = createTestTestIdentityKey(3);
