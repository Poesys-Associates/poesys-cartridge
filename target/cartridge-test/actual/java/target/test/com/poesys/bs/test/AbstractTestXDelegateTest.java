...
public abstract class AbstractTestXDelegateTest {
  ...
  @Before
  public void setUp() {
    delegate = TestDelegateFactory.getTestXDelegate();
  ...
  protected void clearCaches() {
    ...
    if (manager != null) {
      manager.clearCache(com.poesys.db.test.TestXProxy.class.getName());
    }
   ...
   * @throws DelegateException when a problem occurs during object creation
   */
  protected List<com.poesys.bs.test.BsTestX> createTestTestX(int count) 
      throws DelegateException, InvalidParametersException {
    List<com.poesys.bs.test.BsTestX> objects = 
      new CopyOnWriteArrayList<com.poesys.bs.test.BsTestX>();
   ...
   */
  abstract protected List<com.poesys.bs.test.BsTestAssociationChild> createTestTestAssociationChild(com.poesys.db.test.ITestX parent, 
                                                       int count) 
  ...
  public void testInsert() {
    ...
    List<BsTestX> objects = createTestTestX(1);
  ...
  public void testGetObject() throws java.sql.SQLException {
    ...
    java.util.Collection<com.poesys.bs.test.BsTestY> ys = 
      object.getYs();
  ...
  public void testGetAllObjects() 
    ...
    // Create a new TestX object to perform the test.
    List<BsTestX> insertedObjects = createTestTestX(1);
  ...
  public void testUpdateBatch() throws InvalidParametersException,
      DelegateException {
    List<BsTestX> objects = createTestTestX(2);
    delegate.insert(objects);
  ...
  public void testProcess() throws InvalidParametersException,
    ...
    List<BsTestX> allObjects = createTestTestX(3);
