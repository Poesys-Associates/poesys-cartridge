...
public abstract class AbstractLeafADelegateTest {
  ...
  @Before
  public void setUp() {
    delegate = TestDelegateFactory.getLeafADelegate();
  ...
  protected void clearCaches() {
    ...
    if (manager != null) {
      manager.clearCache(com.poesys.db.test.LeafA.class.getName());
    }
  }
   ...
   * @throws DelegateException when a problem occurs during object creation
   */
  protected List<com.poesys.bs.test.BsLeafA> createTestLeafA(int count) 
      throws DelegateException, InvalidParametersException {
    List<com.poesys.bs.test.BsLeafA> objects = 
      new CopyOnWriteArrayList<com.poesys.bs.test.BsLeafA>();
  ...
  public void testInsert() {
    ...
    List<BsLeafA> objects = createTestLeafA(1);
  ...
  public void testGetAllObjects() 
    ...
    // Create a new LeafA object to perform the test.
    List<BsLeafA> insertedObjects = createTestLeafA(1);
  ...
  public void testUpdateBatch() throws InvalidParametersException,
      DelegateException {
    List<BsLeafA> objects = createTestLeafA(2);
    delegate.insert(objects);
  ...
  public void testProcess() throws InvalidParametersException,
    ...
    List<BsLeafA> allObjects = createTestLeafA(3);
