...
public abstract class AbstractSelf4DelegateTest {
  ...
  @Before
  public void setUp() {
    delegate = TestDelegateFactory.getSelf4Delegate();
  ...
  protected void clearCaches() {
    ...
    if (manager != null) {
      manager.clearCache(com.poesys.db.test.Self4.class.getName());
    }

    // Clear nested object caches
    
    // Child Self4Self cache
    IDaoManager Self4SelfManager = DaoManagerFactory.getManager("com.poesys.db.test");
    if (Self4SelfManager != null) {
      Self4SelfManager.clearCache(com.poesys.db.test.Self4Self.class.getName());
    }
  }
   ...
   * @throws DelegateException when a problem occurs during object creation
   */
  protected List<com.poesys.bs.test.BsSelf4> createTestSelf4(int count) 
      throws DelegateException, InvalidParametersException {
    List<com.poesys.bs.test.BsSelf4> objects = 
      new CopyOnWriteArrayList<com.poesys.bs.test.BsSelf4>();
   ...
   */
  abstract protected List<com.poesys.bs.test.BsSelf4Self> createTestSelf4Self(List<com.poesys.db.test.ISelf4> children4List, List<com.poesys.db.test.ISelf4> parents4List, int count) 
  ...
  public void testInsert() {
    ...
    List<BsSelf4> objects = createTestSelf4(1);
  ...
  public void testGetAllObjects() 
    ...
    // Create a new Self4 object to perform the test.
    List<BsSelf4> insertedObjects = createTestSelf4(1);
  ...
  public void testDeleteBatch() throws InvalidParametersException,
      DelegateException {
    List<BsSelf4> objects = createTestSelf4(2);
    delegate.insert(objects);
  ...
  public void testProcess() throws InvalidParametersException,
    ...
    List<BsSelf4> allObjects = createTestSelf4(3);
