...
public abstract class AbstractMapDelegateTest {
  ...
  @Before
  public void setUp() {
    delegate = Memcached_testDelegateFactory.getMapDelegate();
  ...
  protected void clearCaches() {
    ...
    if (manager != null) {
      manager.clearCache(com.poesys.db.memcached_test.Map.class.getName());
    }
   ...
   * @throws DelegateException when a problem occurs during object creation
   */
  protected List<com.poesys.bs.memcached_test.BsMap> createMemcached_testMap(int count) 
      throws DelegateException, InvalidParametersException {
    List<com.poesys.bs.memcached_test.BsMap> objects = 
      new CopyOnWriteArrayList<com.poesys.bs.memcached_test.BsMap>();
   ...
   */
  abstract protected List<com.poesys.bs.memcached_test.BsMapElement> createMemcached_testMapElement(com.poesys.db.memcached_test.IMap parent, 
                                                       int count) 
  ...
  public void testInsert() {
    ...
    List<BsMap> objects = createMemcached_testMap(1);
  ...
  public void testGetAllObjects() 
    ...
    // Create a new Map object to perform the test.
    List<BsMap> insertedObjects = createMemcached_testMap(1);
  ...
  public void testUpdateBatch() throws InvalidParametersException,
      DelegateException {
    List<BsMap> objects = createMemcached_testMap(2);
    delegate.insert(objects);
  ...
  public void testProcess() throws InvalidParametersException,
    ...
    List<BsMap> allObjects = createMemcached_testMap(3);
