...
public class TestParentDelegateTest extends
    com.poesys.bs.test.AbstractTestParentDelegateTest {

  @Override
  public java.util.List<BsTestChildChild> createTestTestChildChild(
                                                                   com.poesys.db.test.ITestParent parent,
                                                                   int count)
    ...
    for (int i = 0; i < count; i++) {
      ...
      BsTestChildChild bsObject =
        TestDelegateFactory.getTestParentDelegate().createTestChildChild(new BsTestParent(parent),
  ...
  @Override
  protected java.util.List<com.poesys.bs.test.BsTC2TC2TC2TC> createTestTC2TC2TC2TC(
                                                                                   java.util.List<com.poesys.db.test.ITestChild2TestChild> tc1List,
                                                                                   java.util.List<com.poesys.db.test.ITestChild2TestChild> tc2List,
                                                                                   int count)
      throws com.poesys.bs.delegate.DelegateException,
      com.poesys.db.InvalidParametersException,
      com.poesys.db.dto.DtoStatusException {
    ...
    if (tc1List.size() < count) {
      org.junit.Assert.fail("createTestTC2TC2TC2TC tc1List list has "
                            + tc1List.size() + " elements but needs at least "
                            + count);
    }
    if (tc2List.size() < count) {
      org.junit.Assert.fail("createTestTC2TC2TC2TC tc2List list has "
    ...
    TestParentDelegate delegate = TestDelegateFactory.getTestParentDelegate();
  ...
  @Override
  protected java.util.List<com.poesys.bs.test.BsTestChild2TestChild> createTestTestChild2TestChild(
                                                                                                   java.util.List<com.poesys.db.test.ITestChild> downList,
                                                                                                   java.util.List<com.poesys.db.test.ITestChild> upList,
                                                                                                   int count)
      throws com.poesys.bs.delegate.DelegateException,
      com.poesys.db.InvalidParametersException,
      com.poesys.db.dto.DtoStatusException {
    ...
    if (downList.size() < count) {
      org.junit.Assert.fail("createTestTestChild2TestChild downList list has "
                            + downList.size() + " elements but needs at least "
                            + count);
    }
    if (upList.size() < count) {
      org.junit.Assert.fail("createTestTestChild2TestChild upList list has "
                            + upList.size() + " elements but needs at least "
                            + count);
    }
  ...
  @Override
  protected java.util.List<BsTestChild> createTestTestChild(
                                                            com.poesys.db.test.ITestParent parent,
                                                            int count)
      throws com.poesys.bs.delegate.DelegateException,
      com.poesys.db.InvalidParametersException,
    ...
    for (int i = 0; i < count; i++) {
      BsTestChild bsObject =
        TestDelegateFactory.getTestParentDelegate().createTestChild(new BsTestParent(parent),
                                                                    parent.getTestParentId(),
                                                                    new BigInteger(new Long(i).toString()));
      objects.add(bsObject);
    }
  ...
  @Override
  protected java.util.List<BsTestExplicitKeyChild> createTestTestExplicitKeyChild(
                                                                                  com.poesys.db.test.ITestParent parent,
                                                                                  int count)
      throws com.poesys.bs.delegate.DelegateException,
      com.poesys.db.InvalidParametersException,
    ...
    for (int i = 0; i < count; i++) {
      BsTestExplicitKeyChild bsObject =
        TestDelegateFactory.getTestParentDelegate().createTestExplicitKeyChild(new BsTestParent(parent),
                                                                               parent.getTestParentId(),
                                                                               new Long(i));
      objects.add(bsObject);
    }
