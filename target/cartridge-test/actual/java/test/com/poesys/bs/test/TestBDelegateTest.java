...
/**
 * <p>
 * A test class for the TestBDelegate class. This class is the concrete subclass
 ...
 */
public class TestBDelegateTest extends
    com.poesys.bs.test.AbstractTestBDelegateTest {

  @Override
  public java.util.List<com.poesys.bs.test.BsTestA> createATestTestA(int count)
      throws com.poesys.bs.delegate.DelegateException,
      com.poesys.db.InvalidParametersException,
      com.poesys.db.dto.DtoStatusException {
    
    TestADelegate aDelegate = TestDelegateFactory.getTestADelegate();
    List<com.poesys.bs.test.BsTestA> objects =
      new ArrayList<com.poesys.bs.test.BsTestA>();
