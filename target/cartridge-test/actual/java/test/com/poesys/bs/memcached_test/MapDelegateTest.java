 ...
 */
public class MapDelegateTest extends com.poesys.bs.memcached_test.AbstractMapDelegateTest {

  @Override
  protected java.util.List<BsMapElement> createMemcached_testMapElement(com.poesys.db.memcached_test.IMap parent, int count)
    ...
    // Create a poly and link it to the map to create a MapElement link.
      PolyDelegate del = Memcached_testDelegateFactory.getPolyDelegate();
