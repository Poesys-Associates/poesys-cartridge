/**
 * Copyright 2011 Poesys Associates. All rights reserved.
 */
...
import com.poesys.bs.memcached_test.BsTestX;
import com.poesys.bs.memcached_test.BsTestY;
import com.poesys.bs.memcached_test.BsTestZ;
...
public class TestXDelegateTest extends
    com.poesys.bs.memcached_test.AbstractTestXDelegateTest {

  @Override
  protected java.util.List<BsTestAssociationChild> createMemcached_testTestAssociationChild(
                                                                                            com.poesys.db.memcached_test.ITestX parent,
                                                                                            int count)
  ...
  @Override
  protected java.util.List<com.poesys.bs.memcached_test.BsTestZ> createMemcached_testTestZ(
                                                                                           java.util.List<com.poesys.db.memcached_test.ITestX> xsList,
                                                                                           java.util.List<com.poesys.db.memcached_test.ITestY> ysList,
                                                                                           int count)
      throws com.poesys.bs.delegate.DelegateException,
      com.poesys.db.InvalidParametersException,
      com.poesys.db.dto.DtoStatusException {
    ...
    if (xsList.size() < count) {
      org.junit.Assert.fail("createMemcached_testTestZ xsList list has "
                            + xsList.size() + " elements but needs at least "
                            + count);
    }
    if (ysList.size() < count) {
      org.junit.Assert.fail("createMemcached_testTestZ ysList list has "
                            + ysList.size() + " elements but needs at least "
                            + count);
    }
    ...
    TestXDelegate delegate = Memcached_testDelegateFactory.getTestXDelegate();
