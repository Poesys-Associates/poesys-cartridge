...
public class TestNaturalParentDelegateTest extends
    com.poesys.bs.memcached_test.AbstractTestNaturalParentDelegateTest {

  @Override
  protected java.util.List<BsTestNaturalChild> createMemcached_testTestNaturalChild(
                                                                                    com.poesys.db.memcached_test.ITestNaturalParent parent,
                                                                                    int count)
