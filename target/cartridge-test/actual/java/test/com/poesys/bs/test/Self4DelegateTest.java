...
/**
 * <p>
 * A test class for the Self4Delegate class. This class is the concrete subclass
 ...
 */
public class Self4DelegateTest extends
    com.poesys.bs.test.AbstractSelf4DelegateTest {

  @Override
  public java.util.List<com.poesys.bs.test.BsSelf4Self> createTestSelf4Self(
                                                                               java.util.List<com.poesys.db.test.ISelf4> children4List,
                                                                               java.util.List<com.poesys.db.test.ISelf4> parents4List,
                                                                               int count)
    ...
    if (children4List.size() < count) {
      org.junit.Assert.fail("createTestSelf4Self children4List list has "
                            + children4List.size()
                            + " elements but needs at least " + count);
    }
    if (parents4List.size() < count) {
      org.junit.Assert.fail("createTestSelf4Self parents4List list has "
                            + parents4List.size()
                            + " elements but needs at least " + count);
    }
    ...
    Self4Delegate delegate = TestDelegateFactory.getSelf4Delegate();

    for (int i = 0; i < count; i++) {
      com.poesys.db.test.ISelf4 children2Dto = children4List.get(i);
      ...
      com.poesys.db.test.ISelf4 parents2Dto = parents4List.get(i);
