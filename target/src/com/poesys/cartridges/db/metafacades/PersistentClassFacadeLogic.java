...
/**
 * MetafacadeLogic for com.poesys.cartridges.db.metafacades.PersistentClassFacade
 *
 * @see com.poesys.cartridges.db.metafacades.PersistentClassFacade
 */
public abstract class PersistentClassFacadeLogic
    extends org.andromda.core.metafacade.MetafacadeBase
    implements com.poesys.cartridges.db.metafacades.PersistentClassFacade
{

    protected org.eclipse.uml2.Class metaObject;

    public PersistentClassFacadeLogic(org.eclipse.uml2.Class metaObject, String context)
    {
    ...
    private static String getContext(String context)
    {
        if (context == null)
        {
            context = "com.poesys.cartridges.db.metafacades.PersistentClassFacade";
        }
        return context;
    }
